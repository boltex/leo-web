 ...
 */
export function makeAllBindings(p_leoUI: LeoUI): void {
    ...
    const w_commands: [string, (...args: any[]) => any][] = [
        ...
        [CMD.OPEN_FILE, (p_uri?: Uri) => p_leoUI.openLeoFile(p_uri)],
        ...
        [CMD.SET_OPENED_FILE, (p_index: number) => p_leoUI.selectOpenedLeoDocument(p_index)],
        ...
        [CMD.SELECT_NODE, (p_outlineNode: any) => p_leoUI.selectTreeNode(p_outlineNode.position, false)], // Select is NOT a Position! TODO : FIX THIS TYPE ISSUE
