...
export function makeAllBindings(leoUI: LeoUI, controller: LeoController): void {
    ...
    const commands: [string, (...args: any[]) => any][] = [
        ...
        [CMD.BACKWARD_CHAR, () => leoUI.command(LEOCMD.BACKWARD_CHAR, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_PARAGRAPH, () => leoUI.command(LEOCMD.BACKWARD_PARAGRAPH, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_SENTENCE, () => leoUI.command(LEOCMD.BACKWARD_SENTENCE, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_WORD, () => leoUI.command(LEOCMD.BACKWARD_WORD, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        ...
        [CMD.BACKWARD_CHAR_EXTEND_SELECTION, () => leoUI.command(LEOCMD.BACKWARD_CHAR_EXTEND_SELECTION, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_PARAGRAPH_EXTEND_SELECTION, () => leoUI.command(LEOCMD.BACKWARD_PARAGRAPH_EXTEND_SELECTION, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_SENTENCE_EXTEND_SELECTION, () => leoUI.command(LEOCMD.BACKWARD_SENTENCE_EXTEND_SELECTION, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
        [CMD.BACKWARD_WORD_EXTEND_SELECTION, () => leoUI.command(LEOCMD.BACKWARD_WORD_EXTEND_SELECTION, { refreshType: REFRESH_NODE_BODY, finalFocus: Focus.Body })],
