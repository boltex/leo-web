//@+leo-ver=5-thin
//@+node:felix.20251214160339.7: * @file src/core/idle_time.ts
/**
...
//@+others
//@+node:felix.20251214160339.8: ** class IdleTime
/**
...
export class IdleTime {
    ...
    //@+node:felix.20251214160339.10: *3* IdleTime.__repr__
    /**
     * IdleTime repr.
     */
    ...
    //@+node:felix.20251214160339.11: *3* IdleTime.at_idle_time
    /**
    ...
    //@+node:felix.20251214160339.12: *3* IdleTime.call_handler
    /**
    ...
    //@+node:felix.20251214160339.13: *3* IdleTime.destroy_self
    /**
    ...
    //@+node:felix.20251214160339.14: *3* IdleTime.start & stop
    /**
