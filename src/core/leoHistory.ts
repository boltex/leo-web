//@+leo-ver=5-thin
//@+node:felix.20251214160339.1297: * @file src/core/leoHistory.ts
...
//@+others
//@+node:felix.20251214160339.1298: ** class NodeHistory
/**
...
export class NodeHistory {
    ...
    //@+others
    //@+node:felix.20251214160339.1299: *3* NodeHistory.ctor
    ...
    //@+node:felix.20251214160339.1300: *3* NodeHistory.dump
    /**
     * * Dump the beadList
     */
    public dump(): void {
    ...
    //@+node:felix.20251214160339.1301: *3* NodeHistory.goNext
    /**
    ...
    //@+node:felix.20251214160339.1302: *3* NodeHistory.goPrev
    /**
    ...
    //@+node:felix.20251214160339.1303: *3* NodeHistory.select
    /**
    ...
    //@+node:felix.20251214160339.1304: *3* NodeHistory.update
    /**
