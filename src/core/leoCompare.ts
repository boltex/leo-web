//@+leo-ver=5-thin
//@+node:felix.20251214160339.660: * @file src/core/leoCompare.ts
/**
...
//@-<< leoCompare imports & annotations >>
//@+others
//@+node:felix.20251214160339.662: ** class LeoCompare
/**
...
export class BaseLeoCompare {
    ...
    //@+node:felix.20251214160339.665: *3* compare_files (entry)
    ...
    //@+node:felix.20251214160339.666: *3* compare_list_of_files (entry for scripts)
    ...
    //@+node:felix.20251214160339.667: *3* compare_two_files
    /**
     * A helper function.
     */
    ...
    //@+node:felix.20251214160339.668: *3* compare_lines
    ...
    //@+node:felix.20251214160339.669: *3* compare_open_files
    public async compare_open_files(
        ...
        //@+node:felix.20251214160339.670: *4* << handle opening lines >>
        ...
        while (1) {
            ...
            //@+node:felix.20251214160339.671: *4* << ignore blank lines and/or sentinels >>
            ...
            //@+node:felix.20251214160339.672: *4* << print matches and/or mismatches >>
            ...
            //@+node:felix.20251214160339.673: *4* << warn if mismatch limit reached >>
            if (this.limitCount > 0 && mismatches >= this.limitCount) {
                if (printTrailing) {
                    this.show('');
        ...
        //@+node:felix.20251214160339.674: *4* << handle reporting after at least one eof is seen >>
        if (n1 > 0) {
    ...
    //@+node:felix.20251214160339.675: *3* compare.filecmp
    ...
    //@+node:felix.20251214160339.676: *3* compare.utils...
    ...
    //@+node:felix.20251214160339.678: *4* compare.dump
    ...
    //@+node:felix.20251214160339.679: *4* compare.dumpToEndOfFile
    ...
    //@+node:felix.20251214160339.680: *4* compare.isLeoHeader & isSentinel
    ...
    //@+node:felix.20251214160339.681: *4* compare.openOutputFile
    ...
    //@+node:felix.20251214160339.682: *4* compare.show
    ...
    //@+node:felix.20251214160339.683: *4* compare.showIvars
...
//@+node:felix.20251214160339.684: ** class CompareLeoOutlines
/**
...
export class CompareLeoOutlines {
    ...
    //@+others
    //@+node:felix.20251214160339.685: *3* loc.diff_list_of_files (entry)
    /**
    ...
    //@+node:felix.20251214160339.686: *3* loc.diff_two_files
    /**
    ...
    //@+node:felix.20251214160339.687: *3* loc.Utils
    //@+node:felix.20251214160339.688: *4* loc.compute_dicts
    /**
    ...
    //@+node:felix.20251214160339.689: *4* loc.create_compare_node
    /**
    ...
    //@+node:felix.20251214160339.690: *4* loc.create_file_node
    /**
    ...
    //@+node:felix.20251214160339.691: *4* loc.create_root
    /**
    ...
    //@+node:felix.20251214160339.692: *4* loc.finish
    /**
    ...
    //@+node:felix.20251214160339.693: *4* loc.get_file
    /**
    ...
    //@+node:felix.20251214160339.694: *4* loc.make_diff_outlines
    /**
    ...
    //@+node:felix.20251214160339.695: *4* loc.open_outline
    /**
...
//@+node:felix.20251214160339.696: ** class TopLevelCompareCommands
export class TopLevelCompareCommands {
    //@+others
    //@+node:felix.20251214160339.697: *3* @g.command(diff-and-open-leo-files)
    @command(
    ...
    //@+node:felix.20251214160339.698: *3* @g.command(diff-leo-files)
    @command(
        'diff-leo-files',
        'Open a dialog prompting for two or more .leo files.' +
    ...
    //@+node:felix.20251214160339.699: *3* @g.command(diff-marked-nodes)
    @command(
        'diff-marked-nodes',
...
//@+node:felix.20251214160339.700: ** diff_leo_files_helper
/**
