//@+leo-ver=5-thin
//@+node:felix.20251103192334.665: * @file src/core/leoCompare.ts
/**
 * Leo's base compare class.
 */
//@+<< leoCompare imports & annotations >>
//@+node:felix.20251103192334.666: ** << leoCompare imports & annotations >>
...
//@-<< leoCompare imports & annotations >>
//@+others
//@+node:felix.20251103192334.667: ** class LeoCompare
/**
...
export class BaseLeoCompare {
    ...
    //@+others
    //@+node:felix.20251103192334.668: *3* compare.__init__
    ...
    //@+node:felix.20251103192334.669: *3* compare_directories (entry)
    ...
    //@+node:felix.20251103192334.670: *3* compare_files (entry)
    ...
    //@+node:felix.20251103192334.671: *3* compare_list_of_files (entry for scripts)
    ...
    //@+node:felix.20251103192334.672: *3* compare_two_files
    /**
     * A helper function.
     */
    ...
    //@+node:felix.20251103192334.673: *3* compare_lines
    ...
    //@+node:felix.20251103192334.674: *3* compare_open_files
    public async compare_open_files(
        ...
        //@+node:felix.20251103192334.675: *4* << handle opening lines >>
        ...
        while (1) {
            ...
            //@+node:felix.20251103192334.676: *4* << ignore blank lines and/or sentinels >>
            ...
            //@+node:felix.20251103192334.677: *4* << print matches and/or mismatches >>
            ...
            //@+node:felix.20251103192334.678: *4* << warn if mismatch limit reached >>
            if (this.limitCount > 0 && mismatches >= this.limitCount) {
                if (printTrailing) {
                    this.show('');
        ...
        //@+node:felix.20251103192334.679: *4* << handle reporting after at least one eof is seen >>
        if (n1 > 0) {
    ...
    //@+node:felix.20251103192334.680: *3* compare.filecmp
    ...
    //@+node:felix.20251103192334.681: *3* compare.utils...
    //@+node:felix.20251103192334.682: *4* compare.doOpen
    ...
    //@+node:felix.20251103192334.683: *4* compare.dump
    ...
    //@+node:felix.20251103192334.684: *4* compare.dumpToEndOfFile
    ...
    //@+node:felix.20251103192334.685: *4* compare.isLeoHeader & isSentinel
    ...
    //@+node:felix.20251103192334.686: *4* compare.openOutputFile
    ...
    //@+node:felix.20251103192334.687: *4* compare.show
    ...
    //@+node:felix.20251103192334.688: *4* compare.showIvars
...
//@+node:felix.20251103192334.689: ** class CompareLeoOutlines
/**
...
export class CompareLeoOutlines {
    ...
    //@+others
    //@+node:felix.20251103192334.690: *3* loc.diff_list_of_files (entry)
    /**
    ...
    //@+node:felix.20251103192334.691: *3* loc.diff_two_files
    /**
    ...
    //@+node:felix.20251103192334.692: *3* loc.Utils
    //@+node:felix.20251103192334.693: *4* loc.compute_dicts
    /**
    ...
    //@+node:felix.20251103192334.694: *4* loc.create_compare_node
    /**
    ...
    //@+node:felix.20251103192334.695: *4* loc.create_file_node
    /**
    ...
    //@+node:felix.20251103192334.696: *4* loc.create_root
    /**
    ...
    //@+node:felix.20251103192334.697: *4* loc.finish
    /**
    ...
    //@+node:felix.20251103192334.698: *4* loc.get_file
    /**
    ...
    //@+node:felix.20251103192334.699: *4* loc.make_diff_outlines
    /**
    ...
    //@+node:felix.20251103192334.700: *4* loc.open_outline
    /**
...
//@+node:felix.20251103192334.701: ** class TopLevelCompareCommands
export class TopLevelCompareCommands {
    //@+others
    //@+node:felix.20251103192334.702: *3* @g.command(diff-and-open-leo-files)
    @command(
    ...
    //@+node:felix.20251103192334.703: *3* @g.command(diff-leo-files)
    @command(
        'diff-leo-files',
        'Open a dialog prompting for two or more .leo files.' +
    ...
    //@+node:felix.20251103192334.704: *3* @g.command(diff-marked-nodes)
    @command(
        'diff-marked-nodes',
...
//@+node:felix.20251103192334.705: ** diff_leo_files_helper
/**
