//@+leo-ver=5-thin
//@+node:felix.20251103192334.1700: * @file src/core/leoPersistence.ts
/**
 * Support for persistent clones, gnx's and uA's using @persistence trees.
 */
//@+<< leoPersistence imports & annotations >>
//@+node:felix.20251103192334.1701: ** << leoPersistence imports & annotations >>
...
//@-<< leoPersistence imports & annotations >>
//@+others
//@+node:felix.20251103192334.1702: ** class TopLevelPersistanceCommands
export class TopLevelPersistanceCommands {
    //@+others
    //@+node:felix.20251103192334.1703: *3* @g.command('clean-persistence')
    @command(
        'clean-persistence',
...
//@+node:felix.20251103192334.1704: ** class PersistenceDataController
export class PersistenceDataController {
    //@+<< docstring >>
    //@+node:felix.20251103192334.1705: *3*  << docstring >> (class persistenceController)
    /**
    ...
    //@+others
    //@+node:felix.20251103192334.1706: *3* pd.ctor
    /**
    ...
    //@+node:felix.20251103192334.1707: *3* pd.Entry points
    //@+node:felix.20251103192334.1708: *4* pd.clean
    /**
     * Remove all @data nodes that do not correspond to an existing foreign file.
     */
    public clean(): void {
    ...
    //@+node:felix.20251103192334.1709: *4* pd.update_before_write_foreign_file & helpers
    /**
    ...
    //@+node:felix.20251103192334.1710: *5* pd.delete_at_data_children
    /**
     * Delete all children of the @data node
     */
    ...
    //@+node:felix.20251103192334.1711: *4* pd.update_after_read_foreign_file & helpers
    /**
    ...
    //@+node:felix.20251103192334.1712: *5* pd.restore_gnxs & helpers
    /**
    ...
    //@+node:felix.20251103192334.1713: *6* pd.create_outer_gnx_dict
    /**
    ...
    //@+node:felix.20251103192334.1714: *6* pd.restore_gnx
    /**
    ...
    //@+node:felix.20251103192334.1715: *5* pd.create_uas
    /**
    ...
    //@+node:felix.20251103192334.1716: *3* pd.Helpers
    //@+node:felix.20251103192334.1717: *4* pd.at_data_body
    ...
    //@+node:felix.20251103192334.1718: *4* pd.expected_headline
    /**
    ...
    //@+node:felix.20251103192334.1719: *4* pd.find...
    // The find commands create the node if not found.
    //@+node:felix.20251103192334.1720: *5* pd.find_at_data_node & helper
    /**
    ...
    //@+node:felix.20251103192334.1721: *5* pd.find_at_gnxs_node
    /**
    ...
    //@+node:felix.20251103192334.1722: *5* pd.find_at_persistence_node
    /**
    ...
    //@+node:felix.20251103192334.1723: *5* pd.find_at_uas_node
    /**
    ...
    //@+node:felix.20251103192334.1724: *5* pd.find_position_for_relative_unl & helpers
    /**
    ...
    //@+node:felix.20251103192334.1725: *6* pd.find_best_match
    /**
    ...
    //@+node:felix.20251103192334.1726: *6* pd.find_exact_match
    /**
    ...
    //@+node:felix.20251103192334.1727: *5* pd.find_representative_node
    /**
    ...
    //@+node:felix.20251103192334.1728: *4* pd.foreign_file_name
    /**
    ...
    //@+node:felix.20251103192334.1729: *4* pd.has...
    // The has commands return None if the node does not exist.
    //@+node:felix.20251103192334.1730: *5* pd.has_at_data_node
    /**
    ...
    //@+node:felix.20251103192334.1731: *5* pd.has_at_gnxs_node
    /**
    ...
    //@+node:felix.20251103192334.1732: *5* pd.has_at_uas_node
    /**
    ...
    //@+node:felix.20251103192334.1733: *5* pd.has_at_persistence_node
    /**
    ...
    //@+node:felix.20251103192334.1734: *4* pd.is...
    //@+node:felix.20251103192334.1735: *5* pd.is_at_auto_node
    /**
    ...
    //@+node:felix.20251103192334.1736: *5* pd.is_at_file_node
    /**
    ...
    //@+node:felix.20251103192334.1737: *5* pd.is_cloned_outside_parent_tree
    /**
    ...
    //@+node:felix.20251103192334.1738: *5* pd.is_foreign_file
    ...
    //@+node:felix.20251103192334.1739: *4* pd.Pickling
    //@+node:felix.20251103192334.1740: *5* pd.pickle
    /**
    ...
    //@+node:felix.20251103192334.1741: *5* pd.unpickle
    /**
    ...
    //@+node:felix.20251103192334.1742: *4* pd.unls...
    //@+node:felix.20251103192334.1743: *5* pd.drop_unl_parent/tail
    /**
    ...
    //@+node:felix.20251103192334.1744: *5* pd.relative_unl
    /**
    ...
    //@+node:felix.20251103192334.1745: *5* pd.unl
    /**
    ...
    //@+node:felix.20251103192334.1746: *5* pd.unl_tail
    /**
