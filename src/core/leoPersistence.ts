//@+leo-ver=5-thin
//@+node:felix.20251214160339.1696: * @file src/core/leoPersistence.ts
/**
 * Support for persistent clones, gnx's and uA's using @persistence trees.
 */
//@+<< leoPersistence imports & annotations >>
//@+node:felix.20251214160339.1697: ** << leoPersistence imports & annotations >>
...
//@-<< leoPersistence imports & annotations >>
//@+others
//@+node:felix.20251214160339.1698: ** class TopLevelPersistanceCommands
export class TopLevelPersistanceCommands {
    //@+others
    //@+node:felix.20251214160339.1699: *3* @g.command('clean-persistence')
    @command(
        'clean-persistence',
...
//@+node:felix.20251214160339.1700: ** class PersistenceDataController
export class PersistenceDataController {
    //@+<< docstring >>
    //@+node:felix.20251214160339.1701: *3*  << docstring >> (class persistenceController)
    /**
    ...
    //@+others
    //@+node:felix.20251214160339.1702: *3* pd.ctor
    /**
    ...
    //@+node:felix.20251214160339.1703: *3* pd.Entry points
    //@+node:felix.20251214160339.1704: *4* pd.clean
    /**
     * Remove all @data nodes that do not correspond to an existing foreign file.
     */
    public clean(): void {
    ...
    //@+node:felix.20251214160339.1705: *4* pd.update_before_write_foreign_file & helpers
    /**
    ...
    //@+node:felix.20251214160339.1706: *5* pd.delete_at_data_children
    /**
     * Delete all children of the @data node
     */
    ...
    //@+node:felix.20251214160339.1707: *4* pd.update_after_read_foreign_file & helpers
    /**
    ...
    //@+node:felix.20251214160339.1708: *5* pd.restore_gnxs & helpers
    /**
    ...
    //@+node:felix.20251214160339.1709: *6* pd.create_outer_gnx_dict
    /**
    ...
    //@+node:felix.20251214160339.1710: *6* pd.restore_gnx
    /**
    ...
    //@+node:felix.20251214160339.1711: *5* pd.create_uas
    /**
    ...
    //@+node:felix.20251214160339.1712: *3* pd.Helpers
    //@+node:felix.20251214160339.1713: *4* pd.at_data_body
    ...
    //@+node:felix.20251214160339.1714: *4* pd.expected_headline
    /**
    ...
    //@+node:felix.20251214160339.1715: *4* pd.find...
    // The find commands create the node if not found.
    //@+node:felix.20251214160339.1716: *5* pd.find_at_data_node & helper
    /**
    ...
    //@+node:felix.20251214160339.1717: *5* pd.find_at_gnxs_node
    /**
    ...
    //@+node:felix.20251214160339.1718: *5* pd.find_at_persistence_node
    /**
    ...
    //@+node:felix.20251214160339.1719: *5* pd.find_at_uas_node
    /**
    ...
    //@+node:felix.20251214160339.1720: *5* pd.find_position_for_relative_unl & helpers
    /**
    ...
    //@+node:felix.20251214160339.1721: *6* pd.find_best_match
    /**
    ...
    //@+node:felix.20251214160339.1722: *6* pd.find_exact_match
    /**
    ...
    //@+node:felix.20251214160339.1723: *5* pd.find_representative_node
    /**
    ...
    //@+node:felix.20251214160339.1724: *4* pd.foreign_file_name
    /**
    ...
    //@+node:felix.20251214160339.1725: *4* pd.has...
    // The has commands return None if the node does not exist.
    //@+node:felix.20251214160339.1726: *5* pd.has_at_data_node
    /**
    ...
    //@+node:felix.20251214160339.1727: *5* pd.has_at_gnxs_node
    /**
    ...
    //@+node:felix.20251214160339.1728: *5* pd.has_at_uas_node
    /**
    ...
    //@+node:felix.20251214160339.1729: *5* pd.has_at_persistence_node
    /**
    ...
    //@+node:felix.20251214160339.1730: *4* pd.is...
    //@+node:felix.20251214160339.1731: *5* pd.is_at_auto_node
    /**
    ...
    //@+node:felix.20251214160339.1732: *5* pd.is_at_file_node
    /**
    ...
    //@+node:felix.20251214160339.1733: *5* pd.is_cloned_outside_parent_tree
    /**
    ...
    //@+node:felix.20251214160339.1734: *5* pd.is_foreign_file
    ...
    //@+node:felix.20251214160339.1735: *4* pd.Pickling
    //@+node:felix.20251214160339.1736: *5* pd.pickle
    /**
    ...
    //@+node:felix.20251214160339.1737: *5* pd.unpickle
    /**
    ...
    //@+node:felix.20251214160339.1738: *4* pd.unls...
    //@+node:felix.20251214160339.1739: *5* pd.drop_unl_parent/tail
    /**
    ...
    //@+node:felix.20251214160339.1740: *5* pd.relative_unl
    /**
    ...
    //@+node:felix.20251214160339.1741: *5* pd.unl
    /**
    ...
    //@+node:felix.20251214160339.1742: *5* pd.unl_tail
    /**
