...
export class FreeMindImporter {
    ...
    //@+others
    //@+node:felix.20251214160339.1308: *3* freemind.add_children
    /**
    ...
    //@+node:felix.20251214160339.1309: *3* freemind.create_outline
    /**
    ...
    //@+node:felix.20251214160339.1310: *3* freemind.import_file
    /**
    ...
    //@+node:felix.20251214160339.1311: *3* freemind.import_files
    /**
    ...
    //@+node:felix.20251214160339.1312: *3* freemind.prompt_for_files
    /**
...
//@+node:felix.20251214160339.1313: ** class LeoImportCommands
/**
...
export class LeoImportCommands {
    ...
    //@+others
    //@+node:felix.20251214160339.1314: *3* ic.__init__& ic.reload_settings
    /**
    ...
    //@+node:felix.20251214160339.1315: *3* ic.Export
    //@+node:felix.20251214160339.1316: *4* ic.convertCodePartToWeb & helpers
    /**
    ...
    //@+node:felix.20251214160339.1317: *5* ic.appendHeadRef
    ...
    //@+node:felix.20251214160339.1318: *5* ic.appendRefToFileName
    ...
    //@+node:felix.20251214160339.1319: *5* ic.getHeadRef
    /**
    ...
    //@+node:felix.20251214160339.1320: *5* ic.getFileName
    /**
    ...
    //@+node:felix.20251214160339.1321: *4* ic.convertDocPartToWeb (handle @ %def)
    ...
    //@+node:felix.20251214160339.1322: *4* ic.positionToWeb
    /**
    ...
    //@+node:felix.20251214160339.1323: *4* ic.copyPart
    ...
    //@+node:felix.20251214160339.1324: *4* ic.exportHeadlines
    /**
    ...
    //@+node:felix.20251214160339.1325: *4* ic.flattenOutline
    /**
    ...
    //@+node:felix.20251214160339.1326: *4* ic.outlineToWeb
    ...
    //@+node:felix.20251214160339.1327: *4* ic.removeSentinelsCommand
    public async removeSentinelsCommand(
        ...
        for (const fileName of paths) {
            ...
            //@+node:felix.20251214160339.1328: *5* << set delims from the header line >>
    ...
    //@+node:felix.20251214160339.1330: *4* ic.removeSentinelLines
    /**
    ...
    //@+node:felix.20251214160339.1331: *4* ic.weave
        ...
        try {
            ...
            for (const w_p of p.self_and_subtree()) {
                ...
                if (s2) {
                    ...
                    //@+node:felix.20251214160339.1332: *5* << write the context of p to f >> (weave)
    ...
    //@+node:felix.20251214160339.1333: *3* ic.Import
    //@+node:felix.20251214160339.1334: *4* ic.createOutline & helpers
    /**
    ...
    //@+node:felix.20251214160339.1335: *5* ic.dispatch & helpers
    /**
    ...
    //@+node:felix.20251214160339.1337: *5* ic.init_import
    /**
    ...
    //@+node:felix.20251214160339.1338: *5* ic.scanUnknownFileType & helper
    /**
    ...
    //@+node:felix.20251214160339.1339: *6* ic.languageForExtension
    /**
    ...
    //@+node:felix.20251214160339.1340: *4* ic.readAtAutoNodes
    ...
    //@+node:felix.20251214160339.1341: *4* ic.importDerivedFiles
    /**
    ...
    //@+node:felix.20251214160339.1342: *4* ic.importFilesCommand
    ...
    //@+node:felix.20251214160339.1343: *4* ic.importFreeMind
    /**
    ...
    //@+node:felix.20251214160339.1344: *4* ic.importMindMap
    /**
    ...
    //@+node:felix.20251214160339.1345: *4* ic.importWebCommand & helpers
    ...
    //@+node:felix.20251214160339.1346: *5* createOutlineFromWeb
    ...
    //@+node:felix.20251214160339.1347: *5* findFunctionDef
    ...
    //@+node:felix.20251214160339.1348: *5* scanBodyForHeadline
    ...
    public scanBodyForHeadline(s: string): string {
        ...
        if (this.webType === 'cweb') {
            ...
            //@+node:felix.20251214160339.1349: *6* << scan cweb body for headline >>
            let i = 0;
            while (i < s.length) {
                i = g.skip_ws_and_nl(s, i);
            ...
            //@+node:felix.20251214160339.1350: *6* << scan noweb body for headline >>
            let i = 0;
            while (i < s.length) {
                i = g.skip_ws_and_nl(s, i);
                if (g.match(s, i, '<<')) {
    ...
    //@+node:felix.20251214160339.1351: *5* scanWebFile (handles limbo)
    public async scanWebFile(
        ...
        //@+node:felix.20251214160339.1352: *6* << Create a symbol table of all section names >>
        let i = 0;
        this.web_st = [];
        while (i < s.length) {
            let progress = i;
        ...
        //@+node:felix.20251214160339.1353: *6* << Create nodes for limbo text and the root section >>
        i = 0;
        while (i < s.length) {
            let progress = i;
            i = g.skip_ws_and_nl(s, i);
        ...
        while (i < s.length) {
            ...
            //@+node:felix.20251214160339.1354: *6* << Create a node for the next module >>
            if (theType === 'cweb') {
                ...
                //@+node:felix.20251214160339.1355: *7* << Handle cweb @d, @f, @c and @p directives >>
                if (g.match(s, i, '@d') || g.match(s, i, '@f')) {
                    i += 2;
                    i = g.skip_line(s, i);
    ...
    //@+node:felix.20251214160339.1356: *5* Symbol table
    //@+node:felix.20251214160339.1357: *6* cstCanonicalize
    ...
    //@+node:felix.20251214160339.1358: *6* cstDump
    ...
    //@+node:felix.20251214160339.1359: *6* cstEnter
    ...
    //@+node:felix.20251214160339.1360: *6* cstLookup
    ...
    //@+node:felix.20251214160339.1361: *3* ic.parse_body & helpers
    /**
    ...
    //@+node:felix.20251214160339.1362: *4* ic.compute_imported_headline
    /**
    ...
    //@+node:felix.20251214160339.1363: *4* ic.parse_body_helper
    /**
    ...
    //@+node:felix.20251214160339.1364: *4* ic.preprocess_blocks
    /**
    ...
    //@+node:felix.20251214160339.1365: *3* ic.Utilities
    //@+node:felix.20251214160339.1366: *4* ic.appendStringToBody & setBodyString (leoImport)
    /**
    ...
    //@+node:felix.20251214160339.1367: *4* ic.createHeadline
    /**
    ...
    //@+node:felix.20251214160339.1368: *4* ic.error
    public error(s: string): void {
        g.es('', s);
    }
    //@+node:felix.20251214160339.1369: *4* ic.isDocStart & isModuleStart
    ...
    //@+node:felix.20251214160339.1370: *4* ic.massageWebBody
    public massageWebBody(s: string): string {
        const theType = this.webType;
        const lb = theType === 'cweb' ? '@<' : '<<';
        const rb = theType === 'cweb' ? '@>' : '>>';
        //@+<< Remove most newlines from @space and @* sections >>
        //@+node:felix.20251214160339.1371: *5* << Remove most newlines from @space and @* sections >>
        let i = 0;
        let start;
        let end;
        ...
        //@+node:felix.20251214160339.1372: *5* << Replace abbreviated names with full names >>
        i = 0;
        while (i < s.length) {
            const progress = i;
            if (g.match(s, i, lb)) {
...
//@+node:felix.20251214160339.1373: ** class MindMapImporter
/**
...
export class MindMapImporter {
    ...
    //@+others
    //@+node:felix.20251214160339.1374: *3* mindmap.create_outline
    public async create_outline(p_path: string): Promise<Position> {
        const c = this.c;
        let [junk, fileName] = g.os_path_split(p_path);
        const undoData = c.undoer.beforeInsertNode(c.p);
    ...
    //@+node:felix.20251214160339.1375: *3* mindmap.import_files
    /**
    ...
    //@+node:felix.20251214160339.1376: *3* mindmap.prompt_for_files
    /**
    ...
    //@+node:felix.20251214160339.1377: *3* mindmap.scan & helpers
    /**
    ...
    //@+node:felix.20251214160339.1378: *4* mindmap.csv_level
    /**
    ...
    //@+node:felix.20251214160339.1379: *4* mindmap.csv_string
    /**
...
//@+node:felix.20251214160339.1380: ** class MORE_Importer
/**
...
export class MORE_Importer {
    ...
    //@+others
    //@+node:felix.20251214160339.1381: *3* MORE.prompt_for_files
    /**
    ...
    //@+node:felix.20251214160339.1382: *3* MORE.import_files
    /**
    ...
    //@+node:felix.20251214160339.1383: *3* MORE.import_file
    ...
    //@+node:felix.20251214160339.1384: *3* MORE.import_lines
    public import_lines(
        strings: string[],
        first_p: Position
    ): Position | undefined {
        ...
        while (index < strings.length) {
            ...
            if (level >= 0) {
                ...
                //@+node:felix.20251214160339.1385: *4* << Link a new position p into the outline >>
                g.assert(level >= 0);
                let p: Position;
                ...
                //@+node:felix.20251214160339.1386: *4* << Set the headline string, skipping over the leader >>
                let j = 0;
                ...
                //@+node:felix.20251214160339.1387: *4* << Count the number of following body lines >>
                let bodyLines = 0;
                ...
                //@+node:felix.20251214160339.1388: *4* << Add the lines to the body text of p >>
                if (bodyLines > 0) {
                    let body = '';
    ...
    //@+node:felix.20251214160339.1389: *3* MORE.headlineLevel
    /**
    ...
    //@+node:felix.20251214160339.1390: *3* MORE.check & check_lines
...
//@+node:felix.20251214160339.1391: ** class RecursiveImportController
/**
...
export class RecursiveImportController {
    ...
    //@+others
    //@+node:felix.20251214160339.1392: *3* ric.ctor
    /**
    ...
    //@+node:felix.20251214160339.1393: *3* ric.error
    /**
    ...
    //@+node:felix.20251214160339.1394: *3* ric.import_dir
    /**
    ...
    //@+node:felix.20251214160339.1395: *3* ric.import_one_file
    /**
    ...
    //@+node:felix.20251214160339.1396: *3* ric.post_process
    /**
    ...
    //@+node:felix.20251214160339.1397: *4* ric.clear_dirty_bits
    ...
    //@+node:felix.20251214160339.1398: *4* ric.dump_headlines
    ...
    //@+node:felix.20251214160339.1399: *4* ric.fix_back_slashes
    /**
    ...
    //@+node:felix.20251214160339.1400: *4* ric.minimize_headline
    /**
    ...
    //}
    //@+node:felix.20251214160339.1401: *4* ric.move_leading_blank_lines
    /**
    ...
    //@+node:felix.20251214160339.1402: *4* ric.remove_empty_nodes
    /**
    ...
    //@+node:felix.20251214160339.1403: *3* ric_resolve_dir_arg
    /**
    ...
    //@+node:felix.20251214160339.1404: *3* ric.run
    /**
...
//@+node:felix.20251214160339.1405: ** class TabImporter
/**
...
export class TabImporter {
    ...
    //@+others
    //@+node:felix.20251214160339.1406: *3* tabbed.check
    /**
    ...
    //@+node:felix.20251214160339.1407: *3* tabbed.dump_stack
    /**
    ...
    //@+node:felix.20251214160339.1408: *3* tabbed.import_files
    /**
    ...
    //@+node:felix.20251214160339.1409: *3* tabbed.lws
    /**
    ...
    //@+node:felix.20251214160339.1410: *3* tabbed.prompt_for_files
    /**
     * Prompt for a list of FreeMind (.mm.html) files and import them.
     */
    public async prompt_for_files(): Promise<void> {
    ...
    //@+node:felix.20251214160339.1411: *3* tabbed.scan
    /**
    ...
    //@+node:felix.20251214160339.1412: *3* tabbed.scan_helper
    /**
    ...
    //@+node:felix.20251214160339.1413: *3* tabbed.undent
    /**
...
//@+node:felix.20251214160339.1414: ** class ToDoImporter
export class ToDoImporter {
    ...
    //@+others
    //@+node:felix.20251214160339.1415: *3* todo_i.get_tasks_from_file
    /**
    ...
    //@+node:felix.20251214160339.1416: *3* todo_i.import_files
    /**
    ...
    //@+node:felix.20251214160339.1417: *3* todo_i.parse_file_contents
    /**
    ...
    //@+node:felix.20251214160339.1418: *3* todo_i.prompt_for_files
    /**
...
//@+node:felix.20251214160339.1419: ** class ToDoTask
/**
...
export class ToDoTask {
    ...
    //@+others
    //@+node:felix.20251214160339.1420: *3* task.__repr__ & __str__
    ...
    //@+node:felix.20251214160339.1421: *3* task.parse_task
...
//@+node:felix.20251214160339.1422: ** class ZimImportController
/**
...
export class ZimImportController {
    ...
    //@+others
    //@+node:felix.20251214160339.1423: *3* zic.__init__ & zic.reloadSettings
    /**
    ...
    //@+node:felix.20251214160339.1424: *3* zic.parseZimIndex
    /**
    ...
    //@+node:felix.20251214160339.1425: *3* zic.rstToLastChild
    /**
    ...
    //@+node:felix.20251214160339.1426: *3* zic.clean
    /**
     * Clean useless nodes
     */
    ...
    //@+node:felix.20251214160339.1427: *3* zic.run
    /**
...
//@+node:felix.20251214160339.1428: ** class Node
/**
 * Hold node data.
 */
...
//@+node:felix.20251214160339.1429: ** class LegacyExternalFileImporter
/**
...
export class LegacyExternalFileImporter {
    ...
    //@+others
    //@+node:felix.20251214160339.1430: *3* legacy.add
    /**
    ...
    //@+node:felix.20251214160339.1431: *3* legacy.compute_delim1
    /**
    ...
    //@+node:felix.20251214160339.1432: *3* legacy.import_file
    /**
    ...
    //@+node:felix.20251214160339.1433: *3* legacy.import_files
    /**
    ...
    //@+node:felix.20251214160339.1434: *3* legacy.prompt_for_files
    /**
...
//@+node:felix.20251214160339.1435: ** class TopLevelImportCommands
export class TopLevelImportCommands {
    //@+others
    //@+node:felix.20251214160339.1436: *3* @g.command(import-free-mind-files)
    @command(
    ...
    //@+node:felix.20251214160339.1437: *3* @g.command(import-legacy-external-file)
    @command(
        'import-legacy-external-files',
    ...
    //@+node:felix.20251214160339.1438: *3* @g.command(import-mind-map-files
    @command(
    ...
    //@+node:felix.20251214160339.1439: *3* @g.command(import-MORE-files)
    ...
    //@+node:felix.20251214160339.1440: *3* @g.command(import-tabbed-files)
    ...
    //@+node:felix.20251214160339.1441: *3* @g.command(import-todo-text-files)
    @command(
    ...
    //@+node:felix.20251214160339.1442: *3* @g.command(import-zim-folder)
    @command(
        'import-zim-folder',
    ...
    //@+node:felix.20251214160339.1443: *3* @g.command(parse-body)
    @command(
        'parse-body',
