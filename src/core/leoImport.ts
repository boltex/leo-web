//@+leo-ver=5-thin
//@+node:felix.20251103192334.1309: * @file src/core/leoImport.ts
//@+<< leoImport imports >>
//@+node:felix.20251103192334.1310: ** << leoImport imports >>
...
//@-<< leoImport imports >>
//@+others
//@+node:felix.20251103192334.1311: ** class FreeMindImporter
/**
...
export class FreeMindImporter {
    ...
    //@+others
    //@+node:felix.20251103192334.1312: *3* freemind.add_children
    /**
    ...
    //@+node:felix.20251103192334.1313: *3* freemind.create_outline
    /**
    ...
    //@+node:felix.20251103192334.1314: *3* freemind.import_file
    /**
    ...
    //@+node:felix.20251103192334.1315: *3* freemind.import_files
    /**
    ...
    //@+node:felix.20251103192334.1316: *3* freemind.prompt_for_files
    /**
...
//@+node:felix.20251103192334.1317: ** class LeoImportCommands
/**
...
export class LeoImportCommands {
    ...
    //@+others
    //@+node:felix.20251103192334.1318: *3* ic.__init__& ic.reload_settings
    /**
    ...
    //@+node:felix.20251103192334.1319: *3* ic.Export
    //@+node:felix.20251103192334.1320: *4* ic.convertCodePartToWeb & helpers
    /**
    ...
    //@+node:felix.20251103192334.1321: *5* ic.appendHeadRef
    ...
    //@+node:felix.20251103192334.1322: *5* ic.appendRefToFileName
    ...
    //@+node:felix.20251103192334.1323: *5* ic.getHeadRef
    /**
    ...
    //@+node:felix.20251103192334.1324: *5* ic.getFileName
    /**
    ...
    //@+node:felix.20251103192334.1325: *4* ic.convertDocPartToWeb (handle @ %def)
    ...
    //@+node:felix.20251103192334.1326: *4* ic.positionToWeb
    /**
    ...
    //@+node:felix.20251103192334.1327: *4* ic.copyPart
    ...
    //@+node:felix.20251103192334.1328: *4* ic.exportHeadlines
    /**
    ...
    //@+node:felix.20251103192334.1329: *4* ic.flattenOutline
    /**
    ...
    //@+node:felix.20251103192334.1330: *4* ic.outlineToWeb
    ...
    //@+node:felix.20251103192334.1331: *4* ic.removeSentinelsCommand
    public async removeSentinelsCommand(
        ...
        for (const fileName of paths) {
            ...
            //@+node:felix.20251103192334.1332: *5* << set delims from the header line >>
            ...
            //@+node:felix.20251103192334.1333: *5* << Write s into newFileName >> (remove-sentinels)
    ...
    //@+node:felix.20251103192334.1334: *4* ic.removeSentinelLines
    /**
    ...
    //@+node:felix.20251103192334.1335: *4* ic.weave
        ...
        try {
            ...
            for (const w_p of p.self_and_subtree()) {
                ...
                if (s2) {
                    ...
                    //@+node:felix.20251103192334.1336: *5* << write the context of p to f >> (weave)
    ...
    //@+node:felix.20251103192334.1337: *3* ic.Import
    //@+node:felix.20251103192334.1338: *4* ic.createOutline & helpers
    /**
    ...
    //@+node:felix.20251103192334.1339: *5* ic.dispatch & helpers
    /**
    ...
    //@+node:felix.20251103192334.1340: *5* ic.import_binary_file
    ...
    //@+node:felix.20251103192334.1341: *5* ic.init_import
    /**
    ...
    //@+node:felix.20251103192334.1342: *5* ic.scanUnknownFileType & helper
    /**
    ...
    //@+node:felix.20251103192334.1343: *6* ic.languageForExtension
    /**
    ...
    //@+node:felix.20251103192334.1344: *4* ic.readAtAutoNodes
    ...
    //@+node:felix.20251103192334.1345: *4* ic.importDerivedFiles
    /**
    ...
    //@+node:felix.20251103192334.1346: *4* ic.importFilesCommand
    ...
    //@+node:felix.20251103192334.1347: *4* ic.importFreeMind
    /**
    ...
    //@+node:felix.20251103192334.1348: *4* ic.importMindMap
    /**
    ...
    //@+node:felix.20251103192334.1349: *4* ic.importWebCommand & helpers
    ...
    //@+node:felix.20251103192334.1350: *5* createOutlineFromWeb
    ...
    //@+node:felix.20251103192334.1351: *5* findFunctionDef
    ...
    //@+node:felix.20251103192334.1352: *5* scanBodyForHeadline
    ...
    public scanBodyForHeadline(s: string): string {
        ...
        if (this.webType === 'cweb') {
            ...
            //@+node:felix.20251103192334.1353: *6* << scan cweb body for headline >>
            let i = 0;
            while (i < s.length) {
                i = g.skip_ws_and_nl(s, i);
            ...
            //@+node:felix.20251103192334.1354: *6* << scan noweb body for headline >>
            let i = 0;
            while (i < s.length) {
                i = g.skip_ws_and_nl(s, i);
                if (g.match(s, i, '<<')) {
    ...
    //@+node:felix.20251103192334.1355: *5* scanWebFile (handles limbo)
    public async scanWebFile(
        ...
        //@+node:felix.20251103192334.1356: *6* << Create a symbol table of all section names >>
        let i = 0;
        this.web_st = [];
        while (i < s.length) {
            let progress = i;
        ...
        //@+node:felix.20251103192334.1357: *6* << Create nodes for limbo text and the root section >>
        i = 0;
        while (i < s.length) {
            let progress = i;
            i = g.skip_ws_and_nl(s, i);
        ...
        while (i < s.length) {
            ...
            //@+node:felix.20251103192334.1358: *6* << Create a node for the next module >>
            if (theType === 'cweb') {
                ...
                //@+node:felix.20251103192334.1359: *7* << Handle cweb @d, @f, @c and @p directives >>
                if (g.match(s, i, '@d') || g.match(s, i, '@f')) {
                    i += 2;
                    i = g.skip_line(s, i);
    ...
    //@+node:felix.20251103192334.1360: *5* Symbol table
    //@+node:felix.20251103192334.1361: *6* cstCanonicalize
    ...
    //@+node:felix.20251103192334.1362: *6* cstDump
    ...
    //@+node:felix.20251103192334.1363: *6* cstEnter
    ...
    //@+node:felix.20251103192334.1364: *6* cstLookup
    ...
    //@+node:felix.20251103192334.1365: *3* ic.parse_body & helpers
    /**
    ...
    //@+node:felix.20251103192334.1366: *4* ic.compute_imported_headline
    /**
    ...
    //@+node:felix.20251103192334.1367: *4* ic.parse_body_helper
    /**
    ...
    //@+node:felix.20251103192334.1368: *4* ic.preprocess_blocks
    /**
    ...
    //@+node:felix.20251103192334.1369: *3* ic.Utilities
    //@+node:felix.20251103192334.1370: *4* ic.appendStringToBody & setBodyString (leoImport)
    /**
    ...
    //@+node:felix.20251103192334.1371: *4* ic.createHeadline
    /**
    ...
    //@+node:felix.20251103192334.1372: *4* ic.error
    public error(s: string): void {
        g.es('', s);
    }
    //@+node:felix.20251103192334.1373: *4* ic.isDocStart & isModuleStart
    ...
    //@+node:felix.20251103192334.1374: *4* ic.massageWebBody
    public massageWebBody(s: string): string {
        const theType = this.webType;
        const lb = theType === 'cweb' ? '@<' : '<<';
        const rb = theType === 'cweb' ? '@>' : '>>';
        //@+<< Remove most newlines from @space and @* sections >>
        //@+node:felix.20251103192334.1375: *5* << Remove most newlines from @space and @* sections >>
        let i = 0;
        let start;
        let end;
        ...
        //@+node:felix.20251103192334.1376: *5* << Replace abbreviated names with full names >>
        i = 0;
        while (i < s.length) {
            const progress = i;
            if (g.match(s, i, lb)) {
...
//@+node:felix.20251103192334.1377: ** class MindMapImporter
/**
...
export class MindMapImporter {
    ...
    //@+others
    //@+node:felix.20251103192334.1378: *3* mindmap.create_outline
    public async create_outline(p_path: string): Promise<Position> {
        const c = this.c;
        let [junk, fileName] = g.os_path_split(p_path);
        const undoData = c.undoer.beforeInsertNode(c.p);
    ...
    //@+node:felix.20251103192334.1379: *3* mindmap.import_files
    /**
    ...
    //@+node:felix.20251103192334.1380: *3* mindmap.prompt_for_files
    /**
    ...
    //@+node:felix.20251103192334.1381: *3* mindmap.scan & helpers
    /**
    ...
    //@+node:felix.20251103192334.1382: *4* mindmap.csv_level
    /**
    ...
    //@+node:felix.20251103192334.1383: *4* mindmap.csv_string
    /**
...
//@+node:felix.20251103192334.1384: ** class MORE_Importer
/**
...
export class MORE_Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.1385: *3* MORE.prompt_for_files
    /**
    ...
    //@+node:felix.20251103192334.1386: *3* MORE.import_files
    /**
    ...
    //@+node:felix.20251103192334.1387: *3* MORE.import_file
    ...
    //@+node:felix.20251103192334.1388: *3* MORE.import_lines
    public import_lines(
        strings: string[],
        first_p: Position
    ): Position | undefined {
        ...
        while (index < strings.length) {
            ...
            if (level >= 0) {
                ...
                //@+node:felix.20251103192334.1389: *4* << Link a new position p into the outline >>
                g.assert(level >= 0);
                let p: Position;
                ...
                //@+node:felix.20251103192334.1390: *4* << Set the headline string, skipping over the leader >>
                let j = 0;
                ...
                //@+node:felix.20251103192334.1391: *4* << Count the number of following body lines >>
                let bodyLines = 0;
                ...
                //@+node:felix.20251103192334.1392: *4* << Add the lines to the body text of p >>
                if (bodyLines > 0) {
                    let body = '';
    ...
    //@+node:felix.20251103192334.1393: *3* MORE.headlineLevel
    /**
    ...
    //@+node:felix.20251103192334.1394: *3* MORE.check & check_lines
...
//@+node:felix.20251103192334.1395: ** class RecursiveImportController
/**
...
export class RecursiveImportController {
    ...
    //@+others
    //@+node:felix.20251103192334.1396: *3* ric.ctor
    /**
    ...
    //@+node:felix.20251103192334.1397: *3* ric.error
    /**
    ...
    //@+node:felix.20251103192334.1398: *3* ric.import_dir
    /**
    ...
    //@+node:felix.20251103192334.1399: *3* ric.import_one_file
    /**
    ...
    //@+node:felix.20251103192334.1400: *3* ric.post_process
    /**
    ...
    //@+node:felix.20251103192334.1401: *4* ric.clear_dirty_bits
    ...
    //@+node:felix.20251103192334.1402: *4* ric.dump_headlines
    ...
    //@+node:felix.20251103192334.1403: *4* ric.fix_back_slashes
    /**
    ...
    //@+node:felix.20251103192334.1404: *4* ric.minimize_headline
    /**
    ...
    //}
    //@+node:felix.20251103192334.1405: *4* ric.move_leading_blank_lines
    /**
    ...
    //@+node:felix.20251103192334.1406: *4* ric.remove_empty_nodes
    /**
    ...
    //@+node:felix.20251103192334.1407: *3* ric_resolve_dir_arg
    /**
    ...
    //@+node:felix.20251103192334.1408: *3* ric.run
    /**
...
//@+node:felix.20251103192334.1409: ** class TabImporter
/**
...
export class TabImporter {
    ...
    //@+others
    //@+node:felix.20251103192334.1410: *3* tabbed.check
    /**
    ...
    //@+node:felix.20251103192334.1411: *3* tabbed.dump_stack
    /**
    ...
    //@+node:felix.20251103192334.1412: *3* tabbed.import_files
    /**
    ...
    //@+node:felix.20251103192334.1413: *3* tabbed.lws
    /**
    ...
    //@+node:felix.20251103192334.1414: *3* tabbed.prompt_for_files
    /**
     * Prompt for a list of FreeMind (.mm.html) files and import them.
     */
    public async prompt_for_files(): Promise<void> {
    ...
    //@+node:felix.20251103192334.1415: *3* tabbed.scan
    /**
    ...
    //@+node:felix.20251103192334.1416: *3* tabbed.scan_helper
    /**
    ...
    //@+node:felix.20251103192334.1417: *3* tabbed.undent
    /**
...
//@+node:felix.20251103192334.1418: ** class ToDoImporter
export class ToDoImporter {
    ...
    //@+others
    //@+node:felix.20251103192334.1419: *3* todo_i.get_tasks_from_file
    /**
    ...
    //@+node:felix.20251103192334.1420: *3* todo_i.import_files
    /**
    ...
    //@+node:felix.20251103192334.1421: *3* todo_i.parse_file_contents
    /**
    ...
    //@+node:felix.20251103192334.1422: *3* todo_i.prompt_for_files
    /**
...
//@+node:felix.20251103192334.1423: ** class ToDoTask
/**
...
export class ToDoTask {
    ...
    //@+others
    //@+node:felix.20251103192334.1424: *3* task.__repr__ & __str__
    ...
    //@+node:felix.20251103192334.1425: *3* task.parse_task
...
//@+node:felix.20251103192334.1426: ** class ZimImportController
/**
...
export class ZimImportController {
    ...
    //@+others
    //@+node:felix.20251103192334.1427: *3* zic.__init__ & zic.reloadSettings
    /**
    ...
    //@+node:felix.20251103192334.1428: *3* zic.parseZimIndex
    /**
    ...
    //@+node:felix.20251103192334.1429: *3* zic.rstToLastChild
    /**
    ...
    //@+node:felix.20251103192334.1430: *3* zic.clean
    /**
     * Clean useless nodes
     */
    ...
    //@+node:felix.20251103192334.1431: *3* zic.run
    /**
...
//@+node:felix.20251103192334.1432: ** class Node
/**
 * Hold node data.
 */
...
//@+node:felix.20251103192334.1433: ** class LegacyExternalFileImporter
/**
...
export class LegacyExternalFileImporter {
    ...
    //@+others
    //@+node:felix.20251103192334.1434: *3* legacy.add
    /**
    ...
    //@+node:felix.20251103192334.1435: *3* legacy.compute_delim1
    /**
    ...
    //@+node:felix.20251103192334.1436: *3* legacy.import_file
    /**
    ...
    //@+node:felix.20251103192334.1437: *3* legacy.import_files
    /**
    ...
    //@+node:felix.20251103192334.1438: *3* legacy.prompt_for_files
    /**
...
//@+node:felix.20251103192334.1439: ** class TopLevelImportCommands
export class TopLevelImportCommands {
    //@+others
    //@+node:felix.20251103192334.1440: *3* @g.command(import-free-mind-files)
    @command(
    ...
    //@+node:felix.20251103192334.1441: *3* @g.command(import-legacy-external-file)
    @command(
        'import-legacy-external-files',
    ...
    //@+node:felix.20251103192334.1442: *3* @g.command(import-mind-map-files
    @command(
    ...
    //@+node:felix.20251103192334.1443: *3* @g.command(import-MORE-files)
    ...
    //@+node:felix.20251103192334.1444: *3* @g.command(import-tabbed-files)
    ...
    //@+node:felix.20251103192334.1445: *3* @g.command(import-todo-text-files)
    @command(
    ...
    //@+node:felix.20251103192334.1446: *3* @g.command(import-zim-folder)
    @command(
        'import-zim-folder',
    ...
    //@+node:felix.20251103192334.1447: *3* @g.command(parse-body)
    @command(
        'parse-body',
