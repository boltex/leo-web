//@+leo-ver=5-thin
//@+node:felix.20251213133753.2: * @file src/core/findTabManager.ts
//@+<< imports >>
//@+node:felix.20251213133753.3: ** << imports >>
...
//@-<< imports >>
//@+<< types >>
//@+node:felix.20251213133753.4: ** << types >>
...
//@-<< types >>
//@+others
//@+node:felix.20251213133753.5: ** class StringCheckBox (leoGui.py)
/**
...
//@+node:felix.20251213133753.6: ** class StringRadioButton (leoGui.py)
/**
...
//@+node:felix.20251213133753.7: ** class StringLineEdit (leoGui)
/**
...
//@+node:felix.20251213133753.8: ** class StringFindTabManager
/**
...
export class StringFindTabManager {
    ...
    //@+others
    //@+node:felix.20251213133753.9: *3*  sftm.ctor
    /**
    ...
    //@+node:felix.20251213133753.11: *3* sftm.get_settings
    /**
    ...
    //@+node:felix.20251213133753.12: *3* sftm.init_widgets
    /**
    ...
    //@+node:felix.20251213133753.13: *3* ftm.set_widgets_from_dict
    /**
    ...
    public set_widgets_from_dict(d: { [key: string]: any }): void {
        ...
        // This will apply them to the find panel webview
        g.app.gui.loadSearchSettings();

    }
    //@+node:felix.20251213133753.14: *3* sftm.set_body_and_headline_checkbox
    /**
    ...
    //@+node:felix.20251213133753.15: *3* sftm.set_radio_button
    /**
    ...
    //@+node:felix.20251213133753.16: *3* sftm.text getters/setters
    ...
    //@+node:felix.20251213133753.17: *3* sftm.toggle_checkbox
    /**
