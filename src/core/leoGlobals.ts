//@+leo-ver=5-thin
//@+node:felix.20251207215313.1: * @file src/core/leoGlobals.ts
/**
...
//@+node:felix.20251207215313.6: ** << define global decorator dicts >>
/*
...
//@+node:felix.20251207215313.7: ** << define global error regexes >>
...
//@-<< define g.Decorators >>
//@+<< define regex's >>
//@+node:felix.20251207215313.9: ** << define regex's >>
...
//@+others
//@+node:felix.20251207215313.10: ** g.codecs
export const codecs = {
    // UTF-8
...
//@+node:felix.20251207215313.11: ** g.Classes & class accessors
//@+node:felix.20251207215313.12: *3* class g.FileLikeObject (coreGlobals.py)
/**
...
export class FileLikeObject {
    ...
    //@+others
    //@+node:felix.20251207215313.13: *4* FileLikeObject.clear (coreGlobals.py)
    public clear(): void {
        this._list = [];
    }

    //@+node:felix.20251207215313.14: *4* FileLikeObject.close (coreGlobals.py)
    public close(): void {
        // pass
    }

    //@+node:felix.20251207215313.15: *4* FileLikeObject.flush (coreGlobals.py)
    public flush(): void {
        // pass
    }

    //@+node:felix.20251207215313.16: *4* FileLikeObject.get & getvalue & read (coreGlobals.py)
    public get(): string {
    ...
    //@+node:felix.20251207215313.17: *4* FileLikeObject.readline (coreGlobals.py)
    /**
    ...
    //@+node:felix.20251207215313.18: *4* FileLikeObject.write  (coreGlobals.py)
...
//@+node:felix.20251207215313.19: *3* class NullObject (Python Cookbook)
/**
...
//@+node:felix.20251207215313.20: *3* class g.GeneralSetting
...
//@+node:felix.20251207215313.21: *3* class g.RedirectClass & convenience functions
/**
...
class RedirectClass {
    ...
    //@+node:felix.20251207215313.22: *4* << RedirectClass methods >>
    //@+others
    //@+node:felix.20251207215313.23: *5* RedirectClass.__init__
    constructor() {
        this.old = undefined;
        this.encoding = 'utf-8';  // 2019/03/29 For pdb.
    }
    //@+node:felix.20251207215313.24: *5* isRedirected
    public isRedirected(): boolean {
        return this.old !== null;
    }
    //@+node:felix.20251207215313.25: *5* flush
    //  For LeoN: just for compatibility.
    public flush(...args: any[]): void {
        return;
    }
    //@+node:felix.20251207215313.26: *5* rawPrint
    ...
    //@+node:felix.20251207215313.27: *5* redirect
    ...
    //@+node:felix.20251207215313.28: *5* undirect
    ...
    //@+node:felix.20251207215313.29: *5* write
...
//@+node:felix.20251207215313.30: *4* << define convenience methods for redirecting streams >>
//@+others
//@+node:felix.20251207215313.31: *5* redirectStderr & redirectStdout
/**
...
//@+node:felix.20251207215313.32: *5* restoreStderr & restoreStdout
/**
...
//@+node:felix.20251207215313.33: *5* stdErrIsRedirected & stdOutIsRedirected
...
//@+node:felix.20251207215313.34: *5* rawPrint
/**
...
//@-others
//@-<< define convenience methods for redirecting streams >>
//@+node:felix.20251207215313.35: *3* class g.SettingsDict
/**
...
export class SettingsDict extends Map<string, any> {
    ...
    //@+others
    //@+node:felix.20251207215313.36: *4* td.__repr__ & __str__
    ...
    //@+node:felix.20251207215313.38: *4* td.get
    ...
    //@+node:felix.20251207215313.39: *4* td.update
    ...
    //@+node:felix.20251207215313.40: *4* td.add_to_list
    /**
    ...
    //@+node:felix.20251207215313.41: *4* td.get_setting & get_string_setting
    /**
    ...
    //@+node:felix.20251207215313.42: *4* td.name & setName
    public name(): string {
        return this._name;
    }
...
//@+node:felix.20251207215313.43: *3* g.isTextWrapper & isTextWidget
...
//@+node:felix.20251207215313.44: ** g.Debugging, GC, Stats & Timing
//@+node:felix.20251207215313.45: *3* assert
/**
...
//@+node:felix.20251207215313.46: *3* g._assert
/**
...
//@+node:felix.20251207215313.47: *3* g.callers
/**
...
//@+node:felix.20251207215313.52: *3* g.getIvarsDict and checkUnchangedIvars
/**
...
//@+node:felix.20251207215313.53: *3* g.objToSTring     (coreGlobals.py)
/**
...
//@+node:felix.20251207215313.54: *3* g.printObj        (coreGlobals.py)
/**
...
//@+node:felix.20251207215313.55: ** g.Directives
//@+node:felix.20251207215313.56: *3* g.comment_delims_from_extension
/**
...
//@+node:felix.20251207215313.57: *3* g.findAllValidLanguageDirectives
/**
...
//@+node:felix.20251207215313.58: *3* g.findFirstAtLanguageDirective
/**
...
//@+node:felix.20251207215313.59: *3* g.findLanguageDirectives (must be fast)
/**
...
//@+node:felix.20251207215313.60: *3* g.findReference
/**
...
//@+node:felix.20251207215313.61: *3* g.getOutputNewline
/**
...
//@+node:felix.20251207215313.62: *3* g.inAtNosearch
/**
...
//@+node:felix.20251207215313.63: *3* g.isDirective
/**
...
//@+node:felix.20251207215313.64: *3* g.isValidLanguage
/**
...
//@+node:felix.20251207215313.65: *3* g.set_delims_from_language
/**
...
//@+node:felix.20251207215313.66: *3* g.set_delims_from_string
/**
...
//@+node:felix.20251207215313.67: *3* g.set_language
/**
...
//@+node:felix.20251207215313.68: *3* g.stripPathCruft
/**
...
//@+node:felix.20251207215313.69: *3* g.update_directives_pat (new)
/**
...
//@+node:felix.20251207215313.76: *3* g.createHiddenCommander
/**
...
//@+node:felix.20251207215313.77: *3* g.defaultLeoFileExtension
...
//@+node:felix.20251207215313.78: *3* g.ensure_extension
...
//@+node:felix.20251207215313.79: *3* g.filecmp_cmp
...
//@+node:felix.20251207215313.80: *3* g.fullPath
/**
...
//@+node:felix.20251207215313.81: *3* g.is_binary_file/external_file/string
...
//@+node:felix.20251207215313.84: *3* g.openWithFileName
/**
...
//@+node:felix.20251207215313.86: *3* g.readFileToUnicodeString
/**
...
//@+node:felix.20251207215313.87: *3* g.readlineForceUnixNewline
...
//@+node:felix.20251207215313.90: *3* g.setGlobalOpenDir
...
//@+node:felix.20251207215313.91: *3* g.shortFileName
/**
...
//@+node:felix.20251207215313.92: *3* g.splitLongFileName
/**
...
//@+node:felix.20251207215313.93: *3* g.writeFile
/**
...
//@+node:felix.20251207215313.94: *3* g.write_file_if_changed
/**
...
//@+node:felix.20251207215313.97: ** g.Finding & Scanning
//@+node:felix.20251207215313.98: *3* g.find_word
/**
...
//@+node:felix.20251207215313.99: *3* g.findRootsWithPredicate
/**
...
//@+node:felix.20251207215313.100: *3* g.see_more_lines
/**
...
//@+node:felix.20251207215313.101: *3* g.splitLines
/**
...
//@+node:felix.20251207215313.102: *3* g.splitLinesAtNewline
/**
...
//@+node:felix.20251207215313.103: *3* Scanners: no error messages
//@+node:felix.20251207215313.104: *4* g.find_line_start
/**
...
//@+node:felix.20251207215313.105: *4* g.find_on_line
...
//@+node:felix.20251207215313.106: *4* g.is_c_id
export function is_c_id(ch: string): boolean {
    return isWordChar(ch);
}
//@+node:felix.20251207215313.107: *4* g.is_special
/**
...
//@+node:felix.20251207215313.108: *4* g.is_nl
export function is_nl(s: string, i: number): boolean {
    return i < s.length && (s[i] === '\n' || s[i] === '\r');
}

//@+node:felix.20251207215313.109: *4* g.isAlpha
export function isAlpha(ch: string) {
    return /^[A-Z]$/i.test(ch);
}
//@+node:felix.20251207215313.110: *4* g.isAlNum
/**
...
//@+node:felix.20251207215313.111: *4* g.isDigit
export function isDigit(s: string): boolean {
    return s >= '0' && s <= '9';
}
//@+node:felix.20251207215313.112: *4* g.is_ws & is_ws_or_nl
...
//@+node:felix.20251207215313.114: *4* g.match_word & g.match_words
/**
...
//@+node:felix.20251207215313.115: *4* g.skip_blank_lines
/**
...
//@+node:felix.20251207215313.117: *4* g.skip_id
...
//@+node:felix.20251207215313.118: *4* g.skip_line, skip_to_start/end_of_line
/** 
...
//@+node:felix.20251207215313.119: *4* g.skip_long
/**
...
//@+node:felix.20251207215313.120: *4* g.skip_nl
/**
...
//@+node:felix.20251207215313.123: *4* g.skip_string
/**
...
//@+node:felix.20251207215313.124: *4* g.skip_to_char
/**
...
//@+node:felix.20251207215313.125: *4* g.skip_ws, skip_ws_and_nl
...
//@+node:felix.20251207215313.135: *3* g.childrenModifiedSet, g.contentModifiedSet
export const childrenModifiedSet: VNode[] = [];
export const contentModifiedSet: VNode[] = [];
//@+node:felix.20251207215313.136: *3* g.doHook
/**
...
//@+node:felix.20251207215313.137: *3* g.Wrappers for g.app.pluginController methods
// Important: we can not define g.pc here!
//@+node:felix.20251207215313.138: *4* g.Loading & registration
...
//@+node:felix.20251207215313.139: *4* g.Information
/*
...
//@+node:felix.20251207215313.140: ** g.Idle time functions
//@+node:felix.20251207215313.141: *3* g.disableIdleTimeHook
/**
...
//@+node:felix.20251207215313.142: *3* g.enableIdleTimeHook
/**
...
//@+node:felix.20251207215313.143: *3* g.IdleTime
/**
...
//@+node:felix.20251207215313.144: *3* g.idleTimeHookHandler (stub)
/**
...
//@+node:felix.20251207215313.145: ** g.Importing
//@+node:felix.20251207215313.146: ** g.Indices, Strings, Unicode & Whitespace
//@+node:felix.20251207215313.147: *3* g.Indices
//@+node:felix.20251207215313.148: *4* g.convertPythonIndexToRowCol
/**
...
//@+node:felix.20251207215313.149: *4* g.convertRowColToPythonIndex
/**
...
//@+node:felix.20251207215313.150: *4* g.getWord & getLine
/**
 *
 */
...
//@+node:felix.20251207215313.151: *4* g.toPythonIndex
/**
...
//@+node:felix.20251207215313.152: *3* g.Strings
//@+node:felix.20251207215313.153: *4* g.isascii
/*
def isascii(s: str) -> bool:
    # s.isascii() is defined in Python 3.7.
    return all(ord(ch) < 128 for ch in s)
 */
//@+node:felix.20251207215313.154: *4* g.isUpper
export function isUpper(s: string): boolean {
    return s !== s.toLowerCase() && s === s.toUpperCase();
}
//@+node:felix.20251207215313.155: *4* g.capitalize
...
//@+node:felix.20251207215313.156: *4* g.enumerate
...
//@+node:felix.20251207215313.158: *4* g.ensureLeading/TrailingNewlines
 ...
 */
//@+node:felix.20251207215313.160: *4* g.pad
/**
...
//@+node:felix.20251207215313.161: *4* g.removeLeading/Trailing
...
//@+node:felix.20251207215313.162: *4* g.stripBrackets
/*
def stripBrackets(s: str) -> str:
    ...
    return s
 */
//@+node:felix.20251207215313.163: *4* g.unCamel
/*
def unCamel(s: str) -> List[str]:
    ...
    return result
 */
//@+node:felix.20251207215313.164: *3* g.Unicode
//@+node:felix.20251207215313.165: *4* g.checkUnicode
...
//@+node:felix.20251207215313.166: *4* g.getPythonEncodingFromString
/**
...
//@+node:felix.20251207215313.167: *4* g.isWordChar*
/**
...
//@+node:felix.20251207215313.168: *4* g.stripBOM
/**
...
//@+node:felix.20251207215313.169: *4* g.toUnicode
/**
...
//@+node:felix.20251207215313.170: *3* g.Whitespace
//@+node:felix.20251207215313.171: *4* g.computeLeadingWhitespace
...
//@+node:felix.20251207215313.172: *4* g.computeLeadingWhitespaceWidth
/*
# Returns optimized whitespace corresponding to width with the indicated tab_width.
...
def computeLeadingWhitespaceWidth(s: str, tab_width: int) -> int:
    ...
    return w
 */
//@+node:felix.20251207215313.173: *4* g.computeWidth
/**
...
//@+node:felix.20251207215313.174: *4* g.wrap_lines (newer)
        ...
        while (i < s.length) {
            ...
            if (wordLen + line.length <= outputLineWidth) {
                if (wordLen > 0) {
                    ...
                    //@+node:felix.20251207215313.175: *5* << place blank and word on the present line >>
                    if (line) {
                ...
                //@+node:felix.20251207215313.176: *5* << place word on a new line >>
...
//@+node:felix.20251207215313.177: *4* g.get_leading_ws
...
//@+node:felix.20251207215313.178: *4* g.optimizeLeadingWhitespace
...
//@+node:felix.20251207215313.179: *4* g.regularizeTrailingNewlines
...
def regularizeTrailingNewlines(s: str, kind: str) -> None:
    ...
    pass
 */
//@+node:felix.20251207215313.180: *4* g.removeBlankLines
...
//@+node:felix.20251207215313.181: *4* g.removeLeadingBlankLines
...
def removeLeadingBlankLines(s: str) -> str:
    ...
    return ''.join(result)
 */
//@+node:felix.20251207215313.182: *4* g.removeLeadingWhitespace
...
//@+node:felix.20251207215313.183: *4* g.removeTrailingWs
/*
...
def removeTrailingWs(s: str) -> str:
    ...
    return s[: j + 1]
 */
//@+node:felix.20251207215313.184: *4* g.skip_leading_ws
/*
...
def skip_leading_ws(s: str, i: int, ws: int, tab_width: int) -> int:
    ...
    return i
 */
//@+node:felix.20251207215313.185: *4* g.skip_leading_ws_with_indent
/*
/**
...
//@+node:felix.20251207215313.186: *4* g.stripBlankLines
/*
def stripBlankLines(s: str) -> str:
    ...
    return ''.join(lines)
 */
//@+node:felix.20251207215313.187: *3* g.isValidEncoding
/**
...
//@+node:felix.20251207215313.188: *3* g.toEncodedString (coreGlobals.py)
/**
...
//@+node:felix.20251207215313.189: ** g.Logging & Printing
//@+node:felix.20251207215313.190: *3* g.doKeywordArgs
/**
...
//@+node:felix.20251207215313.191: *3* g.error, g.note, g.warning, g.red, g.blue
...
//@+node:felix.20251207215313.192: *3* g.es
...
//@+node:felix.20251207215313.193: *3* g.es_dump
...
//@+node:felix.20251207215313.194: *3* g.es_error & es_print_error
...
//@+node:felix.20251207215313.195: *3* g.es_exception
...
//@+node:felix.20251207215313.196: *3* g.es_print
/**
...
//@+node:felix.20251207215313.197: *3* g.internalError
/**
...
//@+node:felix.20251207215313.199: *3* g.print_exception
/**
...
//@+node:felix.20251207215313.200: *3* g.trace
/**
...
//@+node:felix.20251207215313.201: *3* g.print_unique_message & es_print_unique_message
...
//@+node:felix.20251207215313.204: *3* g.maketrans
...
//@+node:felix.20251207215313.205: *3* g.maketrans_from_dict
/**
...
//@+node:felix.20251207215313.206: *3* g.translate
...
//@+node:felix.20251207215313.207: *3* g.compareArrays
...
//@+node:felix.20251207215313.208: *3* g.comparePositionArray
...
//@+node:felix.20251207215313.209: *3* g.process_time
/**
...
//@+node:felix.20251207215313.210: *3* g.convertPythonDayjs
...
//@+node:felix.20251207215313.211: *3* g.dedent
/**
...
//@+node:felix.20251207215313.212: *3* g.issueSecurityWarning
...
//@+node:felix.20251207215313.213: *3* g.reEscape
...
//@+node:felix.20251207215313.214: *3* g.ltrim
...
//@+node:felix.20251207215313.215: *3* g.rtrim
...
//@+node:felix.20251207215313.217: *3* g.plural (coreGlobals.py)
/**
...
//@+node:felix.20251207215313.218: *3* g.rjust
...
//@+node:felix.20251207215313.219: *3* g.useSyntaxColoring
/**
...
//@+node:felix.20251207215313.220: *3* g.findColorDirectives
/**
...
//@+node:felix.20251207215313.227: *3* g.finalize
/**
 *
...
//@+node:felix.20251207215313.228: *3* g.finalize_join
/**
...
//@+node:felix.20251207215313.229: *3* g.glob_glob
...
//     return aList
//@+node:felix.20251207215313.230: *3* g.os_path_abspath
/**
...
//@+node:felix.20251207215313.231: *3* g.os_path_basename
/**
...
//@+node:felix.20251207215313.232: *3* g.os_path_dirname
/**
...
//@+node:felix.20251207215313.234: *3* g.os_path_expanduser
/**
...
//@+node:felix.20251207215313.235: *3* g.os_path_expandvars
...
//@+node:felix.20251207215313.236: *3* g.os_path_getmtime
/**
...
//@+node:felix.20251207215313.237: *3* g.os_path_getsize
/**
...
//@+node:felix.20251207215313.238: *3* g.os_path_isabs
/**
...
//@+node:felix.20251207215313.239: *3* g.os_path_isdir
/**
...
//@+node:felix.20251207215313.240: *3* g.os_path_isfile
/**
...
//@+node:felix.20251207215313.241: *3* g.PYTHON_os_path_join
/**
...
//@+node:felix.20251207215313.242: *3* g.os_path_join
/**
...
//@+node:felix.20251207215313.243: *3* g.os_path_fix_drive
...
//@+node:felix.20251207215313.244: *3* g.os_path_normcase
/**
...
//@+node:felix.20251207215313.245: *3* g.os_path_normpath
/**
...
//@+node:felix.20251207215313.246: *3* g.os_path_normslashes
/**
...
//@+node:felix.20251207215313.247: *3* g.os_path_realpath
/**
...
//@+node:felix.20251207215313.248: *3* g.os_path_relpath
export function os_path_relpath(start: string, target: string): string {
    return path.relative(start, target);
}
//@+node:felix.20251207215313.249: *3* g.os_path_samefile
...
//@+node:felix.20251207215313.250: *3* g.os_path_split
...
//@+node:felix.20251207215313.251: *3* g.os_path_splitext
...
//@+node:felix.20251207215313.252: *3* g.os_startfile
...
//@+node:felix.20251207215313.253: *4* stderr2log()
...
//         else:
//             break
//@+node:felix.20251207215313.254: *4* itPoll()
...
//         stderr2log(g, ree, fname)
//         ree.close()
//@+node:felix.20251207215313.255: ** g.Parsing & Tokenizing
//@+node:felix.20251207215313.256: *3* g.createTopologyList
/**
...
//@+node:felix.20251207215313.257: *3* g.getDocString
/**
...
//@+node:felix.20251207215313.258: *3* g.getDocStringForFunction
/**
...
//@+node:felix.20251207215313.259: *3* g.python_tokenize (not used)
/**
...
//@+node:felix.20251207215313.260: ** g.Scripting
//@+node:felix.20251207215313.261: *3* g.execute_shell_commands
/**
...
//@+node:felix.20251207215313.262: *3* g.execute_shell_commands_with_options & helpers
/**
...
//@+node:felix.20251207215313.263: *4* g.computeBaseDir
/**
...
//@+node:felix.20251207215313.264: *4* g.computeCommands
/**
...
//@+node:felix.20251207215313.265: *3* g.getScript & helpers
/**
...
//@+node:felix.20251207215313.266: *4* g.composeScript
/**
...
//@+node:felix.20251207215313.267: *4* g.extractExecutableString
/**
...
//@+node:felix.20251207215313.268: *3* g.find*Node*
//@+others
//@+node:felix.20251207215313.269: *4* g.findNodeAnywhere
...
//@+node:felix.20251207215313.270: *4* g.findNodeInTree
/**
...
//@-others
//@+node:felix.20251207215313.271: *3* g.handleScriptException
export function handleScriptException(
    ...
    try {
        ...
        //@+node:felix.20251207215313.272: *4* << dump the lines near the error >>
...
//@+node:felix.20251207215313.273: ** g.Sentinels
//@+node:felix.20251207215313.274: *3* g.is_invisible_sentinel
/**
...
//@+node:felix.20251207215313.275: *3* g.is_sentinel
/**
...
//@+node:felix.20251207215313.276: ** g.Unit Tests
//@+node:felix.20251207215313.277: ** g.Urls & UNLs
//@+<< About clickable links >>
//@+node:felix.20251207215313.278: *3* << About clickable links >>
/*
...
*/
//@-<< About clickable links >>
//@+node:felix.20251207215313.279: *3* g.computeFileUrl
/**
...
//@+node:felix.20251207215313.280: *3* g.es_clickable_link (not used)
/**
...
//@+node:felix.20251207215313.281: *3* g.findAnyUnl
/** 
...
//@+node:felix.20251207215313.282: *3* g.findGnx (new unls)
/**
...
//@+node:felix.20251207215313.283: *3* g.findUnl & helpers (legacy unls)
/**
...
export async function findUnl(unlList1: string[], c: Commands): Promise<Position | undefined> {
    ...
    //@+node:felix.20251207215313.284: *4* function: convert_unl_list
    /**
    ...
    //@+node:felix.20251207215313.285: *4* function: full_match
    /**
...
//@+node:felix.20251207215313.286: *3* g.getUrlFromNode
/**
...
//@+node:felix.20251207215313.287: *3* g.handleUnl
/**
...
//@+node:felix.20251207215313.288: *3* g.handleUrl & helpers
/**
 * Open a url or a unl.
 */
...
//@+node:felix.20251207215313.289: *4* g.handleUrlHelper
/**
...
//@+node:felix.20251207215313.290: *4* g.traceUrl
...
//@+node:felix.20251207215313.291: *3* g.isValidUnl
...
//@+node:felix.20251207215313.292: *3* g.isValidUrl
/**
...
//@+node:felix.20251207215313.293: *3* g.openUrl
/**
...
//@+node:felix.20251207215313.294: *3* g.open_mimetype
/**
...
export async function openUrlHelper(c: Commands, url?: string): Promise<string | undefined> {
    ...
    if (url == null) {
        ...
        //@+node:felix.20251207215313.297: *5* << look for section ref >>
        ...
        //@+<< look for url >>
        //@+node:felix.20251207215313.298: *5* << look for url  >>
        let match;
        ...
        if (!url) {
            //@+<< look for unl >>
            //@+node:felix.20251207215313.299: *5* << look for unl >>
            ...
            if (!unl) {
                //@+<< look for gnx >>
                //@+node:felix.20251207215313.300: *5* << look for gnx >>
                let target: string = "";
    ...
    //@+node:felix.20251207215313.301: *5* << look for filename or import >>
...
//@+node:felix.20251207215313.303: *3* g: file part utils
//@+node:felix.20251207215313.304: *4* g.getUNLFilePart
...
//@+node:felix.20251207215313.306: *4* g.parsePathData
