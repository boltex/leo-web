...
//@+node:felix.20251214160339.703: ** << class ParserBaseClass >>
/**
...
export class ParserBaseClass {
    ...
    //@-<< ParserBaseClass data >>
    //@+others
    //@+node:felix.20251214160339.705: *3*  pbc.ctor
    ...
    //@+node:felix.20251214160339.707: *3* pbc.createModeCommand
    /**
    ...
    //@+node:felix.20251214160339.708: *3* pbc.error
    ...
    //@+node:felix.20251214160339.709: *3* pbc.kind handlers
    //@+node:felix.20251214160339.710: *4* pbc.doBool
    ...
    //@+node:felix.20251214160339.711: *4* pbc.doButtons
    /**
    ...
    //@+node:felix.20251214160339.712: *4* pbc.doColor
    ...
    //@+node:felix.20251214160339.713: *4* pbc.doCommands
    /**
    ...
    //@+node:felix.20251214160339.714: *4* pbc.doData
    ...
    //@+node:felix.20251214160339.715: *4* pbc.doOutlineData & helper
    ...
    //@+node:felix.20251214160339.716: *5* pbc.getOutlineDataHelper
    ...
    //@+node:felix.20251214160339.717: *4* pbc.doDirectory & doPath
    public doDirectory(
        p: Position,
        kind: string,
        name: string,
    ...
    //@+node:felix.20251214160339.718: *4* pbc.doEnabledPlugins
    ...
    //@+node:felix.20251214160339.719: *4* pbc.doFloat
    ...
    //@+node:felix.20251214160339.720: *4* pbc.doFont
    /**
    ...
    //@+node:felix.20251214160339.721: *4* pbc.doIfEnv
    /**
    ...
    //@+node:felix.20251214160339.722: *4* pbc.doIfHostname
    /**
    ...
    //@+node:felix.20251214160339.723: *4* pbc.doIfPlatform
    /**
    ...
    //@+node:felix.20251214160339.724: *4* pbc.doIgnore
    public doIgnore(p: Position, kind: string, name: string, val: any): string {
        return 'skip';
    }

    //@+node:felix.20251214160339.725: *4* pbc.doInt
    ...
    //@+node:felix.20251214160339.726: *4* pbc.doInts
    /**
     * We expect either:
    ...
    //@+node:felix.20251214160339.727: *4* pbc.doMenuat
    /**
    ...
    //@+node:felix.20251214160339.729: *5* pbc.dumpMenuTree
    ...
    //@+node:felix.20251214160339.734: *4* pbc.doOpenWith
    ...
    //@+node:felix.20251214160339.735: *4* pbc.doPopup & helper
    /**
    ...
    //@+node:felix.20251214160339.736: *5* pbc.doPopupItems
    ...
    //@+node:felix.20251214160339.737: *4* pbc.doRatio
    ...
    //@+node:felix.20251214160339.738: *4* pbc.doShortcuts
    /**
    ...
    //@+node:felix.20251214160339.739: *5* pbc.doOneShortcut
    /**
    ...
    //@+node:felix.20251214160339.740: *4* pbc.doString
    public doString(p: Position, kind: string, name: string, val: any): void {
        // At present no checking is done.
        this.set(p, kind, name, val);
    }

    //@+node:felix.20251214160339.741: *4* pbc.doStrings
    /**
    ...
    //@+node:felix.20251214160339.742: *3* pbc.munge
    public munge(s: string): string {
        return g.app.config.canonicalizeSettingName(s)!;
    }
    //@+node:felix.20251214160339.743: *3* pbc.oops
    public oops(): void {
        g.pr(
    ...
    //@+node:felix.20251214160339.744: *3* pbc.parsers
    //@+node:felix.20251214160339.745: *4* pbc.parseFont & helper
    ...
    //@+node:felix.20251214160339.746: *5* pbc.parseFontLine
    ...
    //@+node:felix.20251214160339.747: *4* pbc.parseHeadline
    /**
    ...
    //@+node:felix.20251214160339.748: *4* pbc.parseOpenWith & helper
    ...
    //@+node:felix.20251214160339.749: *5* pbc.parseOpenWithLine
    ...
    //@+node:felix.20251214160339.750: *4* pbc.parseShortcutLine
    /**
    ...
    //@+node:felix.20251214160339.751: *3* pbc.set
    /**
    ...
    //@+node:felix.20251214160339.752: *3* pbc.traverse
    /**
    ...
    //@+node:felix.20251214160339.753: *3* pbc.valueError
    /**
    ...
    //@+node:felix.20251214160339.754: *3* pbc.visitNode (must be overwritten in subclasses)
...
//@-<< class ParserBaseClass >>
//@+others
//@+node:felix.20251214160339.755: ** class ActiveSettingsOutline
export class ActiveSettingsOutline {
    ...
    //@+others
    //@+node:felix.20251214160339.756: *3* aso.start & helpers
    /** 
    ...
    //@+node:felix.20251214160339.757: *4* aso.create_commanders_list
    /**
    ...
    //@+node:felix.20251214160339.758: *4* aso.load_hidden_commanders
    /**
    ...
    //@+node:felix.20251214160339.759: *4* aso.new_commander
    /**
    ...
    //@+node:felix.20251214160339.760: *3* aso.create_outline & helper
    /**
    ...
    //@+node:felix.20251214160339.762: *3* aso.create_inner_outline
    /**
    ...
    //@+node:felix.20251214160339.763: *3* aso.create_unified_settings
    /**
    ...
    public create_unified_settings(kind: string, root: Position, settings_root: Position): void {
        ...
        for (const p of settings_root.subtree()) {
            ...
            //@+node:felix.20251214160339.764: *4* << continue if we should ignore p >>
            if (ignore) {
                if (p.__eq__(ignore)) {
                    ignore = undefined;
                } else {
    ...
    //@+node:felix.20251214160339.766: *3* aso.add
    /**
     * Add a node for p.
     *
    ...
    //@+node:felix.20251214160339.767: *3* aso.clean
    /**
    ...
    //@+node:felix.20251214160339.768: *3* aso.filter_settings
    /**
...
//@+node:felix.20251214160339.769: ** class GlobalConfigManager
/**
...
export class GlobalConfigManager {
    ...
    //@+others
    //@+node:felix.20251214160339.770: *3* gcm.ctor
    constructor() {
    ...
    //@+node:felix.20251214160339.771: *3* gcm.config_iter
    ...
    */
    //@+node:felix.20251214160339.772: *3* gcm.canonicalizeSettingName (munge)
    ...
    //@+node:felix.20251214160339.773: *3* gcm.Getters...
    //@+node:felix.20251214160339.774: *4* gcm.exists
    /**
    ...
    //@+node:felix.20251214160339.775: *4* gcm.get & allies
    /**
    ...
    //@+node:felix.20251214160339.776: *5* gcm.getValFromDict
    /**
    ...
    //@+node:felix.20251214160339.777: *5* gcm.typesMatch
    /**
    ...
    //@+node:felix.20251214160339.778: *4* gcm.getAbbrevDict
    /**
    ...
    //@+node:felix.20251214160339.779: *4* gcm.getBool
    /**
    ...
    //@+node:felix.20251214160339.780: *4* gcm.getButtons
    /**
    ...
    //@+node:felix.20251214160339.781: *4* gcm.getColor
    /**
    ...
    //@+node:felix.20251214160339.782: *4* gcm.getCommonCommands
    /**
    ...
    //@+node:felix.20251214160339.783: *4* gcm.getData & getOutlineData
    /**
    ...
    //@+node:felix.20251214160339.784: *4* gcm.getDirectory
    /**
     ...
     */
    //@+node:felix.20251214160339.786: *4* gcm.getFloat
    /**
     ...
     */
    //@+node:felix.20251214160339.788: *4* gcm.getInt
    /**
    ...
    //@+node:felix.20251214160339.789: *4* gcm.getLanguage
    /**
    ...
    //@+node:felix.20251214160339.790: *4* gcm.getMenusList
    /**
    ...
    //@+node:felix.20251214160339.791: *4* gcm.getOpenWith
    /**
    ...
    //@+node:felix.20251214160339.792: *4* gcm.getRatio
    /**
    ...
    //@+node:felix.20251214160339.793: *4* gcm.getRecentFiles
    /**
    ...
    //@+node:felix.20251214160339.794: *4* gcm.getString
    /**
    ...
    //@+node:felix.20251214160339.795: *3* gcm.valueInMyLeoSettings
    /**
...
//@+node:felix.20251214160339.796: ** class LocalConfigManager
/**
...
export class LocalConfigManager {
    ...
    //@+node:felix.20251214160339.798: *3* c.config.createActivesSettingsOutline (new: #852)
    /**
    ...
    //@+node:felix.20251214160339.799: *3* c.config.getSource
    /**
    ...
    //@+node:felix.20251214160339.800: *3* c.config.Getters
    //@+node:felix.20251214160339.801: *4* c.config.findSettingsPosition & helper
    ...
    //@+node:felix.20251214160339.802: *5* c.config.settingsRoot
    /**
    ...
    //@+node:felix.20251214160339.803: *4* c.config.Getters
    //@@nocolor-node
    ...
    //@+node:felix.20251214160339.804: *5* c.config.get & allies
    /**
     * Get the setting and make sure its type matches the expected type.
     */
    public get(setting: string, kind?: string): any {
    ...
    //@+node:felix.20251214160339.805: *6* c.config.getValFromDict
    /**
     * Look up the setting in d. If warn is True, warn if the requested type
     * does not (loosely) match the actual type.
     * returns (val,exists)
    ...
    //@+node:felix.20251214160339.806: *6* c.config.typesMatch
    /**
     * Return True if type1, the actual type, matches type2, the requeseted type.
     *
     * The following equivalences are allowed:
    ...
    //@+node:felix.20251214160339.807: *5* c.config.getAbbrevDict
    /**
     * Search all dictionaries for the setting & check it's type
     * @returns
     */
    ...
    //@+node:felix.20251214160339.808: *5* c.config.getBool
    /**
     * Return the value of @bool setting, or the default if the setting is not found.
    ...
    //@+node:felix.20251214160339.809: *5* c.config.getColor
    /**
     * Return the value of @color setting.
    ...
    //@+node:felix.20251214160339.810: *5* c.config.getData
    /**
     * Return a list of non-comment strings in the body text of @data setting.
     * @param setting
    ...
    //@+node:felix.20251214160339.811: *5* c.config.getOutlineData
    /**
     * Return the pastable (xml) text of the entire @outline-data tree.
     * @param setting
     * @returns string
    ...
    //@+node:felix.20251214160339.812: *5* c.config.getDirectory
    /**
    ...
    //@+node:felix.20251214160339.813: *5* c.config.getFloat
    /**
     * Return the value of @float setting.
     * @param setting
     */
    ...
    //@+node:felix.20251214160339.814: *5* c.config.getFontFromParams
    /**
    ...
    //@+node:felix.20251214160339.815: *5* c.config.getInt
    /**
     * Return the value of @int setting.
     * @param setting
     */
    ...
    //@+node:felix.20251214160339.816: *5* c.config.getLanguage
    /**
     * Return the setting whose value should be a language known to Leo.
     * @param setting
     */
    ...
    //@+node:felix.20251214160339.817: *5* c.config.getMenusList
    /**
     * Return the list of entries for the @menus tree.
     */
    ...
    //@+node:felix.20251214160339.818: *5* c.config.getOpenWith
    /**
     * Return a list of dictionaries corresponding to @openwith nodes.
     * @returns
     */
    ...
    //@+node:felix.20251214160339.819: *5* c.config.getRatio
    /**
     * Return the value of @float setting, or None if there is an error.
     */
    ...
    //@+node:felix.20251214160339.820: *5* c.config.getSettingSource
    /**
    ...
    //@+node:felix.20251214160339.821: *5* c.config.getShortcut
    ...
    //@+node:felix.20251214160339.822: *5* c.config.getString
    /**
     * Return the value of @string setting.
     * @param setting
     */
    ...
    //@+node:felix.20251214160339.823: *4* c.config.Getters: redirect to g.app.config
    /**
     * Return a list of tuples (x,y) for common @button nodes.
     * @param setting
     */
    ...
    //@+node:felix.20251214160339.824: *4* c.config.isLocalSetting
    /**
    ...
    //@+node:felix.20251214160339.827: *3* c.config.printSettings
    /**
    ...
    //@+node:felix.20251214160339.828: *3* c.config.set
    /**
     * Init the setting for name to val.
     *
    ...
    //@+node:felix.20251214160339.829: *3* c.config.settingIsActiveInPath
    /**
    ...
    //@+node:felix.20251214160339.830: *3* c.config.setUserSetting
    /**
...
//@+node:felix.20251214160339.831: ** class SettingsTreeParser (ParserBaseClass)
/**
...
export class SettingsTreeParser extends ParserBaseClass {
    ...
    //@+others
    //@+node:felix.20251214160339.832: *3* ctor (SettingsTreeParser)
    //@+node:felix.20251214160339.833: *3* visitNode (SettingsTreeParser)
    /**
