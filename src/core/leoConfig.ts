//@+leo-ver=5-thin
//@+node:felix.20251103192334.706: * @file src/core/leoConfig.ts
//@+<< imports >>
//@+node:felix.20251103192334.707: ** << imports >>
...
//@+node:felix.20251103192334.708: ** << class ParserBaseClass >>
/**
...
export class ParserBaseClass {
    ...
    //@+node:felix.20251103192334.709: *3* << ParserBaseClass data >>
    ...
    //@-<< ParserBaseClass data >>
    //@+others
    //@+node:felix.20251103192334.710: *3*  pbc.ctor
    ...
    //@+node:felix.20251103192334.711: *3* pbc.computeModeName
    ...
    //@+node:felix.20251103192334.712: *3* pbc.createModeCommand
    /**
    ...
    //@+node:felix.20251103192334.713: *3* pbc.error
    ...
    //@+node:felix.20251103192334.714: *3* pbc.kind handlers
    //@+node:felix.20251103192334.715: *4* pbc.doBool
    ...
    //@+node:felix.20251103192334.716: *4* pbc.doButtons
    /**
    ...
    //@+node:felix.20251103192334.717: *4* pbc.doColor
    ...
    //@+node:felix.20251103192334.718: *4* pbc.doCommands
    /**
    ...
    //@+node:felix.20251103192334.719: *4* pbc.doData
    ...
    //@+node:felix.20251103192334.720: *4* pbc.doOutlineData & helper
    ...
    //@+node:felix.20251103192334.721: *5* pbc.getOutlineDataHelper
    ...
    //@+node:felix.20251103192334.722: *4* pbc.doDirectory & doPath
    public doDirectory(
        p: Position,
        kind: string,
        name: string,
    ...
    //@+node:felix.20251103192334.723: *4* pbc.doEnabledPlugins
    ...
    //@+node:felix.20251103192334.724: *4* pbc.doFloat
    ...
    //@+node:felix.20251103192334.725: *4* pbc.doFont
    /**
    ...
    //@+node:felix.20251103192334.726: *4* pbc.doIfEnv
    /**
    ...
    //@+node:felix.20251103192334.727: *4* pbc.doIfHostname
    /**
    ...
    //@+node:felix.20251103192334.728: *4* pbc.doIfPlatform
    /**
    ...
    //@+node:felix.20251103192334.729: *4* pbc.doIgnore
    public doIgnore(p: Position, kind: string, name: string, val: any): string {
        return 'skip';
    }

    //@+node:felix.20251103192334.730: *4* pbc.doInt
    ...
    //@+node:felix.20251103192334.731: *4* pbc.doInts
    /**
     * We expect either:
    ...
    //@+node:felix.20251103192334.732: *4* pbc.doMenuat
    /**
    ...
    //@+node:felix.20251103192334.733: *5* pbc.getName
    ...
    //@+node:felix.20251103192334.734: *5* pbc.dumpMenuTree
    ...
    //@+node:felix.20251103192334.735: *5* pbc.patchMenuTree
    ...
    //@+node:felix.20251103192334.736: *4* pbc.doMenus & helper
    ...
    //@+node:felix.20251103192334.737: *5* pbc.doItems
    ...
    //@+node:felix.20251103192334.738: *4* pbc.doMode
    /**
    ...
    //@+node:felix.20251103192334.739: *4* pbc.doOpenWith
    ...
    //@+node:felix.20251103192334.740: *4* pbc.doPopup & helper
    /**
    ...
    //@+node:felix.20251103192334.741: *5* pbc.doPopupItems
    ...
    //@+node:felix.20251103192334.742: *4* pbc.doRatio
    ...
    //@+node:felix.20251103192334.743: *4* pbc.doShortcuts
    /**
    ...
    //@+node:felix.20251103192334.744: *5* pbc.doOneShortcut
    /**
    ...
    //@+node:felix.20251103192334.745: *4* pbc.doString
    public doString(p: Position, kind: string, name: string, val: any): void {
        // At present no checking is done.
        this.set(p, kind, name, val);
    }

    //@+node:felix.20251103192334.746: *4* pbc.doStrings
    /**
    ...
    //@+node:felix.20251103192334.747: *3* pbc.munge
    public munge(s: string): string {
        return g.app.config.canonicalizeSettingName(s)!;
    }
    //@+node:felix.20251103192334.748: *3* pbc.oops
    public oops(): void {
        g.pr(
    ...
    //@+node:felix.20251103192334.749: *3* pbc.parsers
    //@+node:felix.20251103192334.750: *4* pbc.parseFont & helper
    ...
    //@+node:felix.20251103192334.751: *5* pbc.parseFontLine
    ...
    //@+node:felix.20251103192334.752: *4* pbc.parseHeadline
    /**
    ...
    //@+node:felix.20251103192334.753: *4* pbc.parseOpenWith & helper
    ...
    //@+node:felix.20251103192334.754: *5* pbc.parseOpenWithLine
    ...
    //@+node:felix.20251103192334.755: *4* pbc.parseShortcutLine
    /**
    ...
    //@+node:felix.20251103192334.756: *3* pbc.set
    /**
    ...
    //@+node:felix.20251103192334.757: *3* pbc.traverse
    /**
    ...
    //@+node:felix.20251103192334.758: *3* pbc.valueError
    /**
    ...
    //@+node:felix.20251103192334.759: *3* pbc.visitNode (must be overwritten in subclasses)
...
//@-<< class ParserBaseClass >>
//@+others
//@+node:felix.20251103192334.760: ** class ActiveSettingsOutline
export class ActiveSettingsOutline {
    ...
    //@+others
    //@+node:felix.20251103192334.761: *3* aso.start & helpers
    /** 
    ...
    //@+node:felix.20251103192334.762: *4* aso.create_commanders_list
    /**
    ...
    //@+node:felix.20251103192334.763: *4* aso.load_hidden_commanders
    /**
    ...
    //@+node:felix.20251103192334.764: *4* aso.new_commander
    /**
    ...
    //@+node:felix.20251103192334.765: *3* aso.create_outline & helper
    /**
    ...
    //@+node:felix.20251103192334.766: *4* aso.legend
    /**
    ...
    //@+node:felix.20251103192334.767: *3* aso.create_inner_outline
    /**
    ...
    //@+node:felix.20251103192334.768: *3* aso.create_unified_settings
    /**
    ...
    public create_unified_settings(kind: string, root: Position, settings_root: Position): void {
        ...
        for (const p of settings_root.subtree()) {
            ...
            //@+node:felix.20251103192334.769: *4* << continue if we should ignore p >>
            if (ignore) {
                if (p.__eq__(ignore)) {
                    ignore = undefined;
                } else {
            ...
            if (m[2] && valid_list.includes(m[1])) {
                ...
                //@+node:felix.20251103192334.770: *4* << handle a real setting >>
    ...
    //@+node:felix.20251103192334.771: *3* aso.add
    /**
     * Add a node for p.
     *
    ...
    //@+node:felix.20251103192334.772: *3* aso.clean
    /**
    ...
    //@+node:felix.20251103192334.773: *3* aso.filter_settings
    /**
...
//@+node:felix.20251103192334.774: ** class GlobalConfigManager
/**
...
export class GlobalConfigManager {
    ...
    //@+others
    //@+node:felix.20251103192334.775: *3* gcm.ctor
    constructor() {
    ...
    //@+node:felix.20251103192334.776: *3* gcm.config_iter
    ...
    */
    //@+node:felix.20251103192334.777: *3* gcm.canonicalizeSettingName (munge)
    ...
    //@+node:felix.20251103192334.778: *3* gcm.Getters...
    //@+node:felix.20251103192334.779: *4* gcm.exists
    /**
    ...
    //@+node:felix.20251103192334.780: *4* gcm.get & allies
    /**
    ...
    //@+node:felix.20251103192334.781: *5* gcm.getValFromDict
    /**
    ...
    //@+node:felix.20251103192334.782: *5* gcm.typesMatch
    /**
    ...
    //@+node:felix.20251103192334.783: *4* gcm.getAbbrevDict
    /**
    ...
    //@+node:felix.20251103192334.784: *4* gcm.getBool
    /**
    ...
    //@+node:felix.20251103192334.785: *4* gcm.getButtons
    /**
    ...
    //@+node:felix.20251103192334.786: *4* gcm.getColor
    /**
    ...
    //@+node:felix.20251103192334.787: *4* gcm.getCommonCommands
    /**
    ...
    //@+node:felix.20251103192334.788: *4* gcm.getData & getOutlineData
    /**
    ...
    //@+node:felix.20251103192334.789: *4* gcm.getDirectory
    /**
    ...
    //@+node:felix.20251103192334.792: *4* gcm.getFontFromParams
    // * LEOJS : UNUSED FOR NOW
     ...
     */
    //@+node:felix.20251103192334.793: *4* gcm.getInt
    /**
    ...
    //@+node:felix.20251103192334.794: *4* gcm.getLanguage
    /**
    ...
    //@+node:felix.20251103192334.795: *4* gcm.getMenusList
    /**
    ...
    //@+node:felix.20251103192334.796: *4* gcm.getOpenWith
    /**
    ...
    //@+node:felix.20251103192334.797: *4* gcm.getRatio
    /**
    ...
    //@+node:felix.20251103192334.798: *4* gcm.getRecentFiles
    /**
    ...
    //@+node:felix.20251103192334.799: *4* gcm.getString
    /**
    ...
    //@+node:felix.20251103192334.800: *3* gcm.valueInMyLeoSettings
    /**
...
//@+node:felix.20251103192334.801: ** class LocalConfigManager
/**
...
export class LocalConfigManager {
    ...
    //@+others
    //@+node:felix.20251103192334.802: *3* c.config.ctor
    ...
    //@+node:felix.20251103192334.803: *3* c.config.createActivesSettingsOutline (new: #852)
    /**
    ...
    //@+node:felix.20251103192334.804: *3* c.config.getSource
    /**
    ...
    //@+node:felix.20251103192334.805: *3* c.config.Getters
    //@+node:felix.20251103192334.806: *4* c.config.findSettingsPosition & helper
    ...
    //@+node:felix.20251103192334.807: *5* c.config.settingsRoot
    /**
    ...
    //@+node:felix.20251103192334.808: *4* c.config.Getters
    //@@nocolor-node
    ...
    //@+node:felix.20251103192334.809: *5* c.config.get & allies
    /**
     * Get the setting and make sure its type matches the expected type.
     */
    public get(setting: string, kind?: string): any {
    ...
    //@+node:felix.20251103192334.810: *6* c.config.getValFromDict
    /**
     * Look up the setting in d. If warn is True, warn if the requested type
     * does not (loosely) match the actual type.
     * returns (val,exists)
    ...
    //@+node:felix.20251103192334.811: *6* c.config.typesMatch
    /**
     * Return True if type1, the actual type, matches type2, the requeseted type.
     *
     * The following equivalences are allowed:
    ...
    //@+node:felix.20251103192334.812: *5* c.config.getAbbrevDict
    /**
     * Search all dictionaries for the setting & check it's type
     * @returns
     */
    ...
    //@+node:felix.20251103192334.813: *5* c.config.getBool
    /**
     * Return the value of @bool setting, or the default if the setting is not found.
    ...
    //@+node:felix.20251103192334.814: *5* c.config.getColor
    /**
     * Return the value of @color setting.
    ...
    //@+node:felix.20251103192334.815: *5* c.config.getData
    /**
     * Return a list of non-comment strings in the body text of @data setting.
     * @param setting
    ...
    //@+node:felix.20251103192334.816: *5* c.config.getOutlineData
    /**
     * Return the pastable (xml) text of the entire @outline-data tree.
     * @param setting
     * @returns string
    ...
    //@+node:felix.20251103192334.817: *5* c.config.getDirectory
    /**
    ...
    //@+node:felix.20251103192334.818: *5* c.config.getFloat
    /**
     * Return the value of @float setting.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.819: *5* c.config.getFontFromParams
    /**
    ...
    //@+node:felix.20251103192334.820: *5* c.config.getInt
    /**
     * Return the value of @int setting.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.821: *5* c.config.getLanguage
    /**
     * Return the setting whose value should be a language known to Leo.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.822: *5* c.config.getMenusList
    /**
     * Return the list of entries for the @menus tree.
     */
    ...
    //@+node:felix.20251103192334.823: *5* c.config.getOpenWith
    /**
     * Return a list of dictionaries corresponding to @openwith nodes.
     * @returns
     */
    ...
    //@+node:felix.20251103192334.824: *5* c.config.getRatio
    /**
     * Return the value of @float setting, or None if there is an error.
     */
    ...
    //@+node:felix.20251103192334.825: *5* c.config.getSettingSource
    /**
    ...
    //@+node:felix.20251103192334.826: *5* c.config.getShortcut
    ...
    //@+node:felix.20251103192334.827: *5* c.config.getString
    /**
     * Return the value of @string setting.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.828: *4* c.config.Getters: redirect to g.app.config
    /**
     * Return a list of tuples (x,y) for common @button nodes.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.829: *4* c.config.isLocalSetting
    /**
    ...
    //@+node:felix.20251103192334.830: *4* c.config.isLocalSettingsFile
    /**
    ...
    //@+node:felix.20251103192334.831: *4* c.exists
    /**
     * Return true if a setting of the given kind exists, even if it is None.
     * @param setting
     */
    ...
    //@+node:felix.20251103192334.832: *3* c.config.printSettings
    /**
    ...
    //@+node:felix.20251103192334.833: *3* c.config.set
    /**
     * Init the setting for name to val.
     *
    ...
    //@+node:felix.20251103192334.834: *3* c.config.settingIsActiveInPath
    /**
    ...
    //@+node:felix.20251103192334.835: *3* c.config.setUserSetting
    /**
...
//@+node:felix.20251103192334.836: ** class SettingsTreeParser (ParserBaseClass)
/**
...
export class SettingsTreeParser extends ParserBaseClass {
    ...
    //@+others
    //@+node:felix.20251103192334.837: *3* ctor (SettingsTreeParser)
    //@+node:felix.20251103192334.838: *3* visitNode (SettingsTreeParser)
    /**
