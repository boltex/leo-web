...
export class ExternalFile {
    ...
    //@+others
    //@+node:felix.20251214160339.837: *3* ef.shortFileName
    public shortFileName(): string {
        return g.shortFilename(this.path);
    }
    //@+node:felix.20251214160339.838: *3* ef.exists
    /**
...
//@+node:felix.20251214160339.839: ** class ExternalFilesController
/**
 *
...
export class ExternalFilesController {
    ...
    //@+others
    //@+node:felix.20251214160339.840: *3* efc.ctor
    /**
    ...
    //@+node:felix.20251214160339.841: *3* efc.entries
    //@+node:felix.20251214160339.842: *4* efc.check_overwrite (called from c.checkTimeStamp)
    /**
    ...
    //@+node:felix.20251214160339.843: *4* efc.destroy_frame
    /**
    ...
    //@+node:felix.20251214160339.844: *4* efc.find_path_for_node (called from vim.py)
    /**
    ...
    //@+node:felix.20251214160339.845: *4* efc.on_idle & helpers
    ...
    //@+node:felix.20251214160339.846: *5* efc.idle_check_commander
    /**
    ...
    //@+node:felix.20251214160339.847: *5* efc.idle_check_leo_file
    /**
    ...
    //@+node:felix.20251214160339.849: *6* efc.update_open_with_node
    /**
    ...
    //@+node:felix.20251214160339.850: *4* efc.open_with & helpers
    /**
    ...
    //     }
    // }
    //@+node:felix.20251214160339.851: *5* efc.compute_ext
    /**
    ...
    //@+node:felix.20251214160339.852: *5* efc.compute_temp_file_path & helpers
    /**
    ...
    //@+node:felix.20251214160339.853: *6* efc.clean_file_name
    /**
    ...
    //@+node:felix.20251214160339.854: *6* efc.legacy_file_name
    /**
    ...
    //@+node:felix.20251214160339.855: *5* efc.create_temp_file
    /**
    ...
    //@+node:felix.20251214160339.856: *5* efc.open_file_in_external_editor
    ...
    //@+node:felix.20251214160339.857: *5* efc.remove_temp_file
    /**
    ...
    //@+node:felix.20251214160339.859: *3* efc.utilities
    // pylint: disable=no-value-for-parameter
    //@+node:felix.20251214160339.860: *4* efc.ask
    /**
    ...
    //@+node:felix.20251214160339.861: *4* efc.checksum
    /**
    ...
    public async checksum(p_path: string): Promise<string> {
        ...
        if (!w_exists) {
            ...
            void g.workspace.dialog.showInformationMessage(`Checksum: file does not exist: ${p_path}`);
            return '';
        }
    ...
    //@+node:felix.20251214160339.862: *4* efc.destroy_temp_file
    /**
    ...
    //@+node:felix.20251214160339.863: *4* efc.get_mtime
    /**
    ...
    //@+node:felix.20251214160339.864: *4* efc.get_time
    /**
    ...
    //@+node:felix.20251214160339.866: *4* efc.is_enabled
    /**
    ...
    //@+node:felix.20251214160339.867: *4* efc.join
    /**
     * Return s1 + ' ' + s2
     */
    ...
    //@+node:felix.20251214160339.868: *4* efc.set_time
    /**
    ...
    //@+node:felix.20251214160339.869: *4* efc.warn
    /**
