//@+leo-ver=5-thin
//@+node:felix.20251214160339.333: * @file src/core/leoCache.ts
/**
...
//@+others
//@+node:felix.20251214160339.335: ** class CommanderWrapper
/** 
...
//@+node:felix.20251214160339.336: ** class GlobalCacher
/**
...
export class GlobalCacher {
    ...
    //@+others
    //@+node:felix.20251214160339.337: *3* g_cacher.init
    public init(): Promise<unknown> {
        //
        return this.db.init;
    }
    //@+node:felix.20251214160339.338: *3* g_cacher.clear
    /**
    ...
    //@+node:felix.20251214160339.340: *3* g_cacher.dump
    /**
...
//@+node:felix.20251214160339.341: ** class SqlitePickleShare
/**
...
export class SqlitePickleShare {
    ...
    //@+others
    //@+node:felix.20251214160339.342: *3*  Birth & special methods
    //@+node:felix.20251214160339.343: *4*  __init__ (SqlitePickleShare)
    /**
    ...
    //@+node:felix.20251214160339.345: *4* __delitem__
    /**
     * del db["key"] 
     */
    ...
    //@+node:felix.20251214160339.346: *4* __getitem__
    /**
     *  db['key'] reading 
     */
    ...
    //@+node:felix.20251214160339.347: *4* __iter__
    ...
    //@+node:felix.20251214160339.348: *4* __repr__
    public __repr__(): string {
        return `SqlitePickleShare('${this.root}')`;
    }
    //@+node:felix.20251214160339.349: *4* __setitem__
    /**
     *  db['key'] = 5
     */
    ...
    //@+node:felix.20251214160339.355: *3* refreshFromFile
    ...
    //@+node:felix.20251214160339.356: *3* commit
    ...
    //@+node:felix.20251214160339.357: *3* loader
    /**
     * REBUILDS an object
     */
    ...
    //@+node:felix.20251214160339.358: *3* dumper
    /**
    ...
    //@+node:felix.20251214160339.359: *3* _makedirs
    public async _makedirs(fn: string, mode: number = 0o777): Promise<void> {

        await g.mkdir(fn);

    }
    //@+node:felix.20251214160339.360: *3* clear (SqlitePickleShare)
    /**
    ...
    //@+node:felix.20251214160339.361: *3* get  (SqlitePickleShare)
    ...
    //@+node:felix.20251214160339.362: *3* has_key (SqlitePickleShare)
    ...
    //@+node:felix.20251214160339.363: *3* items
    ...
    //@+node:felix.20251214160339.364: *3* keys
    ...
    //@+node:felix.20251214160339.365: *3* reset_protocol_in_values
    public async reset_protocol_in_values(): Promise<void> {
        ...
        //@+others
        //@+node:felix.20251214160339.366: *4* viewrendered special case
        ...
        //@+node:felix.20251214160339.367: *4* do_block
    ...
    //@+node:felix.20251214160339.368: *3* uncache
    /**
...
//@+node:felix.20251214160339.369: ** function: dump_cache
/**
