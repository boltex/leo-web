//@+leo-ver=5-thin
//@+node:felix.20251103192334.338: * @file src/core/leoCache.ts
/**
 * A module encapsulating Leo's file caching
 */
//@+<< leoCache imports & annotations >>
//@+node:felix.20251103192334.339: ** << leoCache imports & annotations >>
...
//@+others
//@+node:felix.20251103192334.340: ** class CommanderWrapper
/** 
...
//@+node:felix.20251103192334.341: ** class GlobalCacher
/**
...
export class GlobalCacher {
    ...
    //@+others
    //@+node:felix.20251103192334.342: *3* g_cacher.init
    public init(): Promise<unknown> {
        //
        return this.db.init;
    }
    //@+node:felix.20251103192334.343: *3* g_cacher.clear
    /**
    ...
    //@+node:felix.20251103192334.344: *3* g_cacher.commit_and_close()
    ...
    //@+node:felix.20251103192334.345: *3* g_cacher.dump
    /**
...
//@+node:felix.20251103192334.346: ** class SqlitePickleShare
/**
...
export class SqlitePickleShare {
    ...
    //@+others
    //@+node:felix.20251103192334.347: *3*  Birth & special methods
    //@+node:felix.20251103192334.348: *4*  __init__ (SqlitePickleShare)
    /**
    ...
    //@+node:felix.20251103192334.349: *4* __contains__(SqlitePickleShare)
    public __contains__(key: string): boolean {

        return this.has_key(key);  // NOQA

    }
    //@+node:felix.20251103192334.350: *4* __delitem__
    /**
     * del db["key"] 
     */
    ...
    //@+node:felix.20251103192334.351: *4* __getitem__
    /**
     *  db['key'] reading 
     */
    ...
    //@+node:felix.20251103192334.352: *4* __iter__
    ...
    //@+node:felix.20251103192334.353: *4* __repr__
    public __repr__(): string {
        return `SqlitePickleShare('${this.root}')`;
    }
    //@+node:felix.20251103192334.354: *4* __setitem__
    /**
     *  db['key'] = 5
     */
    ...
    //@+node:felix.20251103192334.355: *3* readFileBuffer
    ...
    //@+node:felix.20251103192334.356: *3* writeFileBuffer
    ...
    //@+node:felix.20251103192334.357: *3* bufferToBase64
    public bufferToBase64(buffer: Uint8Array): string {
        return Buffer.from(buffer).toString('base64');
    }

    //@+node:felix.20251103192334.358: *3* saveDatabase
    ...
    //@+node:felix.20251103192334.359: *3* watchSetup
    ...
    //@+node:felix.20251103192334.360: *3* refreshFromFile
    ...
    //@+node:felix.20251103192334.361: *3* commit
    ...
    //@+node:felix.20251103192334.362: *3* loader
    /**
     * REBUILDS an object
     */
    ...
    //@+node:felix.20251103192334.363: *3* dumper
    /**
    ...
    //@+node:felix.20251103192334.364: *3* _makedirs
    public async _makedirs(fn: string, mode: number = 0o777): Promise<void> {

        await g.mkdir(fn);

    }
    //@+node:felix.20251103192334.365: *3* clear (SqlitePickleShare)
    /**
    ...
    //@+node:felix.20251103192334.366: *3* get  (SqlitePickleShare)
    ...
    //@+node:felix.20251103192334.367: *3* has_key (SqlitePickleShare)
    ...
    //@+node:felix.20251103192334.368: *3* items
    ...
    //@+node:felix.20251103192334.369: *3* keys
    ...
    //@+node:felix.20251103192334.370: *3* reset_protocol_in_values
    public async reset_protocol_in_values(): Promise<void> {
        ...
        //@+others
        //@+node:felix.20251103192334.371: *4* viewrendered special case
        ...
        //@+node:felix.20251103192334.372: *4* do_block
    ...
    //@+node:felix.20251103192334.373: *3* uncache
    /**
...
//@+node:felix.20251103192334.374: ** function: dump_cache
/**
