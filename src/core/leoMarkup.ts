//@+leo-ver=5-thin
//@+node:felix.20251214160339.1444: * @file src/core/leoMarkup.ts
/**
 * Supports @adoc, @pandoc and @sphinx nodes and related commands.
 */
//@+<< leoMarkup imports & annotations >>
//@+node:felix.20251214160339.1445: ** << leoMarkup imports & annotations >>
...
//@+others
//@+node:felix.20251214160339.1446: ** class TopLevelMarkupCommands
export class TopLevelMarkupCommands {
    //@+others
    //@+node:felix.20251214160339.1447: *3* @g.command: 'adoc' & 'adoc-with-preview')
    @command(
        'adoc',
    ...
    public adoc_command(this: Commands, verbose: true): Promise<File_List> {
        ...
        //@+node:felix.20251214160339.1448: *4* << adoc command docstring >>
        /*
    ...
    //@+node:felix.20251214160339.1449: *3* @g.command: 'pandoc' & 'pandoc-with-preview'
    @command(
        'pandoc',
    ...
    public pandoc_command(this: Commands, verbose = true): Promise<File_List> {
        ...
        //@+node:felix.20251214160339.1450: *4* << pandoc command docstring >>
        /*
    ...
    //@+node:felix.20251214160339.1451: *3* @g.command: 'sphinx' & 'sphinx-with-preview'
    @command(
        'sphinx',
    ...
    public sphinx_command(this: Commands, verbose = true): Promise<File_List> {
        ...
        //@+node:felix.20251214160339.1452: *4* << sphinx command docstring >>
        /*
...
//@+node:felix.20251214160339.1453: ** class MarkupCommands
/**
...
export class MarkupCommands {
    ...
    //@+others
    //@+node:felix.20251214160339.1454: *3* markup.command_helper & helpers
    ...
    //@+node:felix.20251214160339.1455: *4* markup.filename
    /**
    ...
    //@+node:felix.20251214160339.1456: *4* markup.compute_opath
    /**
    ...
    //@+node:felix.20251214160339.1457: *4* markup.run_asciidoctor
    /**
    ...
    //@+node:felix.20251214160339.1458: *4* markup.run_pandoc
    /**
    ...
    //@+node:felix.20251214160339.1459: *4* markup.run_sphinx
    /**
    ...
    //@+node:felix.20251214160339.1460: *3* markup.write_root & helpers
    /**
    ...
    //@+node:felix.20251214160339.1461: *4* markup.compute_level_offset
    /**
    ...
    //@+node:felix.20251214160339.1462: *4* markup.write_body
    /**
     * Write p.b
     */
    ...
    //@+node:felix.20251214160339.1463: *4* markup.write_headline
    /**
    ...
    //@+node:felix.20251214160339.1464: *4* markup.remove_directives
    ...
    //@+node:felix.20251214160339.1465: *3* markup.commands
