//@+leo-ver=5-thin
//@+node:felix.20251213133753.18: * @file src/core/leoFind.ts
/**
 *  Leo's gui-independent find classes.
 */
//@+<< leoFind imports >>
//@+node:felix.20251213133753.19: ** << leoFind imports >>
...
//@+node:felix.20251213133753.20: ** << Theory of operation of find/change >>
//@@language rest
//@@nosearch
//@+at
//
...
//@+others
//@+node:felix.20251213133753.21: ** class LeoFind
/**
...
export class LeoFind {
    ...
    //@+others
    //@+node:felix.20251213133753.22: *3* LeoFind.birth
    //@+node:felix.20251213133753.23: *4*  find.__init__
    constructor(c: Commands) {
        this.c = c;
        this.reload_settings();
    }
    //@+node:felix.20251213133753.24: *4* find.default_settings
    /**
    ...
    //@+node:felix.20251213133753.26: *4* find.init_ivars_from_settings
    /**
    ...
    //@+node:felix.20251213133753.28: *3* find.batch_change (script helper) & helpers
    ...
    public batch_change(
        ...
        //@+node:felix.20251213133753.29: *4* << docstring: find.batch_change >>
        /*
    ...
    //@+node:felix.20251213133753.30: *4* find._batch_change_helper
    ...
    //@+node:felix.20251213133753.31: *4* find._init_from_dict
    /**
    ...
    //@+node:felix.20251213133753.34: *4* find.change-then-find & helper
    ...
    //@+node:felix.20251213133753.35: *5* find.do_change_then_find
    /**
    ...
    //@+node:felix.20251213133753.36: *4* find.clone-find_marked & helper
    @cmd(
    ...
    //@+node:felix.20251213133753.37: *5* find.do_find_marked
    /**
    ...
    //@+node:felix.20251213133753.38: *4* find.clone-find-parents
    @cmd(
        'clone-find-parents',
    ...
    //@+node:felix.20251213133753.39: *4* find.find-def/var & helper
    ...
    //@+node:felix.20251213133753.40: *5* find.do_find_def & helpers
    /*
    ...
    //@+node:felix.20251213133753.41: *6* find._load_quicksearch_entries
    ...
    //@+node:felix.20251213133753.42: *6* find._compute_find_def_word
    /**
    ...
    //@+node:felix.20251213133753.43: *6* find._find_all_matches
    /*
    ...
    */
    ...
    //@+node:felix.20251213133753.44: *6* find._make_clones
    ...
    //@+node:felix.20251213133753.45: *6* find._make_patterns
    ...
    //@+node:felix.20251213133753.46: *6* find._switch_style
    /**
    ...
    //@+node:felix.20251213133753.48: *5* find.do_find_next & do_find_prev
    /**
    ...
    //@+node:felix.20251213133753.49: *4* find.replace
    ...
    //@+node:felix.20251213133753.50: *4* find.set-find-*
    @cmd(
        'set-find-everywhere',
    ...
    //@+node:felix.20251213133753.51: *4* find.show-find-options
    ...
    //@+node:felix.20251213133753.52: *5* LeoFind.compute_find_options
    /**
    ...
    //@+node:felix.20251213133753.53: *4* find.toggle-find-*
    ...
    //@+node:felix.20251213133753.54: *3* LeoFind.Commands (interactive)
    //@+node:felix.20251213133753.55: *4* find.change-all & helper
    @cmd(
        'change-all',
    ...
    //@+node:felix.20251213133753.56: *5* find.do_change_all & helpers
    ...
    //@+node:felix.20251213133753.59: *7* find._change_all_plain
    /**
    ...
    //@+node:felix.20251213133753.60: *7* find._change_all_regex
    /**
    ...
    //@+node:felix.20251213133753.61: *7* find._change_all_word
    /**
    ...
    //@+node:felix.20251213133753.62: *4* find.clone-find-all & helper
    @cmd(
        'clone-find-all',
    ...
    //         c.treeWantsFocus()
    //     return count
    //@+node:felix.20251213133753.63: *5* find.do_clone_find_all
    /**
    ...
    //@+node:felix.20251213133753.64: *4* find.clone-find-all-flattened & helper
    @cmd(
    ...
    //         c.treeWantsFocus()
    //     return count
    //@+node:felix.20251213133753.65: *5* find.do_clone_find_all_flattened
    /**
    ...
    //@+node:felix.20251213133753.66: *4* find.clone-find-tag & helper
    @cmd(
        'clone-find-tag',
    ...
    //@+node:felix.20251213133753.67: *5* find.do_clone_find_tag & helper
    /**
     * Do the clone-all-find commands from settings.
    ...
    //@+node:felix.20251213133753.68: *6* find._create_clone_tag_nodes
    /**
    ...
    //@+node:felix.20251213133753.69: *4* find.find-all & helper
    ...
    //     c.widgetWantsFocusNow(w)
    //     self.do_change_all(settings)
    //@+node:felix.20251213133753.70: *5* find.do_find_all & helpers
    /**
    ...
    //@+node:felix.20251213133753.79: *4* find.re-search
    ...
    //     )
    //@+node:felix.20251213133753.80: *4* find.re-search-backward
    @cmd(
        're-search-backward',
    ...
    //@+node:felix.20251213133753.81: *4* find.search_backward
    ...
    //         escape_handler=self.start_search_escape1,  # See start-search
    //     )
    //@+node:felix.20251213133753.82: *4* find.start-search (Ctrl-F) & common states
    @cmd(
        'start-search',
    ...
    //@+node:felix.20251213133753.83: *5* find.start_search1
    ...
    //@+node:felix.20251213133753.84: *5* find._start_search_escape1
    ...
    //@+node:felix.20251213133753.85: *5* find._start_search_escape2
    ...
    //@+node:felix.20251213133753.87: *4* find.tag-node
    ...
    //@+node:felix.20251213133753.88: *4* find.remove-tag
    ...
    //@+node:felix.20251213133753.89: *4* find.remove-all-tags
    ...
    //@+node:felix.20251213133753.90: *4* find.tag-children & helper
    ...
    //     c.treeWantsFocus()
    //@+node:felix.20251213133753.91: *5* find.do_tag_children
    /**
    ...
    //@+node:felix.20251213133753.92: *4* find.word-search
    ...
    //         escape_handler=self.start_search_escape1,  # See start-search
    //     )
    //@+node:felix.20251213133753.93: *4* find.word-search-backward
    @cmd(
    ...
    //         escape_handler=self.start_search_escape1,  # See start-search
    //     )
    //@+node:felix.20251213133753.94: *3* LeoFind.Commands: helpers
    //@+node:felix.20251213133753.95: *4* find._cf_helper & helpers
    /**
    ...
    //@+node:felix.20251213133753.96: *5* find._cfa_create_nodes
    /**
    ...
    //@+node:felix.20251213133753.97: *5* find._cfa_find_next_match (for unit tests)
    /**
    ...
    //@+node:felix.20251213133753.98: *4* find.change_selection
    /**
    ...
    //@+node:felix.20251213133753.99: *4* find.check_args
    /**
    ...
    //@+node:felix.20251213133753.100: *4* find.compile_pattern
    /**
    ...
    //@+node:felix.20251213133753.101: *4* find.find_next_match & helpers
    /**
    ...
    //@+node:felix.20251213133753.102: *5* find._fnm_next_after_fail & helper
    /**
    ...
    //@+node:felix.20251213133753.103: *6* find._fail_outside_range
    /**
    ...
    //@+node:felix.20251213133753.104: *5* find._fnm_first_search_pane
    /**
    ...
    //@+node:felix.20251213133753.106: *5* find._fnm_should_stay_in_node
    /**
    ...
    //@+node:felix.20251213133753.107: *4* find.inner_search_helper & helpers
    /**
    ...
    //@+node:felix.20251213133753.108: *5* find._rfind
    private _rfind(
        s: string,
        pattern: string,
        start: number,
    ...
    //@+node:felix.20251213133753.109: *5* find._inner_search_backward
    /**
     * rfind(sub [,start [,end]])
     *
    ...
    //@+node:felix.20251213133753.110: *5* find._inner_search_match_word
    /**
    ...
    //@+node:felix.20251213133753.111: *5* find._inner_search_plain
    /**
     * Do a plain search.
     */
    ...
    //@+node:felix.20251213133753.112: *5* find._inner_search_regex
    /**
    ...
    //@+node:felix.20251213133753.113: *4* find.make_regex_subs
    /**
    ...
    //@+node:felix.20251213133753.114: *4* find.replace_back_slashes
    /**
    ...
    //@+node:felix.20251213133753.115: *3* LeoFind.Initing & finalizing
    //@+node:felix.20251213133753.116: *4* find.init_in_headline & helper
    /**
    ...
    //@+node:felix.20251213133753.117: *5* find.focus_in_tree
    /**
    ...
    //@+node:felix.20251213133753.118: *4* find.restore
    /**
    ...
    //@+node:felix.20251213133753.119: *4* find.save
    /**
    ...
    //@+node:felix.20251213133753.120: *4* find.show_success
    /**
    ...
    //@+node:felix.20251213133753.121: *3* LeoFind.Utils
    //@+node:felix.20251213133753.122: *4* find.add_change_string_to_label
    ...
    // }
    //@+node:felix.20251213133753.123: *4* find.add_find_string_to_label
    // ! USE CLIENT UI DIALOGS INSTEAD OF ORIGINAL LEO'S STATE_MACHINE
    ...
    // }
    //@+node:felix.20251213133753.124: *4* find.compute_result_status
    /**
    ...
    //@+node:felix.20251213133753.125: *4* find.help_for_find_commands
    /**
    ...
    //@+node:felix.20251213133753.127: *4* find.preload_find_pattern
    /**
    ...
    //@+node:felix.20251213133753.128: *4* find.show_status
    /**
    ...
    //@+node:felix.20251213133753.129: *4* find.show_find_options_in_status_area & helper
    /**
    ...
    //@+node:felix.20251213133753.131: *4* find.start_state_machine
    // ! USE CLIENT UI DIALOGS INSTEAD OF ORIGINAL LEO'S STATE_MACHINE
