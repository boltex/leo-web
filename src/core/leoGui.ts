//@+leo-ver=5-thin
//@+node:felix.20251103192334.2841: * @file src/core/leoGui.ts
/**
 ...
 */
//@+<< leoGui imports >>
//@+node:felix.20251103192334.2842: ** << leoGui imports >>
...
//@-<< leoGui imports >>
//@+others
//@+node:felix.20251103192334.2843: ** class LeoGui
/**
...
export class LeoGui {
    ...
    //@+others
    //@+node:felix.20251103192334.2844: *3* LeoGui.__init__
    /**
    ...
    //@+node:felix.20251103192334.2845: *3* LeoGui: Must be defined only in base class
    //@+node:felix.20251103192334.2846: *4* LeoGui.create_key_event (LeoGui)
    ...
    //@+node:felix.20251103192334.2847: *4* LeoGui.guiName
    ...
    //@+node:felix.20251103192334.2848: *4* LeoGui.setScript
    public setScript(script?: string, scriptFileName?: string): void {
        this.script = script;
        this.scriptFileName = scriptFileName;
    }
    //@+node:felix.20251103192334.2849: *4* LeoGui.event_generate (LeoGui)
    ...
    //     c.outerUpdate()
    //@+node:felix.20251103192334.2850: *3* LeoGui: Must be defined in subclasses
    //@+node:felix.20251103192334.2851: *4* LeoGui.destroySelf
    public destroySelf(): void {
        this.oops();
    }
    //@+node:felix.20251103192334.2852: *4* LeoGui.dialogs
    /**
    ...
    //@+node:felix.20251103192334.2853: *4* LeoGui.file dialogs
    /**
    ...
    //@+node:felix.20251103192334.2854: *4* LeoGui.addLogPaneEntry (LeoJs)
    public addLogPaneEntry(...args: any[]): void {
        this.oops();
        // Adds a message string to LeoJS log pane. See LeoUi.ts
    }
    //@+node:felix.20251103192334.2855: *4* LeoGui.focusLogPane (LeoJs)
    public showLogPane(p_focus?: boolean): void {
        // Shows and optionally puts focus on the log pane
    }
    //@+node:felix.20251103192334.2856: *4* LeoGui.finishStartup (LeoJs)
    ...
    //@+node:felix.20251103192334.2857: *4* LeoGui.get1Arg (LeoJs)
    public get1Arg(
        options?: any,
        token?: any,
        tabList?: string[]
    ...
    //@+node:felix.20251103192334.2858: *4* LeoGui.get1Char (LeoJs)
    public get1Char(
        options?: any,
        token?: any
    ): Thenable<string | undefined> {
    ...
    //@+node:felix.20251103192334.2859: *4* leoGui.getWorkspaceSession
    /**
    ...
    //@+node:felix.20251103192334.2860: *4* leoGui.setWorkspaceSession
    /**
    ...
    //@+node:felix.20251103192334.2861: *4* LeoGui.makeAllBindings (LeoJs)
    public makeAllBindings(): void {
        // Make all command/key bindings : see LeoJS commadBindings
    }
    //@+node:felix.20251103192334.2862: *4* LeoGui.panels
    ...
    //@+node:felix.20251103192334.2863: *4* LeoGui.runMainLoop
    public runMainLoop(): void {
        this.oops();
    }
    //@+node:felix.20251103192334.2864: *4* LeoGui.utils
    ...
    //@+node:felix.20251103192334.2865: *5* LeoGui.Clipboard
    ...
    //@+node:felix.20251103192334.2866: *5* LeoGui.Dialog utils
    ...
    //@+node:felix.20251103192334.2867: *5* LeoGui.Font
    ...
    //@+node:felix.20251103192334.2868: *5* LeoGui.getFullVersion
    public getFullVersion(c?: Commands): string {
        return 'LeoGui: dummy version';
    }

    //@+node:felix.20251103192334.2869: *5* LeoGui.makeScriptButton
    ...
    //@+node:felix.20251103192334.2870: *3* LeoGui: May be defined in subclasses
    //@+node:felix.20251103192334.2871: *4* LeoGui.dismiss_spash_screen
    public dismiss_splash_screen(): void {
        // May be overridden in subclasses.
        // pass
    }
    //@+node:felix.20251103192334.2872: *4* LeoGui.ensure_commander_visible
    /**
    ...
    //@+node:felix.20251103192334.2873: *4* LeoGui.finishCreate
    public finishCreate(): void {
        // This may be overridden in subclasses.
        // pass
    }
    //@+node:felix.20251103192334.2874: *4* LeoGui.killPopupMenu & postPopupMenu
    public postPopupMenu(...args: any[]): void {
        // pass
    }
    //@+node:felix.20251103192334.2875: *4* LeoGui.oops
    public oops(): any {
    ...
    //@+node:felix.20251103192334.2876: *4* LeoGui.put_help
    public put_help(c: Commands, s: string, short_title: string): void {
        // pass
    }
    //@+node:felix.20251103192334.2877: *4* LeoGui.widget_name (LeoGui)
    ...
    //@+node:felix.20251103192334.2878: *4* goAnywhere
    public goAnywhere(): Thenable<unknown> {
        return Promise.resolve();
    }

    //@+node:felix.20251103192334.2879: *4* openAside
    public openAside(): Thenable<unknown> {
        return Promise.resolve();
    }

    //@+node:felix.20251103192334.2880: *4* showSettings
...
//@+node:felix.20251103192334.2881: ** class NullGui
/**
 * Null gui class.
 */
...
//@+node:felix.20251103192334.2882: ** class NullScriptingControllerClass
/**
