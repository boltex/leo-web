//@+leo-ver=5-thin
//@+node:felix.20251214160339.1806: * @file src/core/leoSessions.ts
/**
...
//@-<< leoSessions imports & annotations >>
//@+others
//@+node:felix.20251214160339.1808: ** class SessionManager
/**
...
export class SessionManager {
  ...
  //@+others
  //@+node:felix.20251214160339.1809: *3* SessionManager.clear_session
  /**
  ...
  //@+node:felix.20251214160339.1810: *3* SessionManager.error
  // public error (s: string){
  // // Do not use g.trace or g.es here.
  // g.es_print(s);
  // }
  //@+node:felix.20251214160339.1811: *3* SessionManager.get_session
  /**
  ...
  //@+node:felix.20251214160339.1812: *3* SessionManager.get_session_path
  /**
  ...
  //@+node:felix.20251214160339.1813: *3* SessionManager.load_session
  /**
  ...
  //@+node:felix.20251214160339.1814: *3* SessionManager.load_snapshot
  /**
  ...
  //@+node:felix.20251214160339.1815: *3* SessionManager.save_snapshot
  /**
...
//@+node:felix.20251214160339.1816: ** class TopLevelSessionsCommands
export class TopLevelSessionsCommands {
  //@+others
  //@+node:felix.20251214160339.1817: *3* session-clear
  @command(
    'session-clear',
    'Close all tabs except the presently selected tab.'
  )
  ...
  //@+node:felix.20251214160339.1818: *3* session-create
  @command(
    'session-create',
  ...
  //@+node:felix.20251214160339.1819: *3* session-refresh
  @command(
    'session-refresh',
  ...
  //@+node:felix.20251214160339.1820: *3* session-restore
  @command(
    'session-restore',
  ...
  //@+node:felix.20251214160339.1821: *3* session-snapshot-load
  @command(
  ...
  //@+node:felix.20251214160339.1822: *3* session-snapshot-save
  @command(
