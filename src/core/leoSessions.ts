//@+leo-ver=5-thin
//@+node:felix.20251103192334.1810: * @file src/core/leoSessions.ts
/**
 * Support for sessions in Leo.
 */
//@+<< leoSessions imports & annotations >>
//@+node:felix.20251103192334.1811: ** << leoSessions imports & annotations >>
import * as g from './leoGlobals';
import { command } from './decorators';
import { Commands } from './leoCommands';
//@-<< leoSessions imports & annotations >>
//@+others
//@+node:felix.20251103192334.1812: ** class SessionManager
/**
...
export class SessionManager {
  ...
  //@+others
  //@+node:felix.20251103192334.1813: *3* SessionManager.clear_session
  /**
  ...
  //@+node:felix.20251103192334.1814: *3* SessionManager.error
  // public error (s: string){
  // // Do not use g.trace or g.es here.
  // g.es_print(s);
  // }
  //@+node:felix.20251103192334.1815: *3* SessionManager.get_session
  /**
  ...
  //@+node:felix.20251103192334.1816: *3* SessionManager.get_session_path
  /**
  ...
  //@+node:felix.20251103192334.1817: *3* SessionManager.load_session
  /**
  ...
  //@+node:felix.20251103192334.1818: *3* SessionManager.load_snapshot
  /**
  ...
  //@+node:felix.20251103192334.1819: *3* SessionManager.save_snapshot
  /**
...
//@+node:felix.20251103192334.1820: ** class TopLevelSessionsCommands
export class TopLevelSessionsCommands {
  //@+others
  //@+node:felix.20251103192334.1821: *3* session-clear
  @command(
    'session-clear',
    'Close all tabs except the presently selected tab.'
  )
  ...
  //@+node:felix.20251103192334.1822: *3* session-create
  @command(
    'session-create',
  ...
  //@+node:felix.20251103192334.1823: *3* session-refresh
  @command(
    'session-refresh',
  ...
  //@+node:felix.20251103192334.1824: *3* session-restore
  @command(
    'session-restore',
  ...
  //@+node:felix.20251103192334.1825: *3* session-snapshot-load
  @command(
  ...
  //@+node:felix.20251103192334.1826: *3* session-snapshot-save
  @command(
