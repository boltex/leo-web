//@+leo-ver=5-thin
//@+node:felix.20251214160339.1466: * @file src/core/leoNodes.ts
/**
 * Leo's fundamental data classes.
 */
//@+<< imports >>
//@+node:felix.20251214160339.1467: ** << imports >>
...
//@-<< imports >>
//@+others
//@+node:felix.20251214160339.1468: ** class NodeIndices
/**
...
export class NodeIndices {
    ...
    //@+others
    //@+node:felix.20251214160339.1469: *3* ni.constructor
    ...
    //@+node:felix.20251214160339.1470: *3* ni.check_gnx
    /**
    ...
    //@+node:felix.20251214160339.1471: *3* ni.compute_last_index
    /**
    ...
    //@+node:felix.20251214160339.1472: *3* ni.computeNewIndex
    /**
     * Return a new gnx.
     */
    ...
    //@+node:felix.20251214160339.1473: *3* ni.setTimeStamp
    /**
    ...
    //@+node:felix.20251214160339.1474: *3* ni.get/setDefaultId
    ...
    //@+node:felix.20251214160339.1475: *3* ni.getNewIndex
    /**
    ...
    //@+node:felix.20251214160339.1476: *3* ni.new_vnode_helper
    /**
    ...
    //@+node:felix.20251214160339.1477: *3* ni.scanGnx
    /**
    ...
    //@+node:felix.20251214160339.1478: *3* ni.tupleToString
    /**
    ...
    //@+node:felix.20251214160339.1479: *3* ni.update
    /**
    ...
    //@+node:felix.20251214160339.1480: *3* ni.updateLastIndex
    /**
...
//@+node:felix.20251214160339.1481: ** class Position
/**
...
export class Position {
    ...
    //@+others
    //@+node:felix.20251214160339.1482: *3* p.ctor & other special methods...
    //@+node:felix.20251214160339.1483: *4* p.constructor
    /**
    ...
    //@+node:felix.20251214160339.1484: *4* p.__eq__ & __ne__
    /**
    ...
    //@+node:felix.20251214160339.1485: *4* p.__ge__ & __le__& __lt__
    ...
    //@+node:felix.20251214160339.1486: *4* p.__gt__
    /**
    ...
    //@+node:felix.20251214160339.1487: *4* p.__nonzero__ & __bool__
    /**
    ...
    //@+node:felix.20251214160339.1488: *4* p.__str__ and p.__repr__
    /**
    ...
    //@+node:felix.20251214160339.1489: *4* p.valueOf
    /**
    ...
    //@+node:felix.20251214160339.1490: *4* p.archive
    /**
    ...
    //@+node:felix.20251214160339.1491: *4* p.archivedPosition
    /**
    ...
    //@+node:felix.20251214160339.1492: *4* p.dump
    ...
    //@+node:felix.20251214160339.1493: *4* p.key & p.sort_key & __hash__
    public key(): string {
        const p: Position = this;
    ...
    */
    ...
    //@+node:felix.20251214160339.1494: *3* p.File Conversion
    /*
    ...
    */
    ...
    //@+node:felix.20251214160339.1495: *4* p.convertTreeToString
    /**
    ...
    //@+node:felix.20251214160339.1496: *4* p.moreHead
    /**
    ...
    //@+node:felix.20251214160339.1497: *4* p.moreBody
    /*
        + test line
        - test line
        \ test line
    ...
    */
    ...
    //@+node:felix.20251214160339.1498: *3* p.generators
    //@+node:felix.20251214160339.1499: *4* p.children
    /**
    ...
    //@+node:felix.20251214160339.1500: *4* p.following_siblings
    /**
    ...
    //@+node:felix.20251214160339.1501: *4* p.nearest_roots
    /**
    ...
    //@+node:felix.20251214160339.1502: *4* p.nearest_unique_roots (aka p.nearest)
    /**
    ...
    //@+node:felix.20251214160339.1503: *4* p.nodes
    /**
    ...
    //@+node:felix.20251214160339.1504: *4* p.parents
    /**
    ...
    //@+node:felix.20251214160339.1505: *4* p.self_and_parents
    /**
    ...
    //@+node:felix.20251214160339.1506: *4* p.self_and_siblings
    /**
    ...
    //@+node:felix.20251214160339.1507: *4* p.self_and_subtree
    /**
    ...
    //@+node:felix.20251214160339.1508: *4* p.subtree
    /**
    ...
    //@+node:felix.20251214160339.1509: *4* p.unique_nodes
    /**
    ...
    //@+node:felix.20251214160339.1510: *4* p.unique_subtree
    /**
    ...
    //@+node:felix.20251214160339.1511: *3* p.Getters
    //@+node:felix.20251214160339.1512: *4* p.children & parents
    //@+node:felix.20251214160339.1513: *5* p.childIndex
    // This used to be time-critical code.
    public childIndex(): number {
        return this._childIndex;
    }

    //@+node:felix.20251214160339.1514: *5* p.directParents
    public directParents(): VNode[] {
        return this.v.directParents();
    }

    //@+node:felix.20251214160339.1515: *5* p.hasChildren & p.numberOfChildren
    ...
    //@+node:felix.20251214160339.1516: *4* p.findDirective (new)
    /**
    ...
    //@+node:felix.20251214160339.1517: *4* p.findRootPosition
    ...
    //@+node:felix.20251214160339.1518: *4* p.get_UNL and related methods
    // All unls must contain a file part: f"//{file-name}#"
    // The file-name may be empty.
    //@+node:felix.20251214160339.1519: *5* p.get_full_gnx_UNL
    /** 
    ...
    //@+node:felix.20251214160339.1520: *5* p.get_full_legacy_UNL
    /**
    ...
    //@+node:felix.20251214160339.1521: *5* p.get_legacy_UNL
    /**
    ...
    //@+node:felix.20251214160339.1522: *5* p.get_short_gnx_UNL
    /**
    ...
    //@+node:felix.20251214160339.1523: *5* p.get_short_legacy_UNL
    /**
    ...
    //@+node:felix.20251214160339.1524: *5* p.get_UNL
    /**
    ...
    //@+node:felix.20251214160339.1525: *4* p.getX & VNode compatibility traversal routines
    ...
    //@+node:felix.20251214160339.1526: *4* p.hasBack/Next/Parent/ThreadBack
    ...
    //@+node:felix.20251214160339.1527: *5* hasThreadNext (the only complex hasX method)
    ...
    //@+node:felix.20251214160339.1528: *4* p.isAncestorOf
    /**
    ...
    //@+node:felix.20251214160339.1529: *4* p.isCloned
    public isCloned(): boolean {
        const p: Position = this;
        return p.v.isCloned();
    }

    //@+node:felix.20251214160339.1530: *4* p.isRoot
    public isRoot(): boolean {
        const p: Position = this;
        return !p.hasParent() && !p.hasBack();
    }

    //@+node:felix.20251214160339.1531: *4* p.isVisible (slow)
    /**
    ...
    //@+node:felix.20251214160339.1532: *4* p.level & simpleLevel
    /**
    ...
    //@+node:felix.20251214160339.1533: *4* p.positionAfterDeletedTree
    /**
     * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    //@+node:felix.20251214160339.1534: *4* p.textOffset
    /**
    ...
    //@+node:felix.20251214160339.1535: *4* p.VNode proxies
    //@+node:felix.20251214160339.1536: *5* p.Comparisons
    ...
    //@+node:felix.20251214160339.1537: *5* p.Headline & body strings
    ...
    //@+node:felix.20251214160339.1538: *5* p.Status bits
    ...
    //@+node:felix.20251214160339.1539: *3* p.Low level methods
    /*
     * These methods are only for the use of low-level code
     * in leoNodes.py, leoFileCommands.py and leoUndo.py.
     */

    //@+node:felix.20251214160339.1540: *4* p._adjustPositionBeforeUnlink
    /**
    ...
    //@+node:felix.20251214160339.1541: *4* p._linkAfter
    /**
    ...
    //@+node:felix.20251214160339.1542: *4* p._linkCopiedAfter
    /**
    ...
    //@+node:felix.20251214160339.1543: *4* p._linkAsNthChild
    /**
    ...
    //@+node:felix.20251214160339.1544: *4* p._linkCopiedAsNthChild
    /**
    ...
    //@+node:felix.20251214160339.1545: *4* p._linkAsRoot (changed)
    /**
    ...
    //@+node:felix.20251214160339.1548: *4* p._unlink
    /**
    ...
    //@+node:felix.20251214160339.1549: *5* p.badUnlink
    /**
    ...
    //@+node:felix.20251214160339.1550: *3* p.moveToX
    /**
    ...
    //@+node:felix.20251214160339.1551: *4* p.moveToBack
    /**
    ...
    //@+node:felix.20251214160339.1552: *4* p.moveToFirstChild
    /**
    ...
    //@+node:felix.20251214160339.1553: *4* p.moveToLastChild
    /**
    ...
    //@+node:felix.20251214160339.1554: *4* p.moveToLastNode
    /**
    ...
    //@+node:felix.20251214160339.1555: *4* p.moveToNext
    /**
    ...
    //@+node:felix.20251214160339.1556: *4* p.moveToNodeAfterTree
    /**
    ...
    //@+node:felix.20251214160339.1557: *4* p.moveToNthChild
    /**
     * Move to Nth child
     */
    ...
    //@+node:felix.20251214160339.1558: *4* p.moveToParent
    /**
    ...
    //@+node:felix.20251214160339.1559: *4* p.moveToThreadBack
    /**
    ...
    //@+node:felix.20251214160339.1560: *4* p.moveToThreadNext
    /**
    ...
    //@+node:felix.20251214160339.1561: *4* p.moveToVisBack & helper
    /**
    ...
    //@+node:felix.20251214160339.1562: *5* checkVisBackLimit
    /**
    ...
    //@+node:felix.20251214160339.1563: *4* p.moveToVisNext & helper
    /**
    ...
    //@+node:felix.20251214160339.1564: *5* checkVisNextLimit
    /**
    ...
    //@+node:felix.20251214160339.1565: *4* p.safeMoveToThreadNext
    /**
     * Move a position to threadNext position.
    ...
    //@+node:felix.20251214160339.1566: *3* p.Moving, Inserting, Deleting, Cloning, Sorting
    //@+node:felix.20251214160339.1567: *4* p.clone
    /**
    ...
    //@+node:felix.20251214160339.1568: *4* p.copy
    /**
    ...
    //@+node:felix.20251214160339.1569: *4* p.copyTreeAfter, copyTreeTo
    ...
    //@+node:felix.20251214160339.1570: *4* p.copyWithNewVnodes
    /**
    ...
    //@+node:felix.20251214160339.1571: *4* p.deleteAllChildren
    /**
    ...
    //@+node:felix.20251214160339.1572: *4* p.doDelete
    /**
    ...
    //@+node:felix.20251214160339.1573: *4* p.insertAfter
    /**
    ...
    //@+node:felix.20251214160339.1574: *4* p.insertAsFirstChild
    /**
    ...
    //@+node:felix.20251214160339.1575: *4* p.insertAsLastChild
    /**
    ...
    //@+node:felix.20251214160339.1576: *4* p.insertAsNthChild
    /**
    ...
    //@+node:felix.20251214160339.1577: *4* p.insertBefore
    /**
    ...
    //@+node:felix.20251214160339.1578: *4* p.invalidOutline
    /**
    ...
    //@+node:felix.20251214160339.1579: *4* p.moveAfter
    /**
    ...
    //@+node:felix.20251214160339.1580: *4* p.moveToFirst/LastChildOf
    /**
    ...
    //@+node:felix.20251214160339.1581: *4* p.moveToNthChildOf
    /**
    ...
    //@+node:felix.20251214160339.1582: *4* p.moveToRoot (changed)
    /**
    ...
    //@+node:felix.20251214160339.1583: *4* p.promote
    /**
    ...
    //@+node:felix.20251214160339.1584: *4* p.validateOutlineWithParent
    /**
    ...
    public validateOutlineWithParent(pv: Position | undefined): boolean {
        ...
        //@+node:felix.20251214160339.1585: *5* << validate parent ivar >>
        if (pv && !parent.__eq__(pv)) {
            p.invalidOutline('Invalid parent link: ' + JSON.stringify(parent));
        }
        //@-<< validate parent ivar >>
        //@+<< validate childIndex ivar >>
        //@+node:felix.20251214160339.1586: *5* << validate childIndex ivar >>
        if (pv && pv.__bool__()) {
            if (childIndex < 0) {
    ...
    //@+node:felix.20251214160339.1588: *3* p.Properties
    //@+node:felix.20251214160339.1589: *4* p.b property
    /**
    ...
    //@+node:felix.20251214160339.1590: *4* p.h property
    /**
    ...
    //@+node:felix.20251214160339.1591: *4* p.gnx property
    /**
    ...
    //@+node:felix.20251214160339.1592: *4* p.script property
    /**
    ...
    //@+node:felix.20251214160339.1593: *4* p.nosentinels property
    /**
    ...
    //@+node:felix.20251214160339.1594: *4* p.u Property
    /**
     * p.u property
     */
    public get u(): any {
    ...
    //@+node:felix.20251214160339.1595: *3* p.Setters
    //@+node:felix.20251214160339.1596: *4* p.VNode proxies
    //@+node:felix.20251214160339.1597: *5* p.contract/expand/isExpanded
    /**
    ...
    //@+node:felix.20251214160339.1598: *5* p.Status bits
    ...
    //@+node:felix.20251214160339.1599: *5* p.computeIcon & p.setIcon
    ...
    //@+node:felix.20251214160339.1600: *5* p.setSelection
    public setSelection(start: number, length: number): void {
        return this.v.setSelection(start, length);
    }

    //@+node:felix.20251214160339.1601: *5* p.restore/saveCursorAndScroll
    ...
    //@+node:felix.20251214160339.1602: *4* p.setBodyString & setHeadString
    ...
    //@+node:felix.20251214160339.1603: *4* p.Visited bits
    //@+node:felix.20251214160339.1604: *5* p.clearVisitedInTree
    ...
    //@+node:felix.20251214160339.1605: *5* p.clearAllVisitedInTree
    ...
    //@+node:felix.20251214160339.1606: *4* p.Dirty bits
    //@+node:felix.20251214160339.1607: *5* p.clearDirty
    /**
     * (p) Set p.v dirty.
     */
    ...
    //@+node:felix.20251214160339.1608: *5* p.inAtIgnoreRange
    /**
    ...
    //@+node:felix.20251214160339.1609: *5* p.setAllAncestorAtFileNodesDirty
    /**
    ...
    //@+node:felix.20251214160339.1610: *5* p.setDirty
    /**
    ...
    //@+node:felix.20251214160339.1611: *3* p.Predicates
    //@+node:felix.20251214160339.1612: *4* p.is_at_all & is_at_all_tree
    /**
    ...
    //@+node:felix.20251214160339.1613: *4* p.is_at_ignore & in_at_ignore_tree
    /**
...
//@+node:felix.20251214160339.1614: ** Enum StatusFlags
...
//@+node:felix.20251214160339.1615: ** class VNode
/**
 * VNode class.
 */
export class VNode {
    ...
    //@+others
    //@+node:felix.20251214160339.1616: *3* v.Birth & death
    //@+node:felix.20251214160339.1617: *4* constructor
    ...
    //@+node:felix.20251214160339.1618: *4* v.__repr__ & v.__str__
    ...
    //@+node:felix.20251214160339.1619: *4* v.dump
    public dumpLink(link: string): string {
        return link ? link : '<none>';
    }
    ...
    //@+node:felix.20251214160339.1620: *4* v.archive_uas
    /** 
    ...
    //@+node:felix.20251214160339.1621: *3* v.toString
    public toString(): string {
        return this.__repr__();
    }
    //@+node:felix.20251214160339.1622: *3* v.Comparisons
    //@+node:felix.20251214160339.1623: *4* v.findAtFileName
    /**
    ...
    //@+node:felix.20251214160339.1624: *4* v.anyAtFileNodeName
    /**
    ...
    //@+node:felix.20251214160339.1625: *4* v.at...FileNodeName
    ...
    //@+node:felix.20251214160339.1626: *4* v.isAtAllNode
    /**
    ...
    //@+node:felix.20251214160339.1627: *4* v.isAnyAtFileNode
    /**
    ...
    //@+node:felix.20251214160339.1628: *4* v.isAt...FileNode
    public isAtAutoNode(): boolean {
    ...
    //@+node:felix.20251214160339.1629: *4* v.isAtIgnoreNode
    /**
     * Returns True if:
    ...
    //@+node:felix.20251214160339.1630: *4* v.isAtOthersNode
    /**
     * Returns True if the receiver contains @others in its body at the start of a line.
     */
    public isAtOthersNode(): boolean {
    ...
    //@+node:felix.20251214160339.1631: *4* v.matchHeadline
    /**
    ...
    //@+node:felix.20251214160339.1632: *3* v.copyTree
    /**
    ...
    //@+node:felix.20251214160339.1633: *3* v.Getters
    //@+node:felix.20251214160339.1634: *4* v.bodyString
    public bodyString(): string {
        return this._bodyString;
    }

    //@+node:felix.20251214160339.1635: *4* v.Children
    //@+node:felix.20251214160339.1636: *5* v.firstChild
    /**
    ...
    //@+node:felix.20251214160339.1637: *5* v.hasChildren
    public hasChildren(): boolean {
        return !!this.children.length;
    }

    //@+node:felix.20251214160339.1638: *5* v.lastChild
    /**
    ...
    //@+node:felix.20251214160339.1639: *5* v.nthChild
    /**
    ...
    //@+node:felix.20251214160339.1640: *5* v.numberOfChildren
    public numberOfChildren(): number {
        return this.children.length;
    }

    //@+node:felix.20251214160339.1641: *4* v.directParents
    /**
    ...
    //@+node:felix.20251214160339.1642: *4* v.hasBody
    /**
    ...
    //@+node:felix.20251214160339.1643: *4* v.headString
    /**
    ...
    //@+node:felix.20251214160339.1644: *4* v.cleanHeadString
    /**
    ...
    //@+node:felix.20251214160339.1645: *4* v.isNthChildOf
    /**
    ...
    //@+node:felix.20251214160339.1646: *4* v.Status Bits
    //@+node:felix.20251214160339.1647: *5* v.isCloned
    public isCloned(): boolean {
        return this.parents.length > 1;
    }

    //@+node:felix.20251214160339.1648: *5* v.isDirty
    public isDirty(): boolean {
        return (this.statusBits & StatusFlags.dirtyBit) !== 0;
    }

    //@+node:felix.20251214160339.1649: *5* v.isMarked
    public isMarked(): boolean {
        return (this.statusBits & StatusFlags.markedBit) !== 0;
    }

    //@+node:felix.20251214160339.1650: *5* v.isOrphan
    public isOrphan(): boolean {
        return (this.statusBits & StatusFlags.orphanBit) !== 0;
    }

    //@+node:felix.20251214160339.1651: *5* v.isSelected
    public isSelected(): boolean {
        return (this.statusBits & StatusFlags.selectedBit) !== 0;
    }

    //@+node:felix.20251214160339.1652: *5* v.isTopBitSet
    public isTopBitSet(): boolean {
        return (this.statusBits & StatusFlags.topBit) !== 0;
    }

    //@+node:felix.20251214160339.1653: *5* v.isVisited
    public isVisited(): boolean {
        return (this.statusBits & StatusFlags.visitedBit) !== 0;
    }

    //@+node:felix.20251214160339.1654: *5* v.isWriteBit
    public isWriteBit(): boolean {
        return (this.statusBits & StatusFlags.writeBit) !== 0;
    }

    //@+node:felix.20251214160339.1655: *5* v.status
    public status(): number {
        return this.statusBits;
    }

    //@+node:felix.20251214160339.1656: *3* v.Setters
    //@+node:felix.20251214160339.1657: *4*  v.Dirty bits
    //@+node:felix.20251214160339.1658: *5* v.clearDirty
    /**
    ...
    //@+node:felix.20251214160339.1659: *5* v.setDirty
    /**
    ...
    //@+node:felix.20251214160339.1660: *4*  v.Status bits
    //@+node:felix.20251214160339.1661: *5* v.clearClonedBit
    public clearClonedBit(): void {
        this.statusBits &= ~StatusFlags.clonedBit;
    }

    //@+node:felix.20251214160339.1662: *5* v.clearMarked
    public clearMarked(): void {
        this.statusBits &= ~StatusFlags.markedBit;
    }

    //@+node:felix.20251214160339.1663: *5* v.clearWriteBit
    public clearWriteBit(): void {
        this.statusBits &= ~StatusFlags.writeBit;
    }

    //@+node:felix.20251214160339.1664: *5* v.clearOrphan
    public clearOrphan(): void {
        this.statusBits &= ~StatusFlags.orphanBit;
    }

    //@+node:felix.20251214160339.1665: *5* v.clearVisited
    public clearVisited(): void {
        this.statusBits &= ~StatusFlags.visitedBit;
    }

    //@+node:felix.20251214160339.1666: *5* v.contract/expand/initExpandedBit/isExpanded
    /**
     * Contract the node.
     */
    public contract(): void {
    ...
    //@+node:felix.20251214160339.1667: *5* v.initStatus
    public initStatus(status: number): void {
        this.statusBits = status;
    }

    //@+node:felix.20251214160339.1668: *5* v.setClonedBit & initClonedBit
    ...
    //@+node:felix.20251214160339.1669: *5* v.setMarked & initMarkedBit
    public setMarked(): void {
        this.statusBits |= StatusFlags.markedBit;
    }
    ...
    //@+node:felix.20251214160339.1670: *5* v.setOrphan
    /**
    ...
    //@+node:felix.20251214160339.1671: *5* v.setSelected
    /**
    ...
    //@+node:felix.20251214160339.1672: *5* v.setVisited
    /**
     * Compatibility routine for scripts
     */
    public setVisited(): void {
    ...
    //@+node:felix.20251214160339.1673: *5* v.setWriteBit
    public setWriteBit(): void {
        this.statusBits |= StatusFlags.writeBit;
    }

    //@+node:felix.20251214160339.1674: *4* v.childrenModified
    public childrenModified(): void {
        g.childrenModifiedSet.push(this);
    }

    //@+node:felix.20251214160339.1675: *4* v.computeIcon & setIcon
    public computeIcon(): number {
        let val: number = 0;
        const v: VNode = this;
        if (v.hasBody()) {
    ...
    //@+node:felix.20251214160339.1676: *4* v.contentModified
    public contentModified(): void {
        g.contentModifiedSet.push(this);
    }

    //@+node:felix.20251214160339.1677: *4* v.restoreCursorAndScroll
    ...
    //@+node:felix.20251214160339.1678: *4* v.saveCursorAndScroll
    /**
    ...
    //@+node:felix.20251214160339.1679: *4* v.setBodyString & v.setHeadString
    public setBodyString(s: string): void {
        const v: VNode = this;
        if (typeof s === 'string') {
            v._bodyString = s;
    ...
    //@+node:felix.20251214160339.1680: *4* v.setSelection
    public setSelection(start: number, length: number): void {
        const v: VNode = this;
    ...
    //@+node:felix.20251214160339.1681: *3* v.setAllAncestorAtFileNodesDirty & helpers
    /**
    ...
    //@+node:felix.20251214160339.1682: *3* v.Inserting & cloning
    /**
    ...
    //@+node:felix.20251214160339.1683: *3* v.Low level methods
    //@+node:felix.20251214160339.1684: *4* v._addCopiedLink
    /**
    ...
    //@+node:felix.20251214160339.1685: *4* v._addLink & _addParentLinks
    /**
     * Adjust links after adding a link to v.
     */
    ...
    //@+node:felix.20251214160339.1686: *5* v._addParentLinks
    /**
    ...
    //@+node:felix.20251214160339.1687: *4* v._cutLink & _cutParentLinks
    /**
    ...
    //@+node:felix.20251214160339.1688: *5* v._cutParentLinks
    /**
    ...
    //@+node:felix.20251214160339.1689: *4* v._deleteAllChildren
    /**
    ...
    //@+node:felix.20251214160339.1690: *4* v._linkAsNthChild
    /**
    ...
    //@+node:felix.20251214160339.1691: *3* v.Properties
    //@+node:felix.20251214160339.1692: *4* v.b Property
    /**
    ...
    //@+node:felix.20251214160339.1693: *4* v.h property
    /**
    ...
    //@+node:felix.20251214160339.1694: *4* v.u Property
    /**
     * VNode u property
     */
    ...
    //@+node:felix.20251214160339.1695: *4* v.gnx Property
    /**
     * VNode gnx property
     */
    public get gnx() {
