//@+leo-ver=5-thin
//@+node:felix.20251103192334.1747: * @file src/core/leoPlugins.ts
/**
 * Classes relating to Leo's plugin architecture.
 */
//@+<< leoPlugins imports & annotations >>
//@+node:felix.20251103192334.1748: ** << leoPlugins imports & annotations >>
import * as g from './leoGlobals';
type Tags = string | string[];

//@-<< leoPlugins imports & annotations >>
//@+others
//@+node:felix.20251103192334.1749: ** Top-level functions (leoPlugins.py)
/**
...
//@+node:felix.20251103192334.1750: ** class CommandChainDispatcher
/** 
...
//@+node:felix.20251103192334.1751: ** class LeoPluginsController
/**
...
export class LeoPluginsController {
    ...
    //@+others
    //@+node:felix.20251103192334.1752: *3* plugins.Birth
    //@+node:felix.20251103192334.1753: *4* plugins.ctor & reloadSettings
    constructor() {
    ...
    //@+node:felix.20251103192334.1754: *4* plugins.finishCreate & reloadSettings
    ...
    //@+node:felix.20251103192334.1755: *3* plugins.Event handlers
    //@+node:felix.20251103192334.1756: *4* plugins.on_idle
    /**
    ...
    //@+node:felix.20251103192334.1757: *4* plugins.doHandlersForTag & helper
    /**
    ...
    //@+node:felix.20251103192334.1758: *5* plugins.callTagHandler
    /**
    ...
    //@+node:felix.20251103192334.1759: *4* plugins.doPlugins (g.app.hookFunction)
    /**
    ...
    //@+node:felix.20251103192334.1760: *3* plugins.Registration
    //@+node:felix.20251103192334.1761: *4* plugins.registerExclusiveHandler
    /**
    ...
    //@+node:felix.20251103192334.1762: *4* plugins.registerHandler & registerOneHandler
    /**
    ...
    //@+node:felix.20251103192334.1763: *4* plugins.unregisterHandler
