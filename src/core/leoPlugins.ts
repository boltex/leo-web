//@+leo-ver=5-thin
//@+node:felix.20251214160339.1743: * @file src/core/leoPlugins.ts
/**
 * Classes relating to Leo's plugin architecture.
 */
//@+<< leoPlugins imports & annotations >>
//@+node:felix.20251214160339.1744: ** << leoPlugins imports & annotations >>
import * as g from './leoGlobals';
type Tags = string | string[];

//@-<< leoPlugins imports & annotations >>
//@+others
//@+node:felix.20251214160339.1745: ** Top-level functions (leoPlugins.py)
/**
...
//@+node:felix.20251214160339.1746: ** class CommandChainDispatcher
/** 
...
//@+node:felix.20251214160339.1747: ** class LeoPluginsController
/**
...
export class LeoPluginsController {
    ...
    //@+others
    //@+node:felix.20251214160339.1748: *3* plugins.Birth
    //@+node:felix.20251214160339.1749: *4* plugins.ctor & reloadSettings
    constructor() {
    ...
    //@+node:felix.20251214160339.1750: *4* plugins.finishCreate & reloadSettings
    ...
    //@+node:felix.20251214160339.1751: *3* plugins.Event handlers
    //@+node:felix.20251214160339.1752: *4* plugins.on_idle
    /**
    ...
    //@+node:felix.20251214160339.1753: *4* plugins.doHandlersForTag & helper
    /**
    ...
    //@+node:felix.20251214160339.1754: *5* plugins.callTagHandler
    /**
    ...
    //@+node:felix.20251214160339.1755: *4* plugins.doPlugins (g.app.hookFunction)
    /**
    ...
    //@+node:felix.20251214160339.1756: *3* plugins.Registration
    //@+node:felix.20251214160339.1757: *4* plugins.registerExclusiveHandler
    /**
    ...
    //@+node:felix.20251214160339.1758: *4* plugins.registerHandler & registerOneHandler
    /**
    ...
    //@+node:felix.20251214160339.1759: *4* plugins.unregisterHandler
