export const LEO_SETTINGS = String.raw`{
  "leoHeader": {
    "fileFormat": 2
  },
  "vnodes": [
    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "children": [
            {
              "gnx": "felix.20250623214443.1",
              "vh": "@bool diff-leo-files = True"
            },
            {
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "gnx": "felix.20240107200310.1",
              "vh": "@bool json-outline-clipboard = True"
            },
            {
            ...
            {
              "gnx": "felix.20250716012122.1",
              "vh": "@bool report-changed-at-clean-nodes = False"
            },
            {
            ...
            {
              "gnx": "felix.20240101020955.1",
              "vh": "@string gnx-kind = none"
            },
            {
            ...
            },
            {
              ...
              "children": [
                ...
                },
                {
                  ...
                  "vh": "@string default-leo-extension = .leojs"
                }
              ]
            },
            {
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "gnx": "felix.20240531201254.1",
              "vh": "@bool prefer-nav-pane = True"
            },
            {
        ...
        },
        {
          ...
          "children": [
            ...
            {
              "gnx": "felix.20240809011610.1",
              "vh": "sphinx settings",
              "children": [
                {
                  "gnx": "felix.20240809011610.2",
                  "vh": "@string sphinx-command-directory = None"
                },
                {
                  "gnx": "felix.20240809011610.3",
                  "vh": "@string sphinx-default-command = make html"
                },
                {
                  "gnx": "felix.20240809011610.4",
                  "vh": "@string sphinx-input-directory = None"
                },
                {
                  "gnx": "felix.20240809011610.5",
                  "vh": "@string sphinx-output-directory = None"
                }
              ]
            }
          ]
        ...
        {
          "gnx": "felix.20250623215059.1",
          "vh": "UNLs",
          "children": [
            {
              "gnx": "felix.20250623215059.2",
              "vh": "@string unl-status-kind = gnx"
            },
            {
              "gnx": "felix.20250623215059.3",
              "vh": "@bool full-unl-paths = False"
            },
            {
              "gnx": "felix.20250623215059.4",
              "vh": "@data unl-path-prefixes"
            }
          ]
        },
        {
  ...
  "tnodes": {
    ...
    "felix.20250623214443.1": "True: Leo's git-diff command will diff .leo and .leojs files.",
    ...
    "felix.20240107200310.1": "This option dictates that the clipboard content is to be generated as JSON\n(In the same format as the .leojs file format)\n\nLeo accepts outline 'paste' data in both XML Leo format, or JSON format",
    "ekr.20200226102131.1": "True: report unchanged files when saving a .leo file.",
    "felix.20240101020955.1": "Specify the format of gnxs:\n\nnone: Generate legacy gnxs: <self.userId>.<timestamp>.<unique number withing timestamp>\n\nuuid: Generate uuids: See https://docs.python.org/3/library/uuid.html\n\nksuid: Generate ksuids: See https://github.com/saresend/KSUID\n    pip install ksuid\n    \nCompatibility notes:\n    \n- All forms of gnx strings (legacy, UUIDs and KSUIDs) may safely coexist in the same document.\n- All versions of Leo from 4.1 onward can read all forms of gnxs.\n- The \"sort by creation date\" of the todo plugin will not work with UUIDs or KSUIDs.\n\nFor more details, see https://github.com/leo-editor/leo-editor/issues/3047\n",
    ...
    "felix.20240809011610.2": "If given, the sphinx command will cd to this directory.\n\nOtherwise, the sphinx command will cd to the directory containing the input file.",
    "felix.20240809011610.3": "If given, *only* this command will be executed after the cd command.",
    "felix.20240809011610.4": "Used only if the default command is *not* given.\n\nThe input_dir directory specified in the command:\n\nsphinx-build {input_dir} {output_dir} {i_path}",
    "felix.20240809011610.5": "Used only if the default command is *not* given.\n\nThe output_dir directory specified in the command:\n\nsphinx-build {input_dir} {output_dir} {i_path}",
    ...
    "felix.20250623215059.2": "gnx:    Show gnx-based unls in the status area.\nlegacy: Show legacy (headline-based) uns in the status area.",
    "felix.20250623215059.3": "True: (legacy): Display full path names in the status area.\nFalse:          Display only the .leo file's name in the status area.\n",
    "felix.20250623215059.4": "# lines have the form:\n# x.leo: <absolute path to x.leo>\n\n# test.leo:    c:/Repos/leo-editor/leo/test\n# LeoDocs.leo: c:/Repos/leo-editor/leo/doc",
