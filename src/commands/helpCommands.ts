//@+leo-ver=5-thin
//@+node:felix.20251103192334.2548: * @file src/commands/helpCommands.ts
/**
 * Leo's help commands.
 */

//@+<< helpCommands imports & annotations >>
//@+node:felix.20251103192334.2549: ** << helpCommands imports & annotations >>
...
//@+others
//@+node:felix.20251103192334.2550: ** helpCommands.cmd (decorator)
/**
...
//@+node:felix.20251103192334.2551: ** class HelpCommandsClass
/**
...
export class HelpCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251103192334.2552: *3* help
    @cmd('help', 'Prints an introduction to Leo\'s help system.')
    public help_command(): void {
        //@+<< define md_s >>
        //@+node:felix.20251103192334.2553: *4* << define md_s >> (F1)
        //@@language md
    ...
    //@+node:felix.20251103192334.2554: *3* helpForCommand & helpers
    ...
    //@+node:felix.20251103192334.2555: *4* getBindingsForCommand
    ...
    //@+node:felix.20251103192334.2556: *4* helpForCommandFinisher
    public helpForCommandFinisher(commandName: string): void {
        ...
        if (commandName && commandName.startsWith('help-for-')) {
            ...
            if (commandName) {
                ...
                //@+node:felix.20251103192334.2557: *5* << set s to about help-for-command >>
                s = `\
    ...
    //@+node:felix.20251103192334.2558: *4* replaceBindingPatterns
    ...
    //@+node:felix.20251103192334.2559: *3* helpForCreatingExternalFiles
    @cmd('help-for-creating-external-files', 'Explains how to create external files.')
    public helpForCreatingExternalFiles(): void {
        //@+<< define s >>
        //@+node:felix.20251103192334.2560: *4* << define s >> (helpForCreatingExternalFiles)
        //@@language md
    ...
    //@+node:felix.20251103192334.2561: *3* helpForFindCommands
    @cmd('help-for-find-commands', 'Explains Leo\'s find commands.')
    public helpForFindCommands(): void {
        //@+<< define s >>
        //@+node:felix.20251103192334.2562: *4* << define s >> (help-for-find-commands)
        //@@language md
    ...
    //@+node:felix.20251103192334.2563: *3* helpForKeystroke
    ...
    //@+node:felix.20251103192334.2564: *3* helpForMinibuffer
    @cmd('help-for-minibuffer', 'Print a messages telling you how to get started with Leo.')
    public helpForMinibuffer(): void {
        const c = this.c;
        //@+<< define s >>
        //@+node:felix.20251103192334.2565: *4* << define s >> (helpForMinibuffer)
        //@@language md
    ...
    //@+node:felix.20251103192334.2566: *3* helpForScripting
    @cmd('help-for-scripting', 'Shows a tutorial about scripting Leo.')
    public helpForScripting(): void {
        //@+<< define s >>
        //@+node:felix.20251103192334.2567: *4* << define s >> (helpForScripting)
        //@@language md
    ...
    //@+node:felix.20251103192334.2568: *3* helpForSettings
    @cmd('help-for-settings', 'Explains Leo\'s settings.')
    public helpForSettings(): void {
        //@+<< define s >>
        //@+node:felix.20251103192334.2569: *4* << define s >> (helpForSettings)
        //@@language md
    ...
    //@+node:felix.20251103192334.2570: *3* help.showSettings
    @cmd(
        'show-settings',
    ...
    //@+node:felix.20251103192334.2571: *3* help.showSettingsOutline
    @cmd(
    ...
    //@+node:felix.20251103192334.2572: *3* printButtons
    ...
    //@+node:felix.20251103192334.2573: *3* printCommands
    // Originally from leoKeys.py
    ...
    //@+node:felix.20251103192334.2574: *3* printCommandsWithDocs
    // Originally from leoKeys.py
