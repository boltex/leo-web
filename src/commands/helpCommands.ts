//@+leo-ver=5-thin
//@+node:felix.20251214160853.464: * @file src/commands/helpCommands.ts
/**
 * Leo's help commands.
 */
...
//@+others
//@+node:felix.20251214160853.466: ** helpCommands.cmd (decorator)
/**
...
//@+node:felix.20251214160853.467: ** class HelpCommandsClass
/**
...
export class HelpCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251214160853.468: *3* help
    @cmd('help', 'Prints an introduction to Leo\'s help system.')
    public help_command(): void {
        //@+<< define md_s >>
        //@+node:felix.20251214160853.469: *4* << define md_s >> (F1)
        //@@language md
    ...
    //@+node:felix.20251214160853.472: *4* helpForCommandFinisher
    public helpForCommandFinisher(commandName: string): void {
        ...
        if (commandName && commandName.startsWith('help-for-')) {
            ...
            if (commandName) {
                ...
                //@+node:felix.20251214160853.473: *5* << set s to about help-for-command >>
                s = `\
    ...
    //@+node:felix.20251214160853.475: *3* helpForCreatingExternalFiles
    @cmd('help-for-creating-external-files', 'Explains how to create external files.')
    public helpForCreatingExternalFiles(): void {
        //@+<< define s >>
        //@+node:felix.20251214160853.476: *4* << define s >> (helpForCreatingExternalFiles)
        //@@language md
    ...
    public helpForFindCommands(): void {
        //@+<< define s >>
        //@+node:felix.20251214160853.478: *4* << define s >> (help-for-find-commands)
        //@@language md
    ...
    public helpForMinibuffer(): void {
        const c = this.c;
        //@+<< define s >>
        //@+node:felix.20251214160853.481: *4* << define s >> (helpForMinibuffer)
        //@@language md
    ...
    public helpForScripting(): void {
        //@+<< define s >>
        //@+node:felix.20251214160853.483: *4* << define s >> (helpForScripting)
        //@@language md
    ...
    public helpForSettings(): void {
        //@+<< define s >>
        //@+node:felix.20251214160853.485: *4* << define s >> (helpForSettings)
        //@@language md
    ...
    //@+node:felix.20251214160853.487: *3* help.showSettingsOutline
    @cmd(
    ...
    //@+node:felix.20251214160853.488: *3* printButtons
    ...
    //@+node:felix.20251214160853.490: *3* printCommandsWithDocs
    // Originally from leoKeys.py
