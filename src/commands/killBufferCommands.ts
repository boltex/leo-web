//@+leo-ver=5-thin
//@+node:felix.20251214160853.514: * @file src/commands/killBufferCommands.ts
/**
 * Leo's kill-buffer commands.
 */
//@+<< killBufferCommands imports & annotations >>
//@+node:felix.20251214160853.515: ** << killBufferCommands imports & annotations >>
...
//@+others
//@+node:felix.20251214160853.516: ** class KillBufferIterClass
/**
...
class KillBufferIterClass {
    ...
    //@+others
    //@+node:felix.20251214160853.517: *3* __init__ & __iter__ (iterateKillBuffer)
    /**
    ...
    //@+node:felix.20251214160853.518: *3* __next__
...
//@+node:felix.20251214160853.519: ** class KillBufferCommandsClass
/**
...
export class KillBufferCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251214160853.520: *3* kill.ctor & reloadSettings
    constructor(c: any) {
    ...
    //@+node:felix.20251214160853.521: *3* addToKillBuffer
    /**
    ...
    //@+node:felix.20251214160853.522: *3* backwardKillSentence
    ...
    //@+node:felix.20251214160853.523: *3* backwardKillWord & killWord
    ...
    //@+node:felix.20251214160853.524: *3* clearKillRing
    @cmd('clear-kill-ring', 'Clear the kill ring.')
    public clearKillRing(): void {
        g.app.globalKillBuffer = [];
    }
    //@+node:felix.20251214160853.525: *3* getClipboard
    /**
    ...
    //@+node:felix.20251214160853.526: *3* iterateKillBuffer
    public iterateKillBuffer(): KillBufferIterClass {
        return new KillBufferIterClass(this.c);
    }
    //@+node:felix.20251214160853.527: *3* ec.killHelper
    /**
    ...
    //@+node:felix.20251214160853.528: *3* ec.killParagraphHelper
    /**
    ...
    //@+node:felix.20251214160853.529: *3* ec.killToEndOfLine
    ...
    //@+node:felix.20251214160853.530: *3* ec.killLine
    ...
    //@+node:felix.20251214160853.531: *3* killRegion & killRegionSave
    ...
    //@+node:felix.20251214160853.532: *3* ec.killSentence
    ...
    //@+node:felix.20251214160853.533: *3* killWs
    ...
    //@+node:felix.20251214160853.534: *3* yank & yankPop
    ...
    //@+node:felix.20251214160853.535: *3* zapToCharacter
