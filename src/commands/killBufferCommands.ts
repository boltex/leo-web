//@+leo-ver=5-thin
//@+node:felix.20251103192334.2598: * @file src/commands/killBufferCommands.ts
/**
 * Leo's kill-buffer commands.
 */
//@+<< killBufferCommands imports & annotations >>
//@+node:felix.20251103192334.2599: ** << killBufferCommands imports & annotations >>
...
//@+others
//@+node:felix.20251103192334.2600: ** class KillBufferIterClass
/**
...
class KillBufferIterClass {
    ...
    //@+others
    //@+node:felix.20251103192334.2601: *3* __init__ & __iter__ (iterateKillBuffer)
    /**
    ...
    //@+node:felix.20251103192334.2602: *3* __next__
...
//@+node:felix.20251103192334.2603: ** class KillBufferCommandsClass
/**
...
export class KillBufferCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251103192334.2604: *3* kill.ctor & reloadSettings
    constructor(c: any) {
    ...
    //@+node:felix.20251103192334.2605: *3* addToKillBuffer
    /**
    ...
    //@+node:felix.20251103192334.2606: *3* backwardKillSentence
    ...
    //@+node:felix.20251103192334.2607: *3* backwardKillWord & killWord
    ...
    //@+node:felix.20251103192334.2608: *3* clearKillRing
    @cmd('clear-kill-ring', 'Clear the kill ring.')
    public clearKillRing(): void {
        g.app.globalKillBuffer = [];
    }
    //@+node:felix.20251103192334.2609: *3* getClipboard
    /**
    ...
    //@+node:felix.20251103192334.2610: *3* iterateKillBuffer
    public iterateKillBuffer(): KillBufferIterClass {
        return new KillBufferIterClass(this.c);
    }
    //@+node:felix.20251103192334.2611: *3* ec.killHelper
    /**
    ...
    //@+node:felix.20251103192334.2612: *3* ec.killParagraphHelper
    /**
    ...
    //@+node:felix.20251103192334.2613: *3* ec.killToEndOfLine
    ...
    //@+node:felix.20251103192334.2614: *3* ec.killLine
    ...
    //@+node:felix.20251103192334.2615: *3* killRegion & killRegionSave
    ...
    //@+node:felix.20251103192334.2616: *3* ec.killSentence
    ...
    //@+node:felix.20251103192334.2617: *3* killWs
    ...
    //@+node:felix.20251103192334.2618: *3* yank & yankPop
    ...
    //@+node:felix.20251103192334.2619: *3* zapToCharacter
