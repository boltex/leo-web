//@+leo-ver=5-thin
//@+node:felix.20251103192334.2100: * @file src/commands/bufferCommands.ts
/**
 * Leo's buffer commands.
 */
//@+<< bufferCommands imports & annotations >>
//@+node:felix.20251103192334.2101: ** << bufferCommands imports & annotations >>
...
//@+others
//@+node:felix.20251103192334.2102: ** class BufferCommandsClass
/**
...
export class BufferCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251103192334.2103: *3* buffer.ctor
    /**
    ...
    //@+node:felix.20251103192334.2104: *3* buffer.Entry points
    //@+node:felix.20251103192334.2105: *4* appendToBuffer
    @cmd(
        'buffer-append-to',
    ...
    //@+node:felix.20251103192334.2106: *4* copyToBuffer
    @cmd(
        'buffer-copy',
        'Add the selected body text to the end of the body text of a named buffer (node).'
    )
    ...
    //@+node:felix.20251103192334.2107: *4* insertToBuffer
    @cmd(
        'buffer-insert',
    ...
    //@+node:felix.20251103192334.2108: *4* killBuffer
    @cmd(
        'buffer-kill',
    ...
    //@+node:felix.20251103192334.2109: *4* listBuffers & listBuffersAlphabetically
    @cmd(
        'buffers-list',
    ...
    //@+node:felix.20251103192334.2110: *4* prependToBuffer
    @cmd(
        'buffer-prepend-to',
    ...
    //@+node:felix.20251103192334.2111: *4* switchToBuffer
    @cmd(
        'buffer-switch-to',
    ...
    //@+node:felix.20251103192334.2112: *3* buffer.Utils
    //@+node:felix.20251103192334.2113: *4* computeData
    ...
    //@+node:felix.20251103192334.2114: *4* findBuffer
    ...
    //@+node:felix.20251103192334.2115: *4* getBufferName
    /** 
     * Get a buffer name.
     */
