//@+leo-ver=5-thin
//@+node:felix.20251214160853.16: * @file src/commands/bufferCommands.ts
/**
 * Leo's buffer commands.
 */
//@+<< bufferCommands imports & annotations >>
//@+node:felix.20251214160853.17: ** << bufferCommands imports & annotations >>
...
//@+others
//@+node:felix.20251214160853.18: ** class BufferCommandsClass
/**
...
export class BufferCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251214160853.19: *3* buffer.ctor
    /**
    ...
    //@+node:felix.20251214160853.20: *3* buffer.Entry points
    //@+node:felix.20251214160853.21: *4* appendToBuffer
    @cmd(
        'buffer-append-to',
    ...
    //@+node:felix.20251214160853.22: *4* copyToBuffer
    @cmd(
        'buffer-copy',
        'Add the selected body text to the end of the body text of a named buffer (node).'
    )
    ...
    //@+node:felix.20251214160853.23: *4* insertToBuffer
    @cmd(
        'buffer-insert',
    ...
    //@+node:felix.20251214160853.24: *4* killBuffer
    @cmd(
        'buffer-kill',
    ...
    //@+node:felix.20251214160853.25: *4* listBuffers & listBuffersAlphabetically
    @cmd(
        'buffers-list',
    ...
    //@+node:felix.20251214160853.26: *4* prependToBuffer
    @cmd(
        'buffer-prepend-to',
    ...
    //@+node:felix.20251214160853.27: *4* switchToBuffer
    @cmd(
        'buffer-switch-to',
    ...
    //@+node:felix.20251214160853.28: *3* buffer.Utils
    //@+node:felix.20251214160853.29: *4* computeData
    ...
    //@+node:felix.20251214160853.30: *4* findBuffer
    ...
    //@+node:felix.20251214160853.31: *4* getBufferName
    /** 
     * Get a buffer name.
     */
