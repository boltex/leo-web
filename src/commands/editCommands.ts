//@+leo-ver=5-thin
//@+node:felix.20251214160853.236: * @file src/commands/editCommands.ts
...
//@+others
//@+node:felix.20251214160853.237: ** editCommands.cmd (decorator)
/**
...
//@+node:felix.20251214160853.238: ** class TopLevelEditCommands
export class TopLevelEditCommands {
    //@+others
    //@+node:felix.20251214160853.239: *3* @g.command('mark-node-and-parents')
    ...
    //@+node:felix.20251214160853.240: *3* @g.command('promote-section-definition')
    @command(
    ...
    //@+node:felix.20251214160853.241: *3* @g.command('merge-node-with-next-node')
    @command(
    ...
    //@+node:felix.20251214160853.242: *3* @g.command('merge-node-with-prev-node')
    @command(
    ...
    //@+node:felix.20251214160853.243: *3* @g.command('promote-bodies')
    @command(
        'promote-bodies',
    ...
    //@+node:felix.20251214160853.244: *3* @g.command('promote-headlines')
    @command(
        'promote-headlines',
    ...
    //@+node:felix.20251214160853.245: *3* @g.command('show-clone-ancestors')
    @command(
    ...
    //@+node:felix.20251214160853.247: *3* @g.command('unmark-node-and-parents')
...
//@+node:felix.20251214160853.248: ** class EditCommandsClass
export class EditCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251214160853.249: *3* ec.constructor
    ...
    //@+node:felix.20251214160853.250: *3* ec.cache
    ...
    //@+node:felix.20251214160853.251: *3* ec.doNothing
    @cmd('do-nothing', 'A placeholder command, useful for testing bindings.')
    public doNothing(): void {
        // pass
    }
    //@+node:felix.20251214160853.252: *3* ec.insertFileName
    ...
    //@+node:felix.20251214160853.253: *3* ec.insertHeadlineTime
    @cmd(
    ...
    //@+node:felix.20251214160853.254: *3* ec.capitalizeHeadline
    @cmd(
        'capitalize-headline',
    ...
    //@+node:felix.20251214160853.255: *3* ec.path_for_p
    ...
    //@+node:felix.20251214160853.256: *3* ec.tabify & untabify
    ...
    //@+node:felix.20251214160853.257: *3* ec: capitalization & case
    //@+node:felix.20251214160853.258: *4* ec.capitalizeWord & up/downCaseWord
    ...
    //@+node:felix.20251214160853.259: *4* ec.capitalizeHelper
    ...
    //@+node:felix.20251214160853.260: *4* ec.capitalizeWords & selection
    @cmd(
    ...
    //@+node:felix.20251214160853.261: *3* ec: clicks and focus
    ...
    //@+node:felix.20251214160853.264: *4* ec.setCommentColumn
    ...
    //@+node:felix.20251214160853.265: *4* ec.indentToCommentColumn
    @cmd(
    ...
    //@+node:felix.20251214160853.266: *3* ec: fill column and centering
    //@+at
    ...
    //@+node:felix.20251214160853.267: *4* ec.centerLine
    ...
    //@+node:felix.20251214160853.268: *4* ec.setFillColumn
    ...
    //@+node:felix.20251214160853.269: *4* ec.centerRegion
    ...
    //@+node:felix.20251214160853.270: *4* ec.setFillPrefix
    ...
    //@+node:felix.20251214160853.271: *4* ec._addPrefix
    ...
    //@+node:felix.20251214160853.272: *3* ec: goto node
    //@+node:felix.20251214160853.273: *4* goto-any-clone
    @cmd(
        'goto-any-clone',
    ...
    //@+node:felix.20251214160853.274: *4* goto-char
    ...
    //@+node:felix.20251214160853.275: *4* goto-global-line
    @cmd(
        'goto-global-line',
    ...
    //@+node:felix.20251214160853.276: *4* goto-line
    ...
    //@+node:felix.20251214160853.277: *3* ec: headline numbers
    //@+node:felix.20251214160853.278: *4* hn-add-all & helper
    @cmd(
        'hn-add-all',
    ...
    //@+node:felix.20251214160853.279: *5* hn_add
    /**
    ...
    //@+node:felix.20251214160853.280: *4* hn-add-subtree & helper
    @cmd(
        'hn-add-subtree',
    ...
    //@+node:felix.20251214160853.281: *5* hn_add_relative
    /**
    ...
    //@+node:felix.20251214160853.282: *4* hn-delete-all
    ...
    //@+node:felix.20251214160853.283: *4* hn-delete-subtree
    ...
    //@+node:felix.20251214160853.284: *4* hn_delete
    ...
    //@+node:felix.20251214160853.285: *3* ec: indent
    //@+node:felix.20251214160853.286: *4* ec.deleteIndentation
    ...
    //@+node:felix.20251214160853.287: *4* ec.indentRelative
    ...
    //@+node:felix.20251214160853.288: *3* ec: info
    //@+node:felix.20251214160853.289: *4* ec.copyGnx
    @cmd(
        'copy-gnx',
    ...
    //@+node:felix.20251214160853.290: *4* ec.lineNumber
    @cmd(
        'line-number',
    ...
    //@+node:felix.20251214160853.291: *4* ec.viewRecentCommands
    @cmd(
    ...
    //@+node:felix.20251214160853.292: *4* ec.whatLine
    @cmd(
        'what-line',
    ...
    //@+node:felix.20251214160853.293: *3* ec: insert & delete
    //@+node:felix.20251214160853.294: *4* ec.addSpace/TabToLines & removeSpace/TabFromLines & helper
    ...
    //@+node:felix.20251214160853.295: *5* ec.addRemoveHelper
    ...
    //@+node:felix.20251214160853.296: *4* ec.backwardDeleteCharacter
    ...
    public backwardDeleteCharacter(): void {
        ...
        try {
            ...
            if (i !== j) {
                ...
                //@+node:felix.20251214160853.297: *5* << backspace with negative tab_width >>
                let s = w.getAllText();
    ...
    //@+node:felix.20251214160853.298: *4* ec.cleanAllLines
    ...
    //@+node:felix.20251214160853.299: *4* ec.cleanLines
    ...
    //@+node:felix.20251214160853.300: *4* ec.clearSelectedText
    ...
    //@+node:felix.20251214160853.301: *4* ec.delete-word & backward-delete-word
    @cmd(
        'delete-word',
    ...
    //@+node:felix.20251214160853.302: *4* ec.deleteNextChar
    ...
    //@+node:felix.20251214160853.303: *4* ec.deleteSpaces
    ...
    //@+node:felix.20251214160853.304: *4* ec.insertHardTab
    ...
    //@+node:felix.20251214160853.305: *4* ec.insertNewLine (insert-newline)
    ...
    //@+node:felix.20251214160853.306: *4* ec.insertNewLineAndTab (newline-and-indent)
    ...
    //@+node:felix.20251214160853.307: *4* ec.insertParentheses
    ...
    //@+node:felix.20251214160853.308: *4* ec.insertSoftTab
    ...
    //@+node:felix.20251214160853.309: *4* ec.removeBlankLines (remove-blank-lines)
    @cmd(
        'remove-blank-lines',
    ...
    //@+node:felix.20251214160853.310: *4* ec.replaceCurrentCharacter
    @cmd(
    ...
    //@+node:felix.20251214160853.311: *4* ec.selfInsertCommand helpers
    //@+node:felix.20251214160853.312: *5* ec.initBracketMatcher
    /**
    ...
    //@+node:felix.20251214160853.313: *5* ec.insertNewlineHelper
    ...
    //@+node:felix.20251214160853.314: *5* ec.updateAutoIndent
    ...
    //@+node:felix.20251214160853.315: *5* ec.updateAutomatchBracket
    ...
    //@+node:felix.20251214160853.317: *6* ec.doPlainTab
    /**
    ...
    //@+node:felix.20251214160853.318: *3* ec: lines
    //@+node:felix.20251214160853.319: *4* ec.moveLinesToNextNode
    ...
    //@+node:felix.20251214160853.320: *4* ec.splitLine
    ...
    //@+node:felix.20251214160853.321: *3* ec: move cursor
    //@+node:felix.20251214160853.322: *4* ec. helpers
    //@+node:felix.20251214160853.323: *5* ec.extendHelper
    /**
    ...
    //@+node:felix.20251214160853.324: *5* ec.moveToHelper
    /** 
    ...
    //@+node:felix.20251214160853.325: *5* ec.moveWithinLineHelper
    ...
    //@+node:felix.20251214160853.326: *5* ec.moveWordHelper
    private moveWordHelper(
        ...
        */
        ...
        //@+others
        //@+node:felix.20251214160853.327: *6* ec.moveWordHelper functions
    ...
    //@+node:felix.20251214160853.328: *5* ec.setMoveCol
    ...
    //@+node:felix.20251214160853.329: *4* ec.backToHome/ExtendSelection
    @cmd(
        'back-to-home',
    ...
    //@+node:felix.20251214160853.330: *4* ec.backToIndentation
    ...
    //@+node:felix.20251214160853.331: *4* ec.backward*/ExtendSelection
    ...
    //@+node:felix.20251214160853.332: *4* ec.beginningOfLine/ExtendSelection
    ...
    //@+node:felix.20251214160853.333: *4* ec.between lines & helper
    ...
    //@+node:felix.20251214160853.334: *5* ec.moveUpOrDownHelper
    ...
    //@+node:felix.20251214160853.335: *4* ec.buffers & helper
    ...
    //@+node:felix.20251214160853.336: *5* ec.moveToBufferHelper
    ...
    //@+node:felix.20251214160853.337: *4* ec.characters & helper
    ...
    //@+node:felix.20251214160853.338: *5* ec.moveToCharacterHelper
    ...
    //@+node:felix.20251214160853.339: *4* ec.clear/set/ToggleExtendMode
    ...
    //@+node:felix.20251214160853.340: *4* ec.endOfLine/ExtendSelection
    ...
    //@+node:felix.20251214160853.341: *4* ec.exchangePointMark
    @cmd(
        'exchange-point-mark',
    ...
    //@+node:felix.20251214160853.342: *4* ec.extend-to-line
    ...
    //@+node:felix.20251214160853.343: *4* ec.extend-to-sentence
    ...
    //@+node:felix.20251214160853.344: *4* ec.extend-to-word
    @cmd(
        'extend-to-word',
    ...
    //@+node:felix.20251214160853.345: *4* ec.finishOfLine/ExtendSelection
    ...
    //@+node:felix.20251214160853.346: *4* ec.forward*/ExtendSelection
    @cmd(
        'forward-end-word',
    ...
    //@+node:felix.20251214160853.347: *4* ec.movePastClose & helper
    ...
    //@+node:felix.20251214160853.348: *5* ec.movePastCloseHelper
    ...
    //@+node:felix.20251214160853.349: *4* ec.pages & helper
    ...
    //@+node:felix.20251214160853.350: *5* ec.movePageHelper
    /**
    ...
    //@+node:felix.20251214160853.351: *4* ec.paragraphs & helpers
    ...
    //@+node:felix.20251214160853.352: *5* ec.backwardParagraphHelper
    ...
    //@+node:felix.20251214160853.353: *5* ec.forwardParagraphHelper
    ...
    //@+node:felix.20251214160853.354: *4* ec.pushCursor and popCursor
    ...
    //@+node:felix.20251214160853.355: *4* ec.selectAllText
    ...
    //@+node:felix.20251214160853.357: *5* ec.backSentenceHelper
    ...
    //@+node:felix.20251214160853.358: *5* ec.forwardSentenceHelper
    ...
    //@+node:felix.20251214160853.359: *4* ec.startOfLine/ExtendSelection
    ...
    //@+node:felix.20251214160853.360: *3* ec: paragraph
    //@+node:felix.20251214160853.361: *4* ec.backwardKillParagraph
    ...
    //@+node:felix.20251214160853.362: *4* ec.fillRegion
    ...
    //@+node:felix.20251214160853.363: *4* ec.fillRegionAsParagraph
    ...
    //@+node:felix.20251214160853.364: *4* ec.fillParagraph
    ...
    //@+node:felix.20251214160853.365: *4* ec.killParagraph
    ...
    //@+node:felix.20251214160853.366: *4* ec.extend-to-paragraph & helper
    ...
    //@+node:felix.20251214160853.367: *5* ec.selectParagraphHelper
    /**
    ...
    //@+node:felix.20251214160853.368: *3* ec: region
    //@+node:felix.20251214160853.369: *4* ec.tabIndentRegion (indent-rigidly)
    ...
    //@+node:felix.20251214160853.370: *4* ec.countRegion
    ...
    //@+node:felix.20251214160853.371: *4* ec.moveLinesDown
    ...
    //@+node:felix.20251214160853.372: *4* ec.moveLinesUp
    ...
    //@+node:felix.20251214160853.373: *4* ec.reverseRegion
    ...
    //@+node:felix.20251214160853.374: *4* ec.up/downCaseRegion & helper
    ...
    //@+node:felix.20251214160853.375: *3* ec: sort
    //@+node:felix.20251214160853.376: *4* ec.sortColumns
    ...
    //@+node:felix.20251214160853.377: *4* ec.sortLines commands
    ...
    //@+node:felix.20251214160853.378: *3* ec: swap/transpose
    //@+node:felix.20251214160853.379: *4* ec.transposeLines
    ...
    //@+node:felix.20251214160853.380: *4* ec.transposeWords
    ...
    //@+node:felix.20251214160853.381: *4* ec.swapCharacters & transeposeCharacters
    ...
    //@+node:felix.20251214160853.382: *3* ec: uA's
    //@+node:felix.20251214160853.383: *4* ec.clearNodeUas & clearAllUas
    ...
    //@+node:felix.20251214160853.384: *4* ec.showUas & showAllUas
    ...
    //@+node:felix.20251214160853.385: *4* ec.setUa
    @cmd(
        'set-ua',
