//@+leo-ver=5-thin
//@+node:felix.20251214160853.2: * @file src/commands/baseCommands.ts
/**
 * The base class for all of Leo's user commands.
 */

//@+<< baseCommands imports & abbreviations >>
//@+node:felix.20251214160853.3: ** << baseCommands imports & abbreviations >>
...
//@+others
//@+node:felix.20251214160853.4: ** class BaseEditCommandsClass
/**
...
export class BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20251214160853.5: *3* BaseEdit.ctor
    /**
    ...
    //@+node:felix.20251214160853.8: *4* BaseEdit.endCommand
    /**
    ...
    public endCommand(
        ...
        if (bunch && bunch.name && bunch.name.startsWith('body') && changed) {
            ...
            if (
                ...
                // console.log('TODO : LEO-WEB : "TYPING" SHOULD NOT OCCUR ! ');
                // u.doTyping(p, 'Typing', bunch.oldText, newText, bunch.oldSel);
                // ! LEO-WEB : Some 'Typing' commands can be done via minibuffer & scripts !
                // ! SAME AS IN ELSE !
    ...
    //@+node:felix.20251214160853.9: *3* BaseEdit.editWidget
    /**
    ...
    //@+node:felix.20251214160853.10: *3* BaseEdit.getWSString
    /**
    ...
    //@+node:felix.20251214160853.11: *3* BaseEdit.oops
    /**
    ...
    //@+node:felix.20251214160853.12: *3* BaseEdit.Helpers
    //@+node:felix.20251214160853.13: *4* BaseEdit._chckSel
    /**
    ...
    //@+node:felix.20251214160853.14: *4* BaseEdit.getRectanglePoints
    /**
    ...
    //@+node:felix.20251214160853.15: *4* BaseEdit.keyboardQuit
    /**
