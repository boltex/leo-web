//@+leo-ver=5-thin
//@+node:felix.20260518220348.1: * @file src/commands/abbrevCommandsOld.ts
/**
 * Leo's abbreviations commands.
 */

//@+<< abbrevCommands imports & abbreviations >>
//@+node:felix.20260518220348.2: ** << abbrevCommands imports & abbreviations >>
...
//@+others
//@+node:felix.20260518220348.3: ** abbrevCommands.cmd (decorator)
/**
...
//@+node:felix.20260518220348.4: ** class AbbrevCommandsClass
/**
...
export class AbbrevCommandsClass extends BaseEditCommandsClass {
    ...
    //@+others
    //@+node:felix.20260518220348.5: *3* abbrev.Birth
    //@+node:felix.20260518220348.6: *4* abbrev.ctor
    /**
    ...
    //@+node:felix.20260518220348.7: *4* abbrev.finishCreate & helpers
    /**
    ...
    //@+node:felix.20260518220348.8: *5* abbrev.reload_settings & helpers
    /**
    ...
    //@+node:felix.20260518220348.9: *6* abbrev.init_abbrev
    /**
    ...
    //@+node:felix.20260518220348.10: *6* abbrev.init_env
    /**
    ...
    //@+node:felix.20260518220348.11: *6* abbrev.init_settings (called from reload_settings)
    /**
    ...
    //@+node:felix.20260518220348.12: *6* abbrev.init_tree_abbrev
    /**
    ...
    //@+node:felix.20260518220348.13: *7* abbrev.init_tree_abbrev_helper
    /**
    ...
    //@+node:felix.20260518220348.14: *3* abbrev.expandAbbrev & helpers (entry point)
    /**
    ...
    //@+node:felix.20260518220348.17: *4* abbrev.expand_tree (entry) & helpers
    /**
    ...
    //@+node:felix.20260518220348.18: *5* abbrev.paste_tree
    /**
    ...
    //@+node:felix.20260518220348.19: *4* abbrev.find_place_holder
    /**
    ...
    //@+node:felix.20260518220348.20: *4* abbrev.make_script_substitutions
    /**
    ...
    //@+node:felix.20260518220348.21: *4* abbrev.make_script_substitutions_in_headline
    /**
    ...
    //@+node:felix.20260518220348.22: *4* abbrev.match_prefix
    /**
     * A match helper.
     */
    public match_prefix(
    ...
    //@+node:felix.20260518220348.23: *4* abbrev.next_place
    /**
    ...
    //@+node:felix.20260518220348.24: *4* abbrev.replace_selection
    /** 
     * Replace w[i:j] by s.
     */
    ...
    //@+node:felix.20260518220348.25: *4* abbrev_get_ch
    /**
    ...
    //@+node:felix.20260518220348.26: *4* abbrev_get_prefixes
    /**
    ...
    //@+node:felix.20260518220348.27: *3* abbrev.dynamic abbreviation...
    //@+node:felix.20260518220348.28: *4* abbrev.dynamicCompletion C-M-/
    ...
    //@+node:felix.20260518220348.29: *4* abbrev.dynamicExpansion M-/ & helper
    @cmd(
        'dabbrev-expands',
    ...
    //@+node:felix.20260518220348.30: *5* abbrev.dynamicExpandHelper
    /**
    ...
    //@+node:felix.20260518220348.31: *4* abbrev.getDynamicList (helper)
    /**
    ...
    //@+node:felix.20260518220348.32: *3* abbrev.static abbrevs
    //@+node:felix.20260518220348.33: *4* abbrev.addAbbrevHelper
    /**
    ...
    //@+node:felix.20260518220348.34: *4* abbrev.killAllAbbrevs
    @cmd('abbrev-kill-all', 'Delete all abbreviations.')
    public killAllAbbrevs(): void {
        this.abbrevs = {};
    }

    //@+node:felix.20260518220348.35: *4* abbrev.listAbbrevs
    ...
    //@+node:felix.20260518220348.36: *4* abbrev.toggleAbbrevMode
