//@+leo-ver=5-thin
//@+node:felix.20251103192334.2197: * @file src/commands/commanderHelpCommands.ts
/**
...
//@+others
//@+node:felix.20251103192334.2198: ** Class CommanderHelpCommands
export class CommanderHelpCommands {
    //@+others
    //@+node:felix.20251103192334.2199: *3* c_help.about (version number & date)
    ...
    //@+node:felix.20251103192334.2200: *3* c_help.Open Leo files
    //@+node:felix.20251103192334.2201: *4* c_help.leoDocumentation
    // @commander_command(
    //     'open-leo-docs-leo',
    ...
    //@+node:felix.20251103192334.2202: *4* c_help.leoQuickStart
    // @commander_command(
    //     'open-quickstart-leo',
    ...
    //     */
    // }
    //@+node:felix.20251103192334.2203: *4* c_help.openCheatSheet
    ...
    //@+node:felix.20251103192334.2204: *4* c_help.openLeoSettings & openMyLeoSettings & helper
    @commander_command(
        'open-leo-settings',
    ...
    public async openMyLeoSettings(
        ...
        //@+others
        //@+node:felix.20251103192334.2205: *5* function: c_help.createMyLeoSettings
        /**
    ...
    //@+node:felix.20251103192334.2206: *3* c_help.Open Leo web pages
    //@+node:felix.20251103192334.2207: *4* c_help.leoHome
    @commander_command(
        'open-online-home',
    ...
    //@+node:felix.20251103192334.2208: *4* c_help.openLeoTutorials
    @commander_command(
    ...
    //@+node:felix.20251103192334.2209: *4* c_help.openLeoUsersGuide
    @commander_command(
        'open-users-guide',
    ...
    //@+node:felix.20251103192334.2210: *4* c_help.openLeoVideos
    @commander_command(
        'open-online-videos',
    ...
    //@+node:felix.20251103192334.2211: *3* c_help.selectAtSettingsNode
    @commander_command(
        'open-local-settings',
