//@+leo-ver=5-thin
//@+node:felix.20251214160853.113: * @file src/commands/commanderHelpCommands.ts
/**
...
export class CommanderHelpCommands {
    //@+others
    //@+node:felix.20251214160853.115: *3* c_help.about (version number & date)
    ...
    //@+node:felix.20251214160853.117: *4* c_help.leoDocumentation
    // @commander_command(
    //     'open-leo-docs-leo',
    ...
    //@+node:felix.20251214160853.118: *4* c_help.leoQuickStart
    // @commander_command(
    //     'open-quickstart-leo',
    ...
    //     */
    // }
    //@+node:felix.20251214160853.119: *4* c_help.openCheatSheet
    ...
    //@+node:felix.20251214160853.120: *4* c_help.openLeoSettings & openMyLeoSettings & helper
    @commander_command(
        'open-leo-settings',
    ...
    //@+node:felix.20251214160853.122: *3* c_help.Open Leo web pages
