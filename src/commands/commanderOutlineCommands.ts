//@+leo-ver=5-thin
//@+node:felix.20251214160853.128: * @file src/commands/commanderOutlineCommands.ts
/**
...
//@+others
//@+node:felix.20251214160853.129: ** function cantMoveMessage
...
//@+node:felix.20251214160853.130: ** function createMoveMarkedNode
...
//@+node:felix.20251214160853.131: ** function computeVnodeInfoDict
/**
...
//@+node:felix.20251214160853.132: ** function computeCopiedBunchList
/**
...
//@+node:felix.20251214160853.133: ** Class CommanderOutlineCommands
export class CommanderOutlineCommands {
    //@+others
    //@+node:felix.20251214160853.134: *3* c_oc.Cut & Paste Outlines
    //@+node:felix.20251214160853.135: *4* c_oc.copyOutline
    @commander_command(
        'copy-node',
    ...
    //@+node:felix.20251214160853.136: *4* c_oc.copyOutlineAsJson
    @commander_command(
        'copy-node-as-json',
    ...
    //@+node:felix.20251214160853.137: *4* c_oc.cutOutline
    @commander_command(
        'cut-node',
    ...
    //@+node:felix.20251214160853.138: *4* c_oc.pasteOutline
    ...
    //@+node:felix.20251214160853.139: *4* c_oc.asyncPasteOutline
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
        'async-paste-node',
        'Paste an outline into the present outline from the clipboard. ' +
    ...
    //@+node:felix.20251214160853.140: *4* c_oc.pasteOutlineRetainingClones
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251214160853.141: *4* c_oc.asyncPasteOutlineRetainingClones
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251214160853.142: *4* c_oc.pasteAsTemplate
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
        'paste-as-template',
    ...
    public pasteAsTemplate(this: Commands, s?: string): void {
        ...
        //@+others
        //@+node:felix.20251214160853.143: *5* skip_root
        ...
        //@+node:felix.20251214160853.144: *5* translate_gnx
        /**
        ...
        //@+node:felix.20251214160853.145: *5* viter
        /**
        ...
        //@+node:felix.20251214160853.146: *5* getv
        /**
        ...
        //@+node:felix.20251214160853.147: *5* do_paste
        /**
        ...
        //@+node:felix.20251214160853.149: *5* redoHelper
        ...
        //@+node:felix.20251214160853.150: *5* << prepare destination data >>
    ...
    //@+node:felix.20251214160853.151: *4* c_oc.asyncPasteAsTemplate
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251214160853.153: *3* c_oc.Expand & contract commands
    //@+node:felix.20251214160853.154: *4* c_oc.contract-all
    ...
    //@+node:felix.20251214160853.155: *4* c_oc.contractAllOtherNodes & helper
    @commander_command(
    ...
    //@+node:felix.20251214160853.156: *4* c_oc.contractAllSubheads (new)
    @commander_command(
    ...
    //@+node:felix.20251214160853.157: *4* c_oc.contractNode
    ...
    //@+node:felix.20251214160853.159: *4* c_oc.contractParent
    @commander_command(
        'contract-parent',
    ...
    //@+node:felix.20251214160853.160: *4* c_oc.expandAllHeadlines
    @commander_command(
        'expand-all',
    ...
    //@+node:felix.20251214160853.161: *4* c_oc.expandAllSubheads
    @commander_command(
        'expand-all-subheads',
    ...
    //@+node:felix.20251214160853.162: *4* c_oc.expandLevel1..9
    ...
    //@+node:felix.20251214160853.163: *4* c_oc.expandNextLevel
    @commander_command(
        'expand-next-level',
    ...
    //@+node:felix.20251214160853.164: *4* c_oc.expandNode
    ...
    //@+node:felix.20251214160853.165: *4* c_oc.expandNodeAndGoToFirstChild
    @commander_command(
        'expand-and-go-right',
    ...
    //@+node:felix.20251214160853.166: *4* c_oc.expandNodeOrGoToFirstChild
    @commander_command(
        'expand-or-go-right',
    ...
    //@+node:felix.20251214160853.167: *4* c_oc.expandOnlyAncestorsOfNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.168: *4* c_oc.expandPrevLevel
    @commander_command(
        'expand-prev-level',
    ...
    //@+node:felix.20251214160853.169: *3* c_oc.fullCheckOutline
    @commander_command(
        'check-outline',
    ...
    //@+node:felix.20251214160853.170: *3* c_oc.Goto commands
    //@+node:felix.20251214160853.171: *4* c_oc.findNextClone
    ...
    //@+node:felix.20251214160853.172: *4* c_oc.goNextVisitedNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.173: *4* c_oc.goPrevVisitedNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.174: *4* c_oc.goToFirstNode
    @commander_command(
        'goto-first-node',
    ...
    //@+node:felix.20251214160853.175: *4* c_oc.goToFirstSibling
    @commander_command(
        'goto-first-sibling',
    ...
    //@+node:felix.20251214160853.176: *4* c_oc.goToFirstVisibleNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.177: *4* c_oc.goToLastNode
    @commander_command(
        'goto-last-node',
    ...
    //@+node:felix.20251214160853.178: *4* c_oc.goToLastSibling
    @commander_command(
        'goto-last-sibling',
    ...
    //@+node:felix.20251214160853.179: *4* c_oc.goToLastVisibleNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.180: *4* c_oc.goToNextClone
    @commander_command(
        'goto-next-clone',
    ...
    //@+node:felix.20251214160853.181: *4* c_oc.goToNextDirtyHeadline
    @commander_command(
        'goto-next-changed',
    ...
    //@+node:felix.20251214160853.182: *4* c_oc.goToNextMarkedHeadline
    ...
    //@+node:felix.20251214160853.183: *4* c_oc.goToNextSibling
    @commander_command(
        'goto-next-sibling',
    ...
    //@+node:felix.20251214160853.184: *4* c_oc.goToParent
    ...
    //@+node:felix.20251214160853.185: *4* c_oc.goToPrevMarkedHeadline
    ...
    //@+node:felix.20251214160853.186: *4* c_oc.goToPrevSibling
    @commander_command(
        'goto-prev-sibling',
    ...
    //@+node:felix.20251214160853.187: *4* c_oc.selectThreadBack
    @commander_command(
        'goto-prev-node',
    ...
    //@+node:felix.20251214160853.188: *4* c_oc.selectThreadNext
    @commander_command(
        'goto-next-node',
    ...
    //@+node:felix.20251214160853.189: *4* c_oc.selectVisBack
    @commander_command(
        'goto-prev-visible',
    ...
    //@+node:felix.20251214160853.190: *4* c_oc.selectVisNext
    @commander_command(
        'goto-next-visible',
    ...
    //@+node:felix.20251214160853.191: *4* c_oc.treePageUp
    ...
    //@+node:felix.20251214160853.192: *4* c_oc.treePageDown
    ...
    //@+node:felix.20251214160853.193: *3* c_oc.hoist/dehoist/clearAllHoists
    //@+node:felix.20251214160853.194: *4* c_oc.deHoist
    ...
    //@+node:felix.20251214160853.195: *4* c_oc.clearAllHoists
    @commander_command(
        'clear-all-hoists',
    ...
    //@+node:felix.20251214160853.196: *4* c_oc.hoist
    ...
    //@+node:felix.20251214160853.197: *3* c_oc.Insert, Delete & Clone commands
    //@+node:felix.20251214160853.198: *4* c_oc.clone
    ...
    //@+node:felix.20251214160853.201: *4* c_oc.deleteOutline
    ...
    //@+node:felix.20251214160853.202: *4* c_oc.insertChild
    @commander_command(
        'insert-child',
    ...
    //@+node:felix.20251214160853.205: *4* private insertHeadlineHelper
    /**
     * Insert a node after the presently selected node.
     */
    ...
    //@+node:felix.20251214160853.211: *4* c_oc.copyMarked
    @commander_command(
        'copy-marked-nodes',
    ...
    //@+node:felix.20251214160853.212: *4* c_oc.deleteMarked
    ...
    //@+node:felix.20251214160853.213: *4* c_oc.moveMarked
    @commander_command(
        'move-marked-nodes',
    ...
    //@+node:felix.20251214160853.215: *4* c_oc.markHeadline
    ...
    //@+node:felix.20251214160853.216: *4* c_oc.markSubheads
    @commander_command(
        'mark-subheads',
    ...
    //@+node:felix.20251214160853.217: *4* c_oc.unmarkAll
    ...
    //@+node:felix.20251214160853.218: *3* c_oc.Move commands
    //@+node:felix.20251214160853.219: *4* c_oc.demote
    @commander_command(
        'demote',
    ...
    //@+node:felix.20251214160853.220: *4* c_oc.moveOutlineDown
    ...
    public moveOutlineDown(this: Commands): void {
        ...
        //@+node:felix.20251214160853.221: *5* << Move p down & set moved if successful >>
    ...
    //@+node:felix.20251214160853.222: *4* c_oc.moveOutlineLeft
    @commander_command(
        'move-outline-left',
    ...
    //@+node:felix.20251214160853.223: *4* c_oc.moveOutlineRight
    @commander_command(
        'move-outline-right',
    ...
    //@+node:felix.20251214160853.224: *4* c_oc.moveOutlineUp
    @commander_command(
        'move-outline-up',
    ...
    public moveOutlineUp(this: Commands): void {
        ...
        //@+<< Move p up >>
        //@+node:felix.20251214160853.225: *5* << Move p up >>
        const parent: Position = p.parent();
    ...
    //@+node:felix.20251214160853.226: *4* c_oc.moveOutlineToFirstChild
    ...
    //@+node:felix.20251214160853.227: *4* c_oc.moveOutlineToLastChild
    ...
    //@+node:felix.20251214160853.228: *4* c_oc.promote
    @commander_command(
        'promote',
    ...
    //@+node:felix.20251214160853.229: *4* c_oc.toggleSparseMove
    @commander_command(
        'toggle-sparse-move',
    ...
    //@+node:felix.20251214160853.230: *3* c_oc.Sort commands
    //@+node:felix.20251214160853.231: *4* c_oc.reverseSortChildren
    @commander_command(
    ...
    //@+node:felix.20251214160853.232: *4* c_oc.reverseSortSiblings
    @commander_command(
    ...
    //@+node:felix.20251214160853.233: *4* c_oc.sortChildren
    ...
    //@+node:felix.20251214160853.234: *4* c_oc.sortSiblings
    ...
    //@+node:felix.20251214160853.235: *3* count-children
