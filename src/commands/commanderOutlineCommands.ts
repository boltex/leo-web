//@+leo-ver=5-thin
//@+node:felix.20251103192334.2212: * @file src/commands/commanderOutlineCommands.ts
/**
...
//@+others
//@+node:felix.20251103192334.2213: ** function cantMoveMessage
...
//@+node:felix.20251103192334.2214: ** function createMoveMarkedNode
...
//@+node:felix.20251103192334.2215: ** function computeVnodeInfoDict
/**
...
//@+node:felix.20251103192334.2216: ** function computeCopiedBunchList
/**
...
//@+node:felix.20251103192334.2217: ** Class CommanderOutlineCommands
export class CommanderOutlineCommands {
    //@+others
    //@+node:felix.20251103192334.2218: *3* c_oc.Cut & Paste Outlines
    //@+node:felix.20251103192334.2219: *4* c_oc.copyOutline
    @commander_command(
        'copy-node',
    ...
    //@+node:felix.20251103192334.2220: *4* c_oc.copyOutlineAsJson
    @commander_command(
        'copy-node-as-json',
    ...
    //@+node:felix.20251103192334.2221: *4* c_oc.cutOutline
    @commander_command(
        'cut-node',
    ...
    //@+node:felix.20251103192334.2222: *4* c_oc.pasteOutline
    ...
    //@+node:felix.20251103192334.2223: *4* c_oc.asyncPasteOutline
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
        'async-paste-node',
        'Paste an outline into the present outline from the clipboard. ' +
    ...
    //@+node:felix.20251103192334.2224: *4* c_oc.pasteOutlineRetainingClones
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251103192334.2225: *4* c_oc.asyncPasteOutlineRetainingClones
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251103192334.2226: *4* c_oc.pasteAsTemplate
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
        'paste-as-template',
    ...
    public pasteAsTemplate(this: Commands, s?: string): void {
        ...
        //@+others
        //@+node:felix.20251103192334.2227: *5* skip_root
        ...
        //@+node:felix.20251103192334.2228: *5* translate_gnx
        /**
        ...
        //@+node:felix.20251103192334.2229: *5* viter
        /**
        ...
        //@+node:felix.20251103192334.2230: *5* getv
        /**
        ...
        //@+node:felix.20251103192334.2231: *5* do_paste
        /**
        ...
        //@+node:felix.20251103192334.2232: *5* undoHelper
        ...
        //@+node:felix.20251103192334.2233: *5* redoHelper
        ...
        //@+node:felix.20251103192334.2234: *5* << prepare destination data >>
    ...
    //@+node:felix.20251103192334.2235: *4* c_oc.asyncPasteAsTemplate
    // Only USER GUI interaction uses async clipboard methods. Scripts use normal methods.
    @commander_command(
    ...
    //@+node:felix.20251103192334.2236: *3* c_oc.dumpOutline
    ...
    //@+node:felix.20251103192334.2237: *3* c_oc.Expand & contract commands
    //@+node:felix.20251103192334.2238: *4* c_oc.contract-all
    ...
    //@+node:felix.20251103192334.2239: *4* c_oc.contractAllOtherNodes & helper
    @commander_command(
    ...
    //@+node:felix.20251103192334.2240: *4* c_oc.contractAllSubheads (new)
    @commander_command(
    ...
    //@+node:felix.20251103192334.2241: *4* c_oc.contractNode
    ...
    //@+node:felix.20251103192334.2242: *4* c_oc.contractNodeOrGoToParent
    @commander_command(
        'contract-or-go-left',
    ...
    //@+node:felix.20251103192334.2243: *4* c_oc.contractParent
    @commander_command(
        'contract-parent',
    ...
    //@+node:felix.20251103192334.2244: *4* c_oc.expandAllHeadlines
    @commander_command(
        'expand-all',
    ...
    //@+node:felix.20251103192334.2245: *4* c_oc.expandAllSubheads
    @commander_command(
        'expand-all-subheads',
    ...
    //@+node:felix.20251103192334.2246: *4* c_oc.expandLevel1..9
    ...
    //@+node:felix.20251103192334.2247: *4* c_oc.expandNextLevel
    @commander_command(
        'expand-next-level',
    ...
    //@+node:felix.20251103192334.2248: *4* c_oc.expandNode
    ...
    //@+node:felix.20251103192334.2249: *4* c_oc.expandNodeAndGoToFirstChild
    @commander_command(
        'expand-and-go-right',
    ...
    //@+node:felix.20251103192334.2250: *4* c_oc.expandNodeOrGoToFirstChild
    @commander_command(
        'expand-or-go-right',
    ...
    //@+node:felix.20251103192334.2251: *4* c_oc.expandOnlyAncestorsOfNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2252: *4* c_oc.expandPrevLevel
    @commander_command(
        'expand-prev-level',
    ...
    //@+node:felix.20251103192334.2253: *3* c_oc.fullCheckOutline
    @commander_command(
        'check-outline',
    ...
    //@+node:felix.20251103192334.2254: *3* c_oc.Goto commands
    //@+node:felix.20251103192334.2255: *4* c_oc.findNextClone
    ...
    //@+node:felix.20251103192334.2258: *4* c_oc.goToFirstNode
    @commander_command(
        'goto-first-node',
    ...
    //@+node:felix.20251103192334.2259: *4* c_oc.goToFirstSibling
    @commander_command(
        'goto-first-sibling',
    ...
    //@+node:felix.20251103192334.2260: *4* c_oc.goToFirstVisibleNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2261: *4* c_oc.goToLastNode
    @commander_command(
        'goto-last-node',
    ...
    //@+node:felix.20251103192334.2262: *4* c_oc.goToLastSibling
    @commander_command(
        'goto-last-sibling',
    ...
    //@+node:felix.20251103192334.2263: *4* c_oc.goToLastVisibleNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2264: *4* c_oc.goToNextClone
    @commander_command(
        'goto-next-clone',
    ...
    //@+node:felix.20251103192334.2265: *4* c_oc.goToNextDirtyHeadline
    @commander_command(
        'goto-next-changed',
    ...
    //@+node:felix.20251103192334.2266: *4* c_oc.goToNextMarkedHeadline
    ...
    //@+node:felix.20251103192334.2267: *4* c_oc.goToNextSibling
    @commander_command(
        'goto-next-sibling',
    ...
    //@+node:felix.20251103192334.2268: *4* c_oc.goToParent
    ...
    //@+node:felix.20251103192334.2269: *4* c_oc.goToPrevMarkedHeadline
    ...
    //@+node:felix.20251103192334.2270: *4* c_oc.goToPrevSibling
    @commander_command(
        'goto-prev-sibling',
    ...
    //@+node:felix.20251103192334.2271: *4* c_oc.selectThreadBack
    @commander_command(
        'goto-prev-node',
    ...
    //@+node:felix.20251103192334.2272: *4* c_oc.selectThreadNext
    @commander_command(
        'goto-next-node',
    ...
    //@+node:felix.20251103192334.2273: *4* c_oc.selectVisBack
    @commander_command(
        'goto-prev-visible',
    ...
    //@+node:felix.20251103192334.2274: *4* c_oc.selectVisNext
    @commander_command(
        'goto-next-visible',
    ...
    //@+node:felix.20251103192334.2275: *4* c_oc.treePageUp
    ...
    //@+node:felix.20251103192334.2276: *4* c_oc.treePageDown
    ...
    //@+node:felix.20251103192334.2277: *3* c_oc.hoist/dehoist/clearAllHoists
    //@+node:felix.20251103192334.2278: *4* c_oc.deHoist
    ...
    //@+node:felix.20251103192334.2279: *4* c_oc.clearAllHoists
    @commander_command(
        'clear-all-hoists',
    ...
    //@+node:felix.20251103192334.2280: *4* c_oc.hoist
    ...
    //@+node:felix.20251103192334.2281: *3* c_oc.Insert, Delete & Clone commands
    //@+node:felix.20251103192334.2282: *4* c_oc.clone
    ...
    //@+node:felix.20251103192334.2283: *4* c_oc.cloneToAtSpot
    @commander_command(
        'clone-to-at-spot',
    ...
    //@+node:felix.20251103192334.2284: *4* c_oc.cloneToLastNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2285: *4* c_oc.deleteOutline
    ...
    //@+node:felix.20251103192334.2286: *4* c_oc.insertChild
    @commander_command(
        'insert-child',
    ...
    //@+node:felix.20251103192334.2287: *4* c_oc.asyncInsertChild
    @commander_command(
        'async-insert-child',
        'Insert a node after the presently selected node.'
    )
    ...
    //@+node:felix.20251103192334.2288: *4* c_oc.insertHeadline (insert-*)
    @commander_command(
        'insert-node',
    ...
    //@+node:felix.20251103192334.2289: *4* private insertHeadlineHelper
    /**
     * Insert a node after the presently selected node.
     */
    ...
    //@+node:felix.20251103192334.2290: *4* c_oc.asyncInsertHeadline (insert-*)
    //
    //
    //
    @commander_command(
    ...
    //@+node:felix.20251103192334.2291: *4* c_oc.insertHeadlineBefore
    @commander_command(
        'insert-node-before',
    ...
    //@+node:felix.20251103192334.2292: *4* c_oc.asyncInsertHeadlineBefore
    @commander_command(
    ...
    //@+node:felix.20251103192334.2293: *3* c_oc.Mark commands
    //@+node:felix.20251103192334.2294: *4* c_oc.cloneMarked
    @commander_command(
        'clone-marked-nodes',
    ...
    //@+node:felix.20251103192334.2295: *4* c_oc.copyMarked
    @commander_command(
        'copy-marked-nodes',
    ...
    //@+node:felix.20251103192334.2296: *4* c_oc.deleteMarked
    ...
    //@+node:felix.20251103192334.2297: *4* c_oc.moveMarked
    @commander_command(
        'move-marked-nodes',
    ...
    //@+node:felix.20251103192334.2298: *4* c_oc.markChangedHeadlines
    @commander_command(
        'mark-changed-items',
    ...
    //@+node:felix.20251103192334.2299: *4* c_oc.markHeadline
    ...
    //@+node:felix.20251103192334.2300: *4* c_oc.markSubheads
    @commander_command(
        'mark-subheads',
    ...
    //@+node:felix.20251103192334.2301: *4* c_oc.unmarkAll
    ...
    //@+node:felix.20251103192334.2302: *3* c_oc.Move commands
    //@+node:felix.20251103192334.2303: *4* c_oc.demote
    @commander_command(
        'demote',
    ...
    //@+node:felix.20251103192334.2304: *4* c_oc.moveOutlineDown
    ...
    public moveOutlineDown(this: Commands): void {
        ...
        //@+node:felix.20251103192334.2305: *5* << Move p down & set moved if successful >>
    ...
    //@+node:felix.20251103192334.2306: *4* c_oc.moveOutlineLeft
    @commander_command(
        'move-outline-left',
    ...
    //@+node:felix.20251103192334.2307: *4* c_oc.moveOutlineRight
    @commander_command(
        'move-outline-right',
    ...
    //@+node:felix.20251103192334.2308: *4* c_oc.moveOutlineUp
    @commander_command(
        'move-outline-up',
    ...
    public moveOutlineUp(this: Commands): void {
        ...
        //@+<< Move p up >>
        //@+node:felix.20251103192334.2309: *5* << Move p up >>
        const parent: Position = p.parent();
    ...
    //@+node:felix.20251103192334.2310: *4* c_oc.moveOutlineToFirstChild
    ...
    //@+node:felix.20251103192334.2311: *4* c_oc.moveOutlineToLastChild
    ...
    //@+node:felix.20251103192334.2312: *4* c_oc.promote
    @commander_command(
        'promote',
    ...
    //@+node:felix.20251103192334.2313: *4* c_oc.toggleSparseMove
    @commander_command(
        'toggle-sparse-move',
    ...
    //@+node:felix.20251103192334.2314: *3* c_oc.Sort commands
    //@+node:felix.20251103192334.2315: *4* c_oc.reverseSortChildren
    @commander_command(
    ...
    //@+node:felix.20251103192334.2316: *4* c_oc.reverseSortSiblings
    @commander_command(
    ...
    //@+node:felix.20251103192334.2317: *4* c_oc.sortChildren
    ...
    //@+node:felix.20251103192334.2318: *4* c_oc.sortSiblings
    ...
    //@+node:felix.20251103192334.2319: *3* count-children
