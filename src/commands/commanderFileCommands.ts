//@+leo-ver=5-thin
//@+node:felix.20251214160853.68: * @file src/commands/commanderFileCommands.ts
/**
...
export class CommanderFileCommands {
    //@+others
    //@+node:felix.20251214160853.70: *3*  top-level helper functions
    //@+node:felix.20251214160853.71: *4* function: do_error_dialogs
    ...
    //@+node:felix.20251214160853.72: *4* function: set_name_and_title
    /**
    ...
    //@+node:felix.20251214160853.73: *3* c_file.reloadSettings
    @commander_command(
        'reload-settings',
    ...
    //@+node:felix.20251214160853.74: *3* c_file.top level
    //@+node:felix.20251214160853.75: *4* c_file.close
    @commander_command(
        'close-window',
    ...
    //@+node:felix.20251214160853.76: *4* c_file.importAnyFile & helper
    ...
    */
    //@+node:felix.20251214160853.77: *4* c_file.import_txt_file
    /**
    ...
    //@+node:felix.20251214160853.78: *4* c_file.new
    ...
    //@+node:felix.20251214160853.83: *4* c_file.save
    @commander_command(
        'save',
    ...
    //@+node:felix.20251214160853.85: *4* c_file.saveAs
    @commander_command(
        'save-as',
    ...
    //@+node:felix.20251214160853.89: *4* c_file.save-as-zipped
    @commander_command(
        'file-save-as-db',
    ...
    //@+node:felix.20251214160853.90: *4* c_file.save-as-xml
    @commander_command(
        'file-save-as-xml',
    ...
    //@+node:felix.20251214160853.91: *3* Export
    //@+node:felix.20251214160853.92: *4* c_file.exportHeadlines
    @commander_command(
        'export-headlines',
    ...
    //@+node:felix.20251214160853.95: *4* c_file.outlineToCWEB
    @commander_command(
        'outline-to-cweb',
    ...
    //@+node:felix.20251214160853.97: *4* c_file.removeSentinels
    @commander_command(
        'remove-sentinels',
    ...
    //@+node:felix.20251214160853.101: *4* c_file.readAtFileNodes
    @commander_command(
        'read-at-file-nodes',
    ...
    //@+node:felix.20251214160853.102: *4* c_file.readAtShadowNodes
    @commander_command(
    ...
    //@+node:felix.20251214160853.103: *4* c_file.readFileIntoNode
    @commander_command(
        'read-file-into-node',
    ...
    //@+node:felix.20251214160853.104: *4* c_file.writeFileFromNode
    @commander_command(
    ...
    //@+node:felix.20251214160853.106: *3* Recent Files
    //@+node:felix.20251214160853.107: *4* c_file.cleanRecentFiles
    @commander_command(
        'clean-recent-files',
    ...
    //@+node:felix.20251214160853.108: *4* c_file.clearRecentFiles
    ...
    //@+node:felix.20251214160853.109: *4* c_file.editRecentFiles
    ...
    //@+node:felix.20251214160853.110: *4* c._file.showRecentFiles
    ...
    //@+node:felix.20251214160853.111: *4* c_file.sortRecentFiles
    ...
    //@+node:felix.20251214160853.112: *4* c_file.writeEditedRecentFiles
