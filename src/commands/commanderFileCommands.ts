//@+leo-ver=5-thin
//@+node:felix.20251103192334.2152: * @file src/commands/commanderFileCommands.ts
/**
...
//@+others
//@+node:felix.20251103192334.2153: ** function: import_txt_file
/**
...
//@+node:felix.20251103192334.2154: ** Class CommanderFileCommands
export class CommanderFileCommands {
    //@+others
    //@+node:felix.20251103192334.2155: *3*  top-level helper functions
    //@+node:felix.20251103192334.2156: *4* function: do_error_dialogs
    ...
    //@+node:felix.20251103192334.2157: *4* function: set_name_and_title
    /**
    ...
    //@+node:felix.20251103192334.2158: *3* c_file.reloadSettings
    @commander_command(
        'reload-settings',
    ...
    //@+node:felix.20251103192334.2159: *3* c_file.top level
    //@+node:felix.20251103192334.2160: *4* c_file.close
    @commander_command(
        'close-window',
    ...
    //@+node:felix.20251103192334.2161: *4* c_file.importAnyFile & helper
    ...
    */
    //@+node:felix.20251103192334.2162: *4* c_file.new
    ...
    //@+node:felix.20251103192334.2163: *4* c_file.open_outline
    @commander_command(
        'open-outline',
    ...
    public async open_outline(
        ...
        //@+node:felix.20251103192334.2164: *5* function: open_completer
    ...
    //@+node:felix.20251103192334.2165: *4* c_file.refreshFromDisk
    ...
    //@+node:felix.20251103192334.2166: *4* c_file.pwd
    ...
    //@+node:felix.20251103192334.2167: *4* c_file.save
    @commander_command(
        'save',
    ...
    //@+node:felix.20251103192334.2168: *4* c_file.saveAll
    ...
    //@+node:felix.20251103192334.2169: *4* c_file.saveAs
    @commander_command(
        'save-as',
    ...
    //@+node:felix.20251103192334.2170: *4* c_file.saveTo
    @commander_command(
        'save-to',
    ...
    //@+node:felix.20251103192334.2171: *4* c_file.revert
    @commander_command(
        'revert',
    ...
    //@+node:felix.20251103192334.2172: *4* c_file.save-as-leojs
    @commander_command(
        'file-save-as-leojs',
    ...
    //@+node:felix.20251103192334.2173: *4* c_file.save-as-zipped
    @commander_command(
        'file-save-as-db',
    ...
    //@+node:felix.20251103192334.2174: *4* c_file.save-as-xml
    @commander_command(
        'file-save-as-xml',
    ...
    //@+node:felix.20251103192334.2175: *3* Export
    //@+node:felix.20251103192334.2176: *4* c_file.exportHeadlines
    @commander_command(
        'export-headlines',
    ...
    //@+node:felix.20251103192334.2177: *4* c_file.flattenOutline
    @commander_command(
        'flatten-outline',
    ...
    //@+node:felix.20251103192334.2178: *4* c_file.flattenOutlineToNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2179: *4* c_file.outlineToCWEB
    @commander_command(
        'outline-to-cweb',
    ...
    //@+node:felix.20251103192334.2180: *4* c_file.outlineToNoweb
    @commander_command(
        'outline-to-noweb',
    ...
    //@+node:felix.20251103192334.2181: *4* c_file.removeSentinels
    @commander_command(
        'remove-sentinels',
    ...
    //@+node:felix.20251103192334.2182: *4* c_file.weave
    @commander_command(
        'weave',
    ...
    //@+node:felix.20251103192334.2183: *3* Read/Write
    //@+node:felix.20251103192334.2184: *4* c_file.readAtAutoNodes
    @commander_command(
        'read-at-auto-nodes',
    ...
    //@+node:felix.20251103192334.2185: *4* c_file.readAtFileNodes
    @commander_command(
        'read-at-file-nodes',
    ...
    //@+node:felix.20251103192334.2186: *4* c_file.readAtShadowNodes
    @commander_command(
    ...
    //@+node:felix.20251103192334.2187: *4* c_file.readFileIntoNode
    @commander_command(
        'read-file-into-node',
    ...
    //@+node:felix.20251103192334.2188: *4* c_file.writeFileFromNode
    @commander_command(
    ...
    //@+node:felix.20251103192334.2189: *4* c_file.writeFileFromSubtree
    @commander_command(
    ...
    //@+node:felix.20251103192334.2190: *3* Recent Files
    //@+node:felix.20251103192334.2191: *4* c_file.cleanRecentFiles
    @commander_command(
        'clean-recent-files',
    ...
    //@+node:felix.20251103192334.2192: *4* c_file.clearRecentFiles
    ...
    //@+node:felix.20251103192334.2193: *4* c_file.editRecentFiles
    ...
    //@+node:felix.20251103192334.2194: *4* c._file.showRecentFiles
    ...
    //@+node:felix.20251103192334.2195: *4* c_file.sortRecentFiles
    ...
    //@+node:felix.20251103192334.2196: *4* c_file.writeEditedRecentFiles
