//@+leo-ver=5-thin
//@+node:felix.20251103192334.3010: * @file src/importers/xml.ts
/**
...
//@+others
//@+node:felix.20251103192334.3011: ** class Xml_Importer(Importer)
/** 
...
export class Xml_Importer extends Importer {
  ...
  //@+others
  //@+node:felix.20251103192334.3012: *3* xml_i.add_tags
  /**
  ...
  //@+node:felix.20251103192334.3013: *3* xml_i.compute_headline
  /**
  ...
  //@+node:felix.20251103192334.3014: *3* xml_i.find_end_of_block
  /**
  ...
  //@+node:felix.20251103192334.3015: *3* xml_i.preprocess_lines
