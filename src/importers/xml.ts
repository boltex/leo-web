//@+leo-ver=5-thin
//@+node:felix.20251214160933.128: * @file src/importers/xml.ts
/**
...
//@+others
//@+node:felix.20251214160933.129: ** class Xml_Importer(Importer)
/** 
...
export class Xml_Importer extends Importer {
  ...
  //@+others
  //@+node:felix.20251214160933.130: *3* xml_i.add_tags
  /**
  ...
  //@+node:felix.20251214160933.131: *3* xml_i.compute_headline
  /**
  ...
  //@+node:felix.20251214160933.132: *3* xml_i.find_end_of_block
  /**
