//@+leo-ver=5-thin
//@+node:felix.20251103192334.2933: * @file src/importers/javascript.ts
/**
...
//@+others
//@+node:felix.20251103192334.2934: ** class JS_Importer(Importer)
export class JS_Importer extends Importer {
  ...
  //@+others
  //@+node:felix.20251103192334.2935: *3* js_i.delete_comments_and_strings
  /**
