//@+leo-ver=5-thin
//@+node:felix.20251103192334.2948: * @file src/importers/markdown.ts
/**
...
//@+others
//@+node:felix.20251103192334.2949: ** class Markdown_Importer(Importer)
/**
...
export class Markdown_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.2950: *3* md_i.gen_block
    /**
    ...
    //@+node:felix.20251103192334.2951: *4* md_i.is_hash
    /**
    ...
    //@+node:felix.20251103192334.2952: *4* md_i.is_underline
    /**
    ...
    //@+node:felix.20251103192334.2953: *4* md_i.lookahead_underline
    /**
    ...
    //@+node:felix.20251103192334.2954: *4* md_i.make_decls_node
    /**
     * Make a decls node.
     */
    ...
    //@+node:felix.20251103192334.2955: *4* md_i.make_markdown_node
    /**
     * Create a new node. 
     */
