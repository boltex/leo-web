//@+leo-ver=5-thin
//@+node:felix.20251214160933.66: * @file src/importers/markdown.ts
/**
...
//@+others
//@+node:felix.20251214160933.67: ** class Markdown_Importer(Importer)
/**
...
export class Markdown_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251214160933.68: *3* md_i.gen_block
    /**
    ...
    //@+node:felix.20251214160933.71: *4* md_i.lookahead_underline
    /**
    ...
    //@+node:felix.20251214160933.72: *4* md_i.make_decls_node
    /**
     * Make a decls node.
     */
    ...
    //@+node:felix.20260315005417.1: *3* md_i.postprocess
    /**
