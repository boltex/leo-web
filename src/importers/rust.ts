//@+leo-ver=5-thin
//@+node:felix.20251214160933.103: * @file src/importers/rust.ts
/**
...
export class Rust_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251214160933.106: *3* rust_i.check_blanks_and_tabs
    /**
    ...
    //@+node:felix.20251214160933.107: *3* rust_i.compute_headline
    /**
    ...
    //@+node:felix.20251214160933.108: *3* rust_i.delete_comments_and_strings
    /**
    ...
    public override delete_comments_and_strings(lines: string[]): string[] {
        ...
        //@+node:felix.20251214160933.109: *4* rust_i function: oops
        ...
        //@+node:felix.20251214160933.110: *4* rust_i function: skip_r
        /**
        ...
        //@+node:felix.20251214160933.111: *4* rust_i function: skip_single_quote
        ...
        //@+node:felix.20251214160933.112: *4* rust_i function: skip_slash
    ...
    //@+node:felix.20251214160933.115: *3* rust_i.find_blocks
    /**
    ...
    //@+node:felix.20251214160933.116: *3* rust_i.postprocess
    /**
    ...
    public override postprocess(parent: Position): void {
        ...
        //@+node:felix.20251214160933.118: *4* function: move_module_preamble
        /**
