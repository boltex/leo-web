//@+leo-ver=5-thin
//@+node:felix.20251103192334.2985: * @file src/importers/rust.ts
/**
...
//@+others
//@+node:felix.20251103192334.2986: ** class Rust_Importer(Importer)
export class Rust_Importer extends Importer {
    ...
    //@+node:felix.20251103192334.2987: *3* << define rust block patterns >>
    ...
    //@+others
    //@+node:felix.20251103192334.2988: *3* rust_i.check_blanks_and_tabs
    /**
    ...
    //@+node:felix.20251103192334.2989: *3* rust_i.compute_headline
    /**
    ...
    //@+node:felix.20251103192334.2990: *3* rust_i.delete_comments_and_strings
    /**
    ...
    public delete_comments_and_strings(lines: string[]): string[] {
        ...
        //@+node:felix.20251103192334.2991: *4* rust_i function: oops
        ...
        //@+node:felix.20251103192334.2992: *4* rust_i function: skip_r
        /**
        ...
        //@+node:felix.20251103192334.2993: *4* rust_i function: skip_single_quote
        ...
        //@+node:felix.20251103192334.2994: *4* rust_i function: skip_slash
        ...
        //@+node:felix.20251103192334.2995: *4* rust_i function: skip_string_constant
        ...
        //@+node:felix.20251103192334.2996: *4* rust_i functions: scanning
        const add = (): void => {
            if (i < s.length) {
                result.push(s[i]);
                i += 1;
    ...
    //@+node:felix.20251103192334.2997: *3* rust_i.find_blocks
    /**
    ...
    //@+node:felix.20251103192334.2998: *3* rust_i.postprocess
    /**
    ...
    postprocess(parent: Position): void {
        ...
        //@+others  // Define helper functions.
        //@+node:felix.20251103192334.2999: *4* function: convert_docstring
        /**
        ...
        //@+node:felix.20251103192334.3000: *4* function: move_module_preamble
        /**
