//@+leo-ver=5-thin
//@+node:felix.20251214160933.85: * @file src/importers/perl.ts
/**
...
//@+others
//@+node:felix.20251214160933.86: ** class Perl_Importer(Importer)
/**
...
export class Perl_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251214160933.87: *3* perl_i.make_guide_lines
    /**
    ...
    //@+node:felix.20251214160933.88: *3* perl_i.delete_regexes
    /**
     * Remove regexes. 
     */
