//@+leo-ver=5-thin
//@+node:felix.20251103192334.2923: * @file src/importers/elisp.ts
/**
...
//@+others
//@+node:felix.20251103192334.2924: ** class Elisp_Importer(Importer)
export class Elisp_Importer extends Importer {
  ...
  //@+others
  //@+node:felix.20251103192334.2925: *3* elisp_i.find_end_of_block
  /** 
