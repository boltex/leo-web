//@+leo-ver=5-thin
//@+node:felix.20251103192334.2936: * @file src/importers/leo_rst.ts
/**
...
//@+others
//@+node:felix.20251103192334.2937: ** class Rst_Importer(Importer)
/**
...
export class Rst_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.2938: *3* rst_i.gen_block & helpers
    /**
    ...
    //@+node:felix.20251103192334.2939: *4* rst_i.ch_level
    /**
    ...
    //@+node:felix.20251103192334.2940: *4* rst_i.is_lookahead_overline
    /**
    ...
    //@+node:felix.20251103192334.2941: *4* rst_i.is_lookahead_underline
    ...
    //@+node:felix.20251103192334.2942: *4* rst_i.is_underline
    /**
    ...
    //@+node:felix.20251103192334.2943: *4* rst_i.make_dummy_node
    /**
     * Make a decls node.
     */
    ...
    //@+node:felix.20251103192334.2944: *4* rst_i.make_rst_node
    /**
