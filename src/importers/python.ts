//@+leo-ver=5-thin
//@+node:felix.20251103192334.2973: * @file src/importers/python.ts
...
//@+others
//@+node:felix.20251103192334.2974: ** class Python_Importer
/**
...
export class Python_Importer extends Importer {
  ...
  //@+others
  //@+node:felix.20251103192334.2975: *3* python_i.delete_comments_and_strings
  /**
  ...
  //@+node:felix.20251103192334.2976: *3* python_i.find_blocks
  /**
  ...
  //@+node:felix.20251103192334.2977: *3* python_i.find_end_of_block
  /**
  ...
  //@+node:felix.20251103192334.2978: *3* python_i.postprocess & helpers
  /**
  ...
  //@+node:felix.20251103192334.2979: *4* python_i.adjust_at_others
  /**
  ...
  //@+node:felix.20251103192334.2980: *4* python_i.adjust_headlines
  /**
  ...
  //@+node:felix.20251103192334.2981: *4* python_i.find_docstring
  /**
  ...
  //@+node:felix.20251103192334.2982: *4* python_i.move_class_docstring
  /**
  ...
  //@+node:felix.20251103192334.2983: *4* python_i.move_class_docstrings
  /**
  ...
  //@+node:felix.20251103192334.2984: *4* python_i.move_module_preamble
  /**
