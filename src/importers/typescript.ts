//@+leo-ver=5-thin
//@+node:felix.20251103192334.3006: * @file src/importers/typescript.ts
/** 
...
//@+others
//@+node:felix.20251103192334.3007: ** class TS_Importer(Importer)
export class TS_Importer extends Importer {

    public language: string = 'typescript';

    //@+<< define non-function patterns >>
    //@+node:felix.20251103192334.3008: *3* << define non-function patterns >>
    ...
    //@+node:felix.20251103192334.3009: *3* << define function patterns >>
