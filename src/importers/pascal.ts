//@+leo-ver=5-thin
//@+node:felix.20251103192334.2964: * @file src/importers/pascal.ts
/**
...
//@+others
//@+node:felix.20251103192334.2965: ** class Pascal_Importer(Importer)
export class Pascal_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.2966: *3* pascal_i.find_end_of_block
    /**
