//@+leo-ver=5-thin
//@+node:felix.20251103192334.2884: * @file src/importers/base_importer.ts
/**
...
//@+others
//@+node:felix.20251103192334.2885: ** class Block
/**
...
//@+node:felix.20251103192334.2886: ** class Importer
/**
...
export class Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.2887: *3* i.__init__
    /**
     * Importer.__init__
     */
    ...
    //@+node:felix.20251103192334.2888: *3* i: Generic methods: may be overridden
    // The pipeline.
    //@+node:felix.20251103192334.2889: *4* 1: i.import_from_string (entry) & helpers
    /**
    ...
    //@+node:felix.20251103192334.2890: *5* 1A: i.check_blanks_and_tabs
    /**
    ...
    //@+node:felix.20251103192334.2891: *5* 1B: i.regularize_whitespace
    /**
    ...
    //@+node:felix.20251103192334.2892: *5* 1C: i.preprocess_lines
    /**
    ...
    //@+node:felix.20251103192334.2893: *5* 2D: i.make_guide_lines
    /**
    ...
    //@+node:felix.20251103192334.2894: *5* 2E: i.delete_comments_and_strings
    /**
    ...
    //@+node:felix.20251103192334.2895: *4* 2: i.gen_block & helpers
    /**
     * Importer.gen_block.
     *
    ...
    //@+node:felix.20251103192334.2896: *5* 2A: i.find_blocks
    /**
    ...
    //@+node:felix.20251103192334.2897: *5* 2B: i.find_end_of_block
    /**
    ...
    //@+node:felix.20251103192334.2898: *5* 2C: i.compute_headline
    /**
    ...
    //@+node:felix.20251103192334.2899: *5* 2D: i.generate_all_bodies & helpers
    /**
    ...
    public generate_all_bodies(parent: Position, outer_block: Block, result_blocks: Block[]): void {
        ...
        while (todo_list.length > 0) {
            ...
            const v = block.v;
            //@+<< check block and v >>
            //@+node:felix.20251103192334.2900: *6* << check block and v >>
    ...
    //@+node:felix.20251103192334.2901: *6* i.find_all_child_lines
    /**
    ...
    //@+node:felix.20251103192334.2902: *6* i.handle_block_with_children
    /**
    ...
    //@+node:felix.20251103192334.2903: *6* i.remove_lws_from_blocks
    /**
    ...
    //@+node:felix.20251103192334.2904: *4* 3: i.postprocess & helper
    /**
    ...
    //@+node:felix.20251103192334.2905: *5* 3A: i.move_blank_lines
    /**
    ...
    //@+node:felix.20251103192334.2906: *3* i: Utils
    // Subclasses are unlikely ever to need to override these methods.
    //@+node:felix.20251103192334.2907: *4* i.compute_common_lws
    /**
    ...
    //@+node:felix.20251103192334.2908: *4* i.create_placeholders
    /**
    ...
    //@+node:felix.20251103192334.2909: *4* i.lws_n
    lws_n(s: string): number {
        // Return the length of the leading whitespace for s.
        return s.length - s.trimStart().length;
    }
    //@+node:felix.20251103192334.2910: *4* i.get_str_lws
    /**
    ...
    //@+node:felix.20251103192334.2911: *4* i.remove_common_lws
    /**
