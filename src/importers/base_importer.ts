//@+leo-ver=5-thin
//@+node:felix.20251214160933.2: * @file src/importers/base_importer.ts
/**
...
//@+others
//@+node:felix.20251214160933.3: ** class Block
/**
...
//@+node:felix.20251214160933.4: ** class Importer
/**
...
export class Importer {
    ...
    //@+others
    //@+node:felix.20251214160933.5: *3* i.__init__
    /**
     * Importer.__init__
     */
    ...
    //@+node:felix.20251214160933.6: *3* i: Generic methods: may be overridden
    // The pipeline.
    //@+node:felix.20251214160933.7: *4* 1: i.import_from_string (entry) & helpers
    /**
    ...
    //@+node:felix.20251214160933.8: *5* 1A: i.check_blanks_and_tabs
    /**
    ...
    //@+node:felix.20251214160933.9: *5* 1B: i.regularize_whitespace
    /**
    ...
    //@+node:felix.20251214160933.10: *5* 1C: i.preprocess_lines
    /**
    ...
    //@+node:felix.20251214160933.11: *5* 2D: i.make_guide_lines
    /**
    ...
    //@+node:felix.20251214160933.12: *5* 2E: i.delete_comments_and_strings
    /**
    ...
    //@+node:felix.20251214160933.13: *4* 2: i.gen_block & helpers
    /**
     * Importer.gen_block.
     *
    ...
    //@+node:felix.20251214160933.14: *5* 2A: i.find_blocks
    /**
    ...
    //@+node:felix.20251214160933.15: *5* 2B: i.find_end_of_block
    /**
    ...
    //@+node:felix.20251214160933.16: *5* 2C: i.compute_headline
    /**
    ...
    //@+node:felix.20251214160933.17: *5* 2D: i.generate_all_bodies & helpers
    /**
    ...
    public generate_all_bodies(parent: Position, outer_block: Block, result_blocks: Block[]): void {
        ...
        while (todo_list.length > 0) {
            ...
            const v = block.v;
            //@+<< check block and v >>
            //@+node:felix.20251214160933.18: *6* << check block and v >>
    ...
    //@+node:felix.20251214160933.19: *6* i.find_all_child_lines
    /**
    ...
    //@+node:felix.20251214160933.20: *6* i.handle_block_with_children
    /**
    ...
    //@+node:felix.20251214160933.21: *6* i.remove_lws_from_blocks
    /**
    ...
    //@+node:felix.20251214160933.22: *4* 3: i.postprocess & helper
    /**
    ...
    //@+node:felix.20251214160933.23: *5* 3A: i.move_blank_lines
    /**
    ...
    //@+node:felix.20251214160933.24: *3* i: Utils
    // Subclasses are unlikely ever to need to override these methods.
    //@+node:felix.20251214160933.25: *4* i.compute_common_lws
    /**
    ...
    //@+node:felix.20251214160933.26: *4* i.create_placeholders
    /**
    ...
    //@+node:felix.20251214160933.27: *4* i.lws_n
    lws_n(s: string): number {
        // Return the length of the leading whitespace for s.
        return s.length - s.trimStart().length;
    }
    //@+node:felix.20251214160933.28: *4* i.get_str_lws
    /**
    ...
    //@+node:felix.20251214160933.29: *4* i.remove_common_lws
    /**
