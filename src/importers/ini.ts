//@+leo-ver=5-thin
//@+node:felix.20251103192334.2928: * @file src/importers/ini.ts
/**
...
//@+others
//@+node:felix.20251103192334.2929: ** class Ini_Importer(Importer)
export class Ini_Importer extends Importer {
    ...
    //@+others
    //@+node:felix.20251103192334.2930: *3* ini_i.find_end_of_block
    /**
