...
export function makeAllBindings(leoUI: LeoUI, controller: Controller): void {
    ...
    const commands: [string, (...args: any[]) => any][] = [
        ...
        // [CMD.STATUS_BAR, () => leoUI.statusBar()], // Not referenced in package.json
        ...
        // [CMD.GOTO_LINE_IN_LEO_OUTLINE, (p_arg: any) => leoUI.gotoLineInLeoOutline(p_arg)],
        // [CMD.IMPORT_INTO_LEO_OUTLINE, (p_arg: any) => leoUI.importIntoLeoOutline(p_arg)],
