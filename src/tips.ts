        ...
        content: `
            <div class="help-column">
                <ul class="config-col shortcuts">
                    <li class="underlined"><span class="subtitle">Create & Rename</span></li>
                    ...
                    <li class="underlined"><span class="subtitle">Reorganize</span></li>
                    ...
                    <li class="underlined"><span class="subtitle">Clipboard</span></li>
            ...
            <div class="help-column">
                <ul class="config-col shortcuts">
                    <li class="underlined"><span class="subtitle">Navigate</span></li>
                    ...
                    <li class="underlined"><span class="subtitle">Search</span></li>
                    ...
                    <li class="underlined"><span class="subtitle">Run Any Command</span></li>
