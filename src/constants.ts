...
export class Constants {
    ...
    public static COMMANDS = {
        ...
        BACKWARD_CHAR: Constants.NAME + ".backwardChar",
        BACKWARD_PARAGRAPH: Constants.NAME + ".backwardParagraph",
        BACKWARD_SENTENCE: Constants.NAME + ".backwardSentence",
        BACKWARD_WORD: Constants.NAME + ".backwardWord",
        ...
        BACKWARD_CHAR_EXTEND_SELECTION: Constants.NAME + ".backwardCharExtendSelection",
        BACKWARD_PARAGRAPH_EXTEND_SELECTION: Constants.NAME + ".backwardParagraphExtendSelection",
        BACKWARD_SENTENCE_EXTEND_SELECTION: Constants.NAME + ".backwardSentenceExtendSelection",
        BACKWARD_WORD_EXTEND_SELECTION: Constants.NAME + ".backwardWordExtendSelection",
    ...
    public static LEO_COMMANDS = {
        ...
        BACKWARD_SENTENCE: "backward-sentence",
        ...
        BACKWARD_CHAR_EXTEND_SELECTION: "backward-char-extend-selection",
        BACKWARD_PARAGRAPH_EXTEND_SELECTION: "backward-paragraph-extend-selection",
        BACKWARD_SENTENCE_EXTEND_SELECTION: "backward-sentence-extend-selection",
        BACKWARD_WORD_EXTEND_SELECTION: "backward-word-extend-selection",
