...
export class Constants {
    ...
    public static STATES_DEBOUNCE_DELAY: number = 20;
    ...
    public static USER_MESSAGES = {
        ...
        MINIBUFFER_BUTTON: "◉ @button",
        MINIBUFFER_RCLICK: "▶ @rclick",
        MINIBUFFER_COMMAND: "» @command",
        MINIBUFFER_BAD_COMMAND: "⊘ Not Available",
    ...
    public static COMMANDS = {
        ...
        COLOR_THEME: Constants.NAME + ".colorTheme",
        ...
        // Edit Commands
        BACK_TO_HOME: Constants.NAME + ".backToHome",
