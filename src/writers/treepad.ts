//@+leo-ver=5-thin
//@+node:felix.20251214160938.28: * @file src/writers/treepad.ts
/**
...
//@+others
//@+node:felix.20251214160938.29: ** class TreePad_Writer(BaseWriter)
/**
...
export class TreePad_Writer extends BaseWriter {
    ...
    //@+others
    //@+node:felix.20251214160938.30: *3* treepad_w.write
    /**
