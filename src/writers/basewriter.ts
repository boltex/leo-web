//@+leo-ver=5-thin
//@+node:felix.20251214160938.2: * @file src/writers/basewriter.ts
...
export class BaseWriter {
    ...
    //@+others
    //@+node:felix.20251214160938.3: ** basewriter.put
    /**
    ...
    //@+node:felix.20251214160938.4: ** basewriter.put_node_sentinel
    /**
    ...
    //@+node:felix.20251214160938.5: ** basewriter.write
