//@+leo-ver=5-thin
//@+node:felix.20251214160938.14: * @file src/writers/markdown.ts
/**
...
//@+others
//@+node:felix.20251214160938.15: ** class MarkdownWriter(BaseWriter)
/**
...
export class MarkdownWriter extends BaseWriter {
    ...
    //@+node:felix.20251214160938.17: *3* mdw.write_headline
    /**
    ...
    //@+node:felix.20251214160938.18: *3* mdw.write_root
    /**
